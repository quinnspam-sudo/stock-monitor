...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #46 of 136 in universe (earnings yield 9.3%, return on capital 13.7%)
  - Piotroski F-Score: 4/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.24
  - Momentum: 6-mo -5.5%, 12-mo +11.5%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: FAIL
  - Graham/Buffett intrinsic value: Graham Number $140.89, margin of safety -6.5%
...
## Raw data fields (yfinance)
  - forwardPE: 12.500333
  - trailingPE: 14.098683
  - enterpriseToEbitda: 11.13
  - enterpriseToRevenue: 1.425
  - pegRatio: 1.2406
  ...
  - currentPrice: 150.01
  - heldPercentInstitutions: 0.88824
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-28 (~45d): ATM IV 42.0%
