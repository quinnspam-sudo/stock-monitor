...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #45 of 115 in universe (earnings yield 3.5%, return on capital 52.1%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.69
  - Momentum: 6-mo +2.3%, 12-mo +33.9%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: FAIL; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $76.75, margin of safety -155.9%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-21 (~45d): ATM IV 33.9%
    - 25Δ put IV 33.6% vs 25Δ call IV 32.5% — skew +1.1% (balanced)
    - Same-day flow at this expiry: 873 call vol vs 702 put vol (C/P 1.24)
