...
- Earnings gate OPENED — earnings in 6 business day(s), positivity 94/100, beat streak 3/4 — buy decision is now actionable
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #73 of 117 in universe (earnings yield 2.2%, return on capital 27.3%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.42
  - Momentum: 6-mo +62.5%, 12-mo +41.9%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $49.26, margin of safety -506.1%
...
## Recent news headlines
  - Price Prediction: ON Semiconductor’s Rally May Be Far From Over (2026-07-14)
  - Texas Instruments (TXN) Stock Could Be 34% Overvalued After AI Demand News (2026-07-13)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 66.2% vs 25Δ call IV 67.1% — skew -0.9% (balanced)
    - Same-day flow at this expiry: 1,282 call vol vs 294 put vol (C/P 4.36)
