...
Generated: 2026-07-10 09:53 local | Source: stock-monitor local daemon
...
- Previous evaluation date: 2026-07-10 08:51
...
## Supermajority consensus vote (last gate before a BUY alert)
  - Verdict: FAIL — 1/10 systems bullish (supermajority 65%, min 6 computable)
    ...
    - positivity_margin: ✘
    - quality_gates: ✔
  - Market regime: SPY>50d/200d, VIX 15.4 (max 28.0), term 0.819 — OK
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  ...
  - PEG (GARP): 4.94
  - Momentum: 6-mo -5.2%, 12-mo +33.3%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $23.28, margin of safety -1673.9%
...
## Recent news headlines
  ...
  - Tesla Robotaxi Success Endangered By Regulators (2026-07-10)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 46.1% vs 25Δ call IV 46.5% — skew -0.4% (balanced)
    - Same-day flow at this expiry: 12,865 call vol vs 6,430 put vol (C/P 2.00)
