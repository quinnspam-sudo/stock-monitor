...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #59 of 118 in universe (earnings yield 3.9%, return on capital 27.7%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 3.12
  - Momentum: 6-mo +1.0%, 12-mo -9.6%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $78.16, margin of safety -181.3%
...
## Raw data fields (yfinance)
  - forwardPE: 27.258583
  - trailingPE: 31.503582
  - enterpriseToEbitda: 15.519
  - enterpriseToRevenue: 4.829
  - pegRatio: 3.1168
  ...
  - currentPrice: 219.895
  - heldPercentInstitutions: 0.97073
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-09-18 (~45d): ATM IV 27.3%
    - 25Δ put IV 29.5% vs 25Δ call IV 32.0% — skew -2.5% (upside being chased (call skew))
