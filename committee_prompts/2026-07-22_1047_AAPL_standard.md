...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #26 of 109 in universe (earnings yield 2.8%, return on capital 413.7%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.64
  - Momentum: 6-mo +31.0%, 12-mo +51.7%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: FAIL
  - Graham/Buffett intrinsic value: Graham Number $36.73, margin of safety -781.6%
...
## Recent news headlines
  ...
  - A 15% “Dividend” ETF With Berkshire Stocks? Read This Before You Buy a Single Share (2026-07-22)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-28 (~45d): ATM IV 30.1%
    - 25Δ put IV 29.8% vs 25Δ call IV 28.6% — skew +1.2% (balanced)
    - Same-day flow at this expiry: 889 call vol vs 1,063 put vol (C/P 0.84)
