...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #3 of 107 in universe (earnings yield 38.1%, return on capital 81.6%)
  - Piotroski F-Score: 4/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 3.49
  - Momentum: 6-mo -17.7%, 12-mo +5.0%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $25.65, margin of safety -83.9%
  - CANSLIM (O'Neil): 2/7 criteria met — C: Y; A: Y; N: N; S: N; L: N; I: N; M: N
  - Dividend growth quality (if applicable): yield 22.7%, payout 281%, quality score 57/100, 5yr div CAGR +35.6%
...
## Raw data fields (yfinance)
  ...
  - targetMeanPrice: 47.80628
  - currentPrice: 47.15
  - heldPercentInstitutions: 0.099259995
  - numberOfAnalystOpinions: 12

## Recent news headlines
  - Novo Nordisk Stock Falls 7% as ZEUS Trial Fails (2026-07-31)
  - NVO Stock Slumps After Late-Stage Trial Fails Primary Goal – Retail Says ‘Current Revenue Drivers’ Still Intact (2026-07-31)
  - Exchange-Traded Funds, Equity Futures Higher Pre-Bell Friday as Amazon Earnings Offset Apple Weakness (2026-07-31)
  - Novo Nordisk Stock Sinks on Disappointing Heart Drug Trial Results (2026-07-31)
  - Novo Nordisk ziltivekimab heart drug fails phase 3 trial (2026-07-31)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-09-18 (~45d): ATM IV 39.0%
    - 25Δ put IV 43.6% vs 25Δ call IV 41.1% — skew +2.5% (balanced)
    - Same-day flow at this expiry: 2,364 call vol vs 1,619 put vol (C/P 1.46)
