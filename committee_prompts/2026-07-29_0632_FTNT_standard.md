...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - HARD VETO: hostile market regime: SPY>!50d/200d, VIX 18.9 (max 28.0), term 0.952
  - No contract proposed: against: flow_proxy, trend; hostile market regime: SPY>!50d/200d, VIX 18.9 (max 28.0), term 0.952
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  ...
  - PEG (GARP): 3.50
  - Momentum: 6-mo +79.8%, 12-mo +40.8%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $8.85, margin of safety -1567.9%
...
## Recent news headlines
  ...
  - 3 Cybersecurity Stocks to Buy Before Threats Get Worse in Late July (2026-07-28)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - Same-day flow at this expiry: 1,649 call vol vs 1,494 put vol (C/P 1.10)
