...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - HARD VETO: hostile market regime: SPY>!50d/200d, VIX 18.2 (max 28.0), term 0.908
  - No contract proposed: against: catalyst, flow_proxy, trend, vol_mispricing; IV/RVf 1.32 >= 1.15 — vol too rich to buy; hostile market regime: SPY>!50d/200d, VIX 18.2 (max 28.0), term 0.908

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #32 of 102 in universe (earnings yield 5.0%, return on capital 36.8%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.87
  - Momentum: 6-mo +8.6%, 12-mo +27.0%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $185.88, margin of safety -110.3%
...
## Raw data fields (yfinance)
  - forwardPE: 21.453808
  - trailingPE: 24.582705
  - enterpriseToEbitda: 17.051
  - enterpriseToRevenue: 2.056
  - pegRatio: 2.8742
  ...
  - currentPrice: 390.865
  - heldPercentInstitutions: 0.87632006
  - numberOfAnalystOpinions: 21

## Recent news headlines
  - Booz Allen Soared On A Beat, Not A Boom (2026-07-27)
  - Does RTX Stock Chart Its Own Course? (2026-07-27)
  - Russian attack on Kyiv triggers fires across Ukrainian capital (2026-07-26)
  - The Best Aerospace and Defense ETFs to Buy (2026-07-24)
