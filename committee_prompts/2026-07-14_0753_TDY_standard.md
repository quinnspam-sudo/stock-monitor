...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #38 of 136 in universe (earnings yield 3.7%, return on capital 56.7%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +14.6%, 12-mo +17.4%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $320.10, margin of safety -96.8%
...
## Raw data fields (yfinance)
  - forwardPE: 24.263962
  - trailingPE: 31.964994
  - enterpriseToEbitda: 20.06
  - enterpriseToRevenue: 4.957
  ...
  - currentPrice: 630.03
  - heldPercentInstitutions: 1.00396
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 51.3% vs 25Δ call IV 42.6% — skew +8.7% (heavy downside-protection bid (fear))
    - Same-day flow at this expiry: 231 call vol vs 531 put vol (C/P 0.44)
