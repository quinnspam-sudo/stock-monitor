...
- Previous evaluation date: 2026-07-15 08:24
...
## confirm or veto the positivity call using transcript/guidance judgment)
  ...
  - GATE VERDICT: NOT ACTIONABLE — earnings in 36 business days (window: ≤10); positivity 66/100 below strict bar 70
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #57 of 118 in universe (earnings yield 1.4%, return on capital 166.4%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 0.44 (GARP: attractive <= 1)
  - Momentum: 6-mo +10.4%, 12-mo +39.9%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $49.84, margin of safety -682.7%
...
## Raw data fields (yfinance)
  - forwardPE: 20.090229
  - trailingPE: 65.12354
  - enterpriseToEbitda: 45.065
  - enterpriseToRevenue: 25.131
  - pegRatio: 0.4374
  ...
  - currentPrice: 390.09
  - heldPercentInstitutions: 0.79858
  - numberOfAnalystOpinions: 45

## Recent news headlines
  - Apollo Lands Record $35 Billion AI Credit Deal, Challenging Wall Street Banks (2026-07-15)
  - Apple Plans to Spend $30 Billion in a Deal With Broadcom (AVGO) – Reuters (2026-07-15)
  - Prediction: SK Hynix Will Become the Next Nvidia (2026-07-15)
  - Five cloud business groups urge EU interim measures against Broadcom (2026-07-15)
  - Snowflake vs. Broadcom: Which Enterprise AI Stock Is the Smarter Buy? (2026-07-15)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 51.0% vs 25Δ call IV 51.5% — skew -0.5% (balanced)
    - Same-day flow at this expiry: 448 call vol vs 203 put vol (C/P 2.21)
