...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #72 of 112 in universe (earnings yield 2.3%, return on capital 27.3%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.37
  - Momentum: 6-mo +52.5%, 12-mo +38.4%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $49.26, margin of safety -486.4%
...
## Raw data fields (yfinance)
  - forwardPE: 30.175959
  - trailingPE: 49.382053
  - enterpriseToEbitda: 30.863
  - enterpriseToRevenue: 14.504
  - pegRatio: 1.367
  ...
  - currentPrice: 288.885
  - heldPercentInstitutions: 0.93934995
...
## Recent news headlines
  ...
  - Wall St futures climb ahead of this week's megacap earnings (2026-07-20)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 66.0% vs 25Δ call IV 63.6% — skew +2.4% (balanced)
    - Same-day flow at this expiry: 37 call vol vs 282 put vol (C/P 0.13)
