...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - No contract proposed: against: flow_proxy, trend, vol_mispricing; IV/RVf 1.17 >= 1.15 — vol too rich to buy

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #74 of 109 in universe (earnings yield 1.3%, return on capital 44.8%)
  - Piotroski F-Score: 5/9 (1 tests gapped) (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.28
  - Momentum: 6-mo +49.4%, 12-mo +260.2%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $49.31, margin of safety -590.7%
...
## Raw data fields (yfinance)
  - forwardPE: 34.630306
  - trailingPE: 63.31784
  - enterpriseToEbitda: 43.306
  - enterpriseToRevenue: 13.283
  - pegRatio: 1.2755
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-28 (~45d): ATM IV 117.3%
    - 25Δ put IV 113.9% vs 25Δ call IV 109.3% — skew +4.6% (balanced)
    - Same-day flow at this expiry: 55 call vol vs 52 put vol (C/P 1.06)
