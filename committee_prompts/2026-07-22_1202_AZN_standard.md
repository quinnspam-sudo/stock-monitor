...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - No contract proposed: against: catalyst, flow_proxy, trend; 6-mo momentum -6% < 0% (falling knife); price below 200d SMA

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #17 of 108 in universe (earnings yield 4.9%, return on capital 109.4%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.34
  - Momentum: 6-mo -5.7%, 12-mo +22.0%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $67.57, margin of safety -150.1%
...
## Raw data fields (yfinance)
  - forwardPE: 19.254436
  - trailingPE: 25.44729
  - enterpriseToEbitda: 14.417
  - enterpriseToRevenue: 4.777
  - pegRatio: 1.3354
  ...
  - currentPrice: 168.97
  - heldPercentInstitutions: 0.68362
  - numberOfAnalystOpinions: 10

## Recent news headlines
  - Will AbbVie's Oncology Franchise Remain Under Pressure in Q2? (2026-07-22)
  - Jefferies says September lung data can offset AstraZeneca trial failure (2026-07-22)
  - Trump Takes Another Swing at Drug Industry in Made-in-USA Push (2026-07-22)
  - Stay Ahead of the Game With Astrazeneca (AZN) Q2 Earnings: Wall Street's Insights on Key Metrics (2026-07-22)
  - Will Keytruda Remain the Driving Force Behind Merck's Q2 Performance? (2026-07-22)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 32.8% vs 25Δ call IV 31.5% — skew +1.4% (balanced)
    - Same-day flow at this expiry: 153 call vol vs 693 put vol (C/P 0.22)
