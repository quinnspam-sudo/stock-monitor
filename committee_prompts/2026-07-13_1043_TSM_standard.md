...
Generated: 2026-07-13 10:43 local | Source: stock-monitor local daemon
...
- Previous evaluation date: 2026-07-13 10:25
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #16 of 115 in universe (earnings yield 13.0%, return on capital 34.1%)
  - Piotroski F-Score: 9/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.36
  - Momentum: 6-mo +31.7%, 12-mo +87.4%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $33.82, margin of safety -1153.8%
...
## Recent news headlines
  ...
  - Arm And Marvell Tumble As Chip Stocks Sell Off (2026-07-13)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 51.6% vs 25Δ call IV 53.6% — skew -2.0% (upside being chased (call skew))
    - Same-day flow at this expiry: 310 call vol vs 1,008 put vol (C/P 0.31)
