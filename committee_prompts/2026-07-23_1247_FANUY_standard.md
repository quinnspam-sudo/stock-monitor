...
## Trigger(s) breached
- Earnings gate OPENED — earnings in 6 business day(s), positivity 71/100, beat streak 3/4 — buy decision is now actionable
...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - HARD VETO: hostile market regime: SPY>!50d/200d, VIX 19.2 (max 28.0), term 0.919
  - No contract proposed: against: trend; 6-mo momentum -2% < 0% (falling knife); hostile market regime: SPY>!50d/200d, VIX 19.2 (max 28.0), term 0.919

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #94 of 107 in universe (earnings yield -26.4%, return on capital 11.1%)
  - Piotroski F-Score: 7/9 (1 tests gapped) (8-9 strong, 0-2 weak)
  - PEG (GARP): 3.39
  - Momentum: 6-mo -1.7%, 12-mo +40.0%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: GAPPED; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $8.70, margin of safety -136.4%
  - CANSLIM (O'Neil): 0/7 criteria met — C: N; A: N; N: N; S: N; L: N; I: N; M: N
  - Dividend growth quality (if applicable): yield 511.2%, payout 19471%, quality score 35/100
...
## Raw data fields (yfinance)
  - forwardPE: 30.716417
  - trailingPE: 37.418182
  - enterpriseToEbitda: -3.009
