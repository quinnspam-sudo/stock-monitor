...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #67 of 102 in universe (earnings yield 2.6%, return on capital 27.2%)
  - Piotroski F-Score: 4/9 (1 tests gapped) (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.57
  - Momentum: 6-mo -9.6%, 12-mo -9.4%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: FAIL
  - Graham/Buffett intrinsic value: Graham Number $21.89, margin of safety -341.8%
...
## Recent news headlines
  ...
  - Robinhood's New Blockchain Has Been a Smash Success. Here's Why That's Bearish for Ethereum. (2026-07-25)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-09-04 (~45d): ATM IV 85.1%
    - 25Δ put IV 71.1% vs 25Δ call IV 79.0% — skew -7.9% (upside being chased (call skew))
    - Same-day flow at this expiry: 157 call vol vs 67 put vol (C/P 2.34)
