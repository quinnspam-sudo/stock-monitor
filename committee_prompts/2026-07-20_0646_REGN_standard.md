...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #24 of 109 in universe (earnings yield 8.4%, return on capital 28.1%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.17
  - Momentum: 6-mo -8.0%, 12-mo +24.0%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $532.93, margin of safety -26.3%
...
## Raw data fields (yfinance)
  ...
  - targetMeanPrice: 819.1758
  - currentPrice: 672.88
  - heldPercentInstitutions: 0.93447995
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - Same-day flow at this expiry: 79 call vol vs 103 put vol (C/P 0.77)
