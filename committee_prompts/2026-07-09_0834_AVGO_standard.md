...
## Trigger(s) breached
- Entered Top 5 ranked opportunities (rank 8 → 5)
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #44 of 91 in universe (earnings yield 1.4%, return on capital 166.4%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 0.44 (GARP: attractive <= 1)
  - Momentum: 6-mo +16.8%, 12-mo +44.8%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $49.96, margin of safety -699.7%
...
## Recent news headlines
  ...
  - Tech stocks live: Tech stocks buffeted by AI bubble concerns, dip-buying (2026-07-06)
  - Apple & Broadcom ramp up American manufacturing with $30B AI chip partnership (2026-07-08)
  - Meta Reportedly Takes Big Step Toward AI Chip. But The Stock Is Falling. (2026-07-09)
  - Stock Market Today: Dow Builds Gains Amid U.S.-Iran News; Arm, Dell Lead Upside (Live Coverage) (2026-07-09)
