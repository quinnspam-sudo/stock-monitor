...
## confirm or veto the positivity call using transcript/guidance judgment)
  ...
  - GATE VERDICT: NOT ACTIONABLE — no confirmed upcoming earnings date; only 2/5 positivity signals available (need ≥3); positivity 31/100 below strict bar 70; beat streak 1/4 quarters (strict bar: ≥3/4)
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #83 of 107 in universe (earnings yield 0.8%, return on capital 23.2%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.45
  - Momentum: 6-mo +42.8%, 12-mo +92.2%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $17.96, margin of safety -1407.4%
  - CANSLIM (O'Neil): 4/7 criteria met — C: Y; A: Y; N: N; S: N; L: Y; I: N; M: Y
  - Dividend growth quality (if applicable): yield 0.6%, payout 72%, quality score 50/100
...
## Raw data fields (yfinance)
  - trailingPE: 124.18348
  - enterpriseToEbitda: 106.912
  - enterpriseToRevenue: 35.316
  - pegRatio: 1.451
