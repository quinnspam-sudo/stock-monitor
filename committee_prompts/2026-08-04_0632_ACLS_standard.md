...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #64 of 108 in universe (earnings yield 3.8%, return on capital 17.0%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +63.4%, 12-mo +94.5%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: FAIL
  - Graham/Buffett intrinsic value: Graham Number $49.78, margin of safety -177.0%
...
## Raw data fields (yfinance)
  - forwardPE: 28.439562
  - trailingPE: 42.554012
  - enterpriseToEbitda: 34.525
  - enterpriseToRevenue: 4.416
  ...
  - currentPrice: 137.875
  - heldPercentInstitutions: 1.06956
  - numberOfAnalystOpinions: 3

## Recent news headlines
  - Ultra Clean Holdings (UCTT) Beats Q2 Earnings and Revenue Estimates (2026-08-03)
  - Axcelis (ACLS) Stock Could Stay Above Fair Value On Purion XEmax News (2026-07-28)
  ...
  - Axcelis Technologies (ACLS) Stock Sinks As Market Gains: Here's Why (2026-07-24)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  - Short interest trend:
    - Shares short 1,769,809 vs 1,913,857 prior month (-7.5% — FALLING)
    - Days-to-cover 2.7
  ...
  - Options skew / flow:
    ...
    - Same-day flow at this expiry: 253 call vol vs 356 put vol (C/P 0.71)
