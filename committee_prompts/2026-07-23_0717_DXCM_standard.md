...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #47 of 104 in universe (earnings yield 4.2%, return on capital 31.4%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.39
  - Momentum: 6-mo -4.0%, 12-mo -17.9%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $20.04, margin of safety -253.9%
...
## Raw data fields (yfinance)
  - forwardPE: 23.067648
  - trailingPE: 30.467812
  - enterpriseToEbitda: 20.531
  - enterpriseToRevenue: 5.507
  - pegRatio: 1.3938
  ...
  - targetMeanPrice: 85.75
  - currentPrice: 70.99
  - heldPercentInstitutions: 1.0449901
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-28 (~45d): ATM IV 58.0%
    - 25Δ put IV 58.7% vs 25Δ call IV 57.8% — skew +1.0% (balanced)
