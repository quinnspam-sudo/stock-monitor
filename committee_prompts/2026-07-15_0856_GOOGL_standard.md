...
Generated: 2026-07-15 08:56 local | Source: stock-monitor local daemon
...
- Previous evaluation date: 2026-07-15 07:58
...
## Supermajority consensus vote (last gate before a BUY alert)
  - Verdict: PASS — 6/9 systems bullish (supermajority 65%, min 6 computable)
    ...
    - positivity_margin: ✔
    - quality_gates: ✔
  - Market regime: SPY>50d/200d, VIX 16.1 (max 28.0), term 0.84 — OK
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #47 of 135 in universe (earnings yield 3.7%, return on capital 43.7%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.42
  - Momentum: 6-mo +10.8%, 12-mo +104.9%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $108.00, margin of safety -244.3%
...
## Recent news headlines
  ...
  - Warren Buffett’s 3 Favorite Stocks: Buy, Sell or Hold? (2026-07-15)
  - Apple explores chip acquisitions to bolster AI server capabilities (2026-07-15)
  - VUG vs. SCHG: The Growth-ETF Showdown That Could Quietly Cost You Thousands (2026-07-15)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-28 (~45d): ATM IV 37.1%
    - 25Δ put IV 39.7% vs 25Δ call IV 37.4% — skew +2.3% (balanced)
    - Same-day flow at this expiry: 257 call vol vs 73 put vol (C/P 3.52)
