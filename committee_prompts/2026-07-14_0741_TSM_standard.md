...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #14 of 117 in universe (earnings yield 13.5%, return on capital 34.1%)
  - Piotroski F-Score: 9/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.32
  - Momentum: 6-mo +28.8%, 12-mo +87.9%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $33.33, margin of safety -1175.3%
...
## Recent news headlines
  ...
  - Why these two earnings reports could be "tone-setting" for the chip sector (2026-07-14)
  - Here’s How Much TSMC Stock Is Expected to Move After Earnings (2026-07-14)
  - TSMC’s June revenue jump breaks a four-year seasonal pattern (2026-07-14)
  - Chip toolmaker ASML expected to shine light on capacity and China challenges (2026-07-14)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 52.0% vs 25Δ call IV 52.9% — skew -0.9% (balanced)
    - Same-day flow at this expiry: 309 call vol vs 1,481 put vol (C/P 0.21)
