...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #6 of 108 in universe (earnings yield 5.7%, return on capital 159.3%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 4.16
  - Momentum: 6-mo +3.9%, 12-mo -3.5%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $59.60, margin of safety -150.9%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-28 (~45d): ATM IV 26.5%
    - 25Δ put IV 27.7% vs 25Δ call IV 25.6% — skew +2.1% (balanced)
    - Same-day flow at this expiry: 287 call vol vs 64 put vol (C/P 4.48)
