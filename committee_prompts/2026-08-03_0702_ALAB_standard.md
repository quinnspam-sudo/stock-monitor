...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #87 of 109 in universe (earnings yield 0.3%, return on capital 13.1%)
  - Piotroski F-Score: 5/9 (1 tests gapped) (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +99.2%, 12-mo +120.2%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $17.10, margin of safety -1675.8%
...
## Raw data fields (yfinance)
  ...
  - targetMeanPrice: 305.64954
  - currentPrice: 303.66
  - heldPercentInstitutions: 0.73159
  - numberOfAnalystOpinions: 22

## Recent news headlines
  - Astera Labs vs. Arista Networks: Which Tech Stock Is a Better Buy in 2026? (2026-08-01)
  - Jim Cramer sends major Astera Labs signal to investors (2026-08-01)
  - Should You Buy, Sell, or Hold ALAB Stock Before Q2 Earnings Release? (2026-07-31)
  - AMD Stock Rebounds With Chips Ahead Of Q2 Report; SpaceX Earnings, Lockup Expiration Loom Large (2026-07-31)
  - Astera Labs vs. Intel: Which Technology Stock Is a Better Buy in 2026? (2026-07-31)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-09-18 (~45d): ATM IV 116.9%
    - 25Δ put IV 124.4% vs 25Δ call IV 110.9% — skew +13.5% (heavy downside-protection bid (fear))
    - Same-day flow at this expiry: 701 call vol vs 375 put vol (C/P 1.87)
