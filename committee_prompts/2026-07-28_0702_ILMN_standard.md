...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #41 of 103 in universe (earnings yield 3.9%, return on capital 41.9%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 3.39
  - Momentum: 6-mo +26.9%, 12-mo +75.6%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $46.63, margin of safety -313.8%
...
## Raw data fields (yfinance)
  - forwardPE: 32.5275
  - trailingPE: 35.152096
  - enterpriseToEbitda: 26.022
  - enterpriseToRevenue: 6.842
  - pegRatio: 3.3917
  ...
  - currentPrice: 192.985
  - heldPercentInstitutions: 1.0712
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 55.1% vs 25Δ call IV 50.6% — skew +4.5% (balanced)
    - Same-day flow at this expiry: 119 call vol vs 84 put vol (C/P 1.42)
