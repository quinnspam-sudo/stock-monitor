...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #40 of 108 in universe (earnings yield 3.0%, return on capital 120.0%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 3.58
  - Momentum: 6-mo -10.9%, 12-mo -16.5%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $77.49, margin of safety -635.5%
...
## Raw data fields (yfinance)
  - forwardPE: 34.506718
  - trailingPE: 41.93818
  - enterpriseToEbitda: 29.113
  - enterpriseToRevenue: 10.123
  - pegRatio: 3.5825
  ...
  - currentPrice: 569.9399
  - heldPercentInstitutions: 0.96039003
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 46.5% vs 25Δ call IV 45.2% — skew +1.4% (balanced)
