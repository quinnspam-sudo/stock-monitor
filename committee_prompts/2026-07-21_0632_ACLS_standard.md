...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #63 of 100 in universe (earnings yield 3.8%, return on capital 17.0%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +56.1%, 12-mo +84.7%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: FAIL
  - Graham/Buffett intrinsic value: Graham Number $49.55, margin of safety -177.8%
  ...
  - 52-week high breakout (O'Neil/Darvas): -29.0% from 52-wk high
...
## Raw data fields (yfinance)
  - forwardPE: 28.39212
  - trailingPE: 42.880062
  - enterpriseToEbitda: 34.69
  ...
  - currentPrice: 137.645
  - heldPercentInstitutions: 1.07223
...
## Recent news headlines
  ...
  - Here's Why Axcelis Technologies (ACLS) Fell More Than Broader Market (2026-06-16)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - Same-day flow at this expiry: 685 call vol vs 328 put vol (C/P 2.09)
