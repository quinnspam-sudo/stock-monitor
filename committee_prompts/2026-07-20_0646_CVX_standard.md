...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #62 of 109 in universe (earnings yield 5.0%, return on capital 9.3%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 0.77 (GARP: attractive <= 1)
  - Momentum: 6-mo +15.0%, 12-mo +30.6%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $109.44, margin of safety -71.4%
  - CANSLIM (O'Neil): 3/7 criteria met — C: N; A: N; N: N; S: N; L: Y; I: Y; M: Y
  - Dividend growth quality (if applicable): yield 3.7%, payout 121%, quality score 59/100, 5yr div CAGR +5.8%
...
## Raw data fields (yfinance)
  ...
  - currentPrice: 187.53
  - heldPercentInstitutions: 0.70328003
...
## Recent news headlines
  ...
  - Why Are BATL, TPET, XOM, CVX, USO, UCO Stocks Rising Overnight? (2026-07-20)
  - 68% of Greg Abel's Berkshire Hathaway Portfolio Is Invested in Just 5 Stocks. Here's My Favorite of the Bunch. (2026-07-19)
  - Chevron Is Hungry for More Power Deals After Inking a 2.7-Gigawatt Contract With Microsoft. Here's Where the Energy Giant Is Looking Next. (2026-07-19)
  - Chevron (CVX) Cuts 9,000 Jobs As Record Oil Output Reshapes Its Workforce (2026-07-18)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - Same-day flow at this expiry: 328 call vol vs 215 put vol (C/P 1.53)
  - Commodity driver (futures):
    - WTI crude (CL=F): 81.20, 3-mo -9.4%, below 50d SMA — headwind
