...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  ...
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +63.8%, 12-mo +107.0%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $94.41, margin of safety -504.0%
...
## Raw data fields (yfinance)
  - forwardPE: 44.162663
  - trailingPE: 59.904934
  - enterpriseToEbitda: 38.17
  ...
  - currentPrice: 570.295
  - heldPercentInstitutions: 0.9605
  - numberOfAnalystOpinions: 9

## Recent news headlines
  - Nucor's Q2 Earnings and Revenues Surpass Estimates on Higher Prices (2026-07-28)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - Same-day flow at this expiry: 414 call vol vs 1,159 put vol (C/P 0.36)
