...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  ...
  - PEG (GARP): 2.14
  - Momentum: 6-mo -8.5%, 12-mo +15.7%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $55.92, margin of safety -130.9%
...
## Recent news headlines
  ...
  - Stocks Set to Open Higher as Oil Sinks on U.S.-Iran Deal Hopes, Jobs Data and Earnings Awaited (2026-08-03)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 35.1% vs 25Δ call IV 35.2% — skew -0.0% (balanced)
    - Same-day flow at this expiry: 534 call vol vs 162 put vol (C/P 3.30)
