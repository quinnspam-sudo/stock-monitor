...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #73 of 95 in universe (earnings yield 1.3%, return on capital 17.5%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 0.54 (GARP: attractive <= 1)
  - Momentum: 6-mo -13.9%, 12-mo +13.4%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $26.86, margin of safety -1254.4%
...
## Recent news headlines
  ...
  - AstraZeneca and Ionis Stocks Sink on Trial Miss and Analysts See an Overreaction (2026-07-09)
  ...
  - Can Alnylam's Drug Pipeline Fuel Its Long-Term Revenue Growth? (2026-07-06)
