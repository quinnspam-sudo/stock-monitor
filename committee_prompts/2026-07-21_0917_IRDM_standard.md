...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #76 of 104 in universe (earnings yield 3.5%, return on capital 10.9%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.23
  - Momentum: 6-mo +148.8%, 12-mo +50.6%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $9.93, margin of safety -374.0%
...
## Raw data fields (yfinance)
  - forwardPE: 39.734177
  - trailingPE: 47.560604
  - enterpriseToEbitda: 15.012
  - enterpriseToRevenue: 7.518
  - pegRatio: 2.2312
...
## Recent news headlines
  ...
  - Iridium (IRDM) Launches A New Chip For GPS Spoofing And Jamming Risks (2026-07-19)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 44.2% vs 25Δ call IV 42.5% — skew +1.7% (balanced)
    - Same-day flow at this expiry: 334 call vol vs 44 put vol (C/P 7.59)
