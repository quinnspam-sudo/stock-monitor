...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - HARD VETO: hostile market regime: SPY>!50d/200d, VIX 17.0 (max 28.0), term 0.872
  - No contract proposed: against: flow_proxy, trend; hostile market regime: SPY>!50d/200d, VIX 17.0 (max 28.0), term 0.872

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #90 of 103 in universe (earnings yield 0.1%, return on capital 3.2%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.68
  - Momentum: 6-mo +114.3%, 12-mo +98.0%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $10.04, margin of safety -2658.9%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - Same-day flow at this expiry: 342 call vol vs 281 put vol (C/P 1.22)
