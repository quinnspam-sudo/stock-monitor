...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #87 of 104 in universe (earnings yield 0.9%, return on capital 9.9%)
  - Piotroski F-Score: 4/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +38.4%, 12-mo +192.8%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $16.31, margin of safety -528.1%
...
## Raw data fields (yfinance)
  - forwardPE: 36.693237
  - trailingPE: 117.72414
  - enterpriseToEbitda: 57.055
  - enterpriseToRevenue: 9.335
  - freeCashflow: -566875
  ...
  - currentPrice: 102.42
  - heldPercentInstitutions: 0.98164004
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  - Short interest trend:
    - Shares short 2,786,071 vs 3,253,513 prior month (-14.4% — FALLING)
    - Days-to-cover 1.4
  ...
  - Options skew / flow:
    ...
    - Same-day flow at this expiry: 107 call vol vs 67 put vol (C/P 1.60)
