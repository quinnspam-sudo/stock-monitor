...
## Trigger(s) breached
- Earnings gate OPENED — earnings in 2 business day(s), positivity 74/100, beat streak 3/4 — buy decision is now actionable
...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - HARD VETO: hostile market regime: SPY>!50d/200d, VIX 19.2 (max 28.0), term 0.915
  - No contract proposed: against: catalyst, flow_proxy, trend; 6-mo momentum -7% < 0% (falling knife); price below 200d SMA; hostile market regime: SPY>!50d/200d, VIX 19.2 (max 28.0), term 0.915

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #15 of 103 in universe (earnings yield 4.8%, return on capital 109.4%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.34
  - Momentum: 6-mo -7.0%, 12-mo +17.6%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $67.57, margin of safety -149.8%
  ...
  - Analyst estimate revision momentum: +28.6% (current vs 90 days ago)
...
## Raw data fields (yfinance)
  - forwardPE: 19.235065
  - trailingPE: 25.421688
  - enterpriseToEbitda: 14.447
  - enterpriseToRevenue: 4.787
  - pegRatio: 1.3354
  ...
  - targetMeanPrice: 213.89
  - currentPrice: 168.8
  - heldPercentInstitutions: 0.68366
  - numberOfAnalystOpinions: 10

## Recent news headlines
  - Will GSK's Specialty Medicines Boost Q2 Revenue Growth? (2026-07-23)
  - Exchange-Traded Funds, Equity Futures Lower Pre-Bell Thursday Amid Major Tech Stocks Sell-Off (2026-07-23)
  - European Stock Indexes Fall as Tech Struggles Extend (2026-07-23)
  - AstraZeneca Wins EU Approval for Breast-Cancer Drug as U.S. Review Continues (2026-07-23)
  - Will AbbVie's Oncology Franchise Remain Under Pressure in Q2? (2026-07-22)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 34.9% vs 25Δ call IV 30.3% — skew +4.6% (balanced)
    - Same-day flow at this expiry: 259 call vol vs 669 put vol (C/P 0.39)
