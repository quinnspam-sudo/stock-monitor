...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #94 of 113 in universe (earnings yield 0.1%, return on capital 22.8%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.49
  - Momentum: 6-mo +10.3%, 12-mo +54.9%
  - Quality gates (Buffett-style): ROE >= 15%: GAPPED; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: FAIL
  - Graham/Buffett intrinsic value: Graham Number $49.01, margin of safety -1674.6%
...
## Raw data fields (yfinance)
  - forwardPE: 23.664629
  - trailingPE: 38.5663
  - enterpriseToEbitda: 1029.59
  - enterpriseToRevenue: 286.201
  - pegRatio: 1.4912
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - Same-day flow at this expiry: 144 call vol vs 165 put vol (C/P 0.87)
