...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #34 of 108 in universe (earnings yield 6.8%, return on capital 18.5%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.17
  - Momentum: 6-mo -2.5%, 12-mo +7.2%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: FAIL; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $73.66, margin of safety -23.2%
...
## Raw data fields (yfinance)
  ...
  - currentPrice: 90.784
  - heldPercentInstitutions: 0.91646004
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-21 (~45d): ATM IV 42.1%
    - 25Δ put IV 39.1% vs 25Δ call IV 35.4% — skew +3.7% (balanced)
    - Same-day flow at this expiry: 100 call vol vs 95 put vol (C/P 1.05)
