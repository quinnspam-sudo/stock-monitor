...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #58 of 106 in universe (earnings yield 1.9%, return on capital 64.4%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.09
  - Momentum: 6-mo +13.6%, 12-mo +40.2%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $82.90, margin of safety -484.0%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 46.1% vs 25Δ call IV 42.3% — skew +3.8% (balanced)
    - Same-day flow at this expiry: 37 call vol vs 5 put vol (C/P 7.40)
