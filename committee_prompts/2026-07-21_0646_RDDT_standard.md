...
## confirm or veto the positivity call using transcript/guidance judgment)
  ...
  - Earnings Positivity Score: 93/100 (strict pass bar 70, beat streak None/0 last quarters)
...
## Supermajority consensus vote (last gate before a BUY alert)
  - Verdict: FAIL — 2/2 systems bullish (supermajority 65%, min 6 computable)
    - momentum_timing: ✔
