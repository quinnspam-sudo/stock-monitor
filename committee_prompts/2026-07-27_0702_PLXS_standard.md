...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - HARD VETO: hostile market regime: SPY>!50d/200d, VIX 18.2 (max 28.0), term 0.908
  - No contract proposed: against: catalyst, trend, vol_mispricing; IV/RVf 1.22 >= 1.15 — vol too rich to buy; hostile market regime: SPY>!50d/200d, VIX 18.2 (max 28.0), term 0.908

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #70 of 102 in universe (earnings yield 2.9%, return on capital 13.3%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +44.7%, 12-mo +102.0%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $92.43, margin of safety -172.5%
...
## Raw data fields (yfinance)
  - forwardPE: 26.591003
  - trailingPE: 36.931084
  - enterpriseToEbitda: 22.6
  - enterpriseToRevenue: 1.571
  ...
  - currentPrice: 251.87
  - heldPercentInstitutions: 1.04475
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  - Short interest trend:
    - Shares short 846,430 vs 882,096 prior month (-4.0% — FALLING)
    - Days-to-cover 2.5
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 135.8% vs 25Δ call IV 52.8% — skew +83.0% (heavy downside-protection bid (fear))
