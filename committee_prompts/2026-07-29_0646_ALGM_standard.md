...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #93 of 104 in universe (earnings yield 0.1%, return on capital 1.1%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +29.3%, 12-mo +31.4%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 104.5% vs 25Δ call IV 98.5% — skew +6.1% (heavy downside-protection bid (fear))
    - Same-day flow at this expiry: 163 call vol vs 310 put vol (C/P 0.53)
