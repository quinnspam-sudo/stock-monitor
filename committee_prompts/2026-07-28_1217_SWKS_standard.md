...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - HARD VETO: hostile market regime: SPY>!50d/200d, VIX 18.2 (max 28.0), term 0.918
  - No contract proposed: against: flow_proxy, trend, vol_mispricing; hostile market regime: SPY>!50d/200d, VIX 18.2 (max 28.0), term 0.918

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #40 of 105 in universe (earnings yield 5.9%, return on capital 17.6%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.37
  - Momentum: 6-mo +10.2%, 12-mo -5.3%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $45.50, margin of safety -42.5%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-09-18 (~45d): ATM IV 59.8%
    - 25Δ put IV 68.6% vs 25Δ call IV 59.6% — skew +8.9% (heavy downside-protection bid (fear))
    - Same-day flow at this expiry: 190 call vol vs 246 put vol (C/P 0.77)
