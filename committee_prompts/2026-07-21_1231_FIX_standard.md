...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - No contract proposed: against: flow_proxy, trend, vol_mispricing; IV/RVf 1.28 >= 1.15 — vol too rich to buy

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #51 of 107 in universe (earnings yield 2.1%, return on capital 91.1%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 0.82 (GARP: attractive <= 1)
  - Momentum: 6-mo +55.2%, 12-mo +223.6%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $119.52, margin of safety -1372.2%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-21 (~45d): ATM IV 81.2%
    - 25Δ put IV 77.9% vs 25Δ call IV 77.5% — skew +0.4% (balanced)
    - Same-day flow at this expiry: 251 call vol vs 305 put vol (C/P 0.82)
