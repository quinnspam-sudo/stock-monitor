...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #72 of 103 in universe (earnings yield 2.7%, return on capital 21.4%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +19.2%, 12-mo +1.2%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $15.83, margin of safety -204.6%
...
## Raw data fields (yfinance)
  ...
  - currentPrice: 48.225
  - heldPercentInstitutions: 0.27783
