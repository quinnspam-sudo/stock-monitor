...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #32 of 101 in universe (earnings yield 4.4%, return on capital 45.1%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.18
  - Momentum: 6-mo -17.8%, 12-mo -24.8%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $145.16, margin of safety -162.6%
...
## Raw data fields (yfinance)
  - forwardPE: 19.677162
  - trailingPE: 22.711136
  - enterpriseToEbitda: 15.623
  - enterpriseToRevenue: 9.054
  - pegRatio: 1.1803
  ...
  - currentPrice: 381.32
  - heldPercentInstitutions: 0.76448995
...
## Recent news headlines
  ...
  - India Orders Shutdown Of Messaging App Bitchat (2026-07-24)
...
## Recent insider transactions
  ...
  - STANTON JOHN W. — Stock Award(Grant) at price 0.00 per share. (2026-06-05)
  - SCHARF CHARLES W — Stock Award(Grant) at price 0.00 per share. (2026-06-05)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 40.5% vs 25Δ call IV 50.0% — skew -9.5% (upside being chased (call skew))
    - Same-day flow at this expiry: 234 call vol vs 802 put vol (C/P 0.29)
