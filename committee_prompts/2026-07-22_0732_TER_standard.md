...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #72 of 106 in universe (earnings yield 1.1%, return on capital 44.8%)
  - Piotroski F-Score: 5/9 (1 tests gapped) (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.32
  - Momentum: 6-mo +60.2%, 12-mo +297.2%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $52.16, margin of safety -612.0%
  - CANSLIM (O'Neil): 5/7 criteria met — C: Y; A: Y; N: N; S: N; L: Y; I: Y; M: Y
  - Dividend growth quality (if applicable): yield 0.1%, payout 8%, quality score 67/100, 5yr div CAGR -2.8%
...
## Raw data fields (yfinance)
  - forwardPE: 36.099354
  - trailingPE: 61.667774
  - enterpriseToEbitda: 50.273
  - enterpriseToRevenue: 15.419
  - pegRatio: 1.3206
  ...
  - currentPrice: 371.24
  - heldPercentInstitutions: 0.98102
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-28 (~45d): ATM IV 110.3%
    - 25Δ put IV 113.7% vs 25Δ call IV 107.3% — skew +6.5% (heavy downside-protection bid (fear))
    - Same-day flow at this expiry: 76 call vol vs 51 put vol (C/P 1.49)
