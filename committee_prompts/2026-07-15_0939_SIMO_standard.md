...
Generated: 2026-07-15 09:39 local | Source: stock-monitor local daemon
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  ...
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +151.9%, 12-mo +306.9%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: GAPPED; Gross margin > 40%: PASS; CFO > Net Income: FAIL
  - Graham/Buffett intrinsic value: Graham Number $55.35, margin of safety -413.9%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 109.6% vs 25Δ call IV 120.1% — skew -10.5% (upside being chased (call skew))
    - Same-day flow at this expiry: 500 call vol vs 125 put vol (C/P 4.00)
