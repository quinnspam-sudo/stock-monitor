...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #84 of 106 in universe (earnings yield -184.7%, return on capital 35.8%)
  - Piotroski F-Score: 4/9 (1 tests gapped) (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.01
  - Momentum: 6-mo +25.7%, 12-mo +83.4%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: GAPPED; Gross margin > 40%: PASS; CFO > Net Income: FAIL
  - Graham/Buffett intrinsic value: Graham Number $34.70, margin of safety -384.5%
  - CANSLIM (O'Neil): 3/7 criteria met — C: Y; A: Y; N: N; S: N; L: Y; I: N; M: N
  - Dividend growth quality (if applicable): yield 340.7%, payout 16354%, quality score 35/100
...
## Raw data fields (yfinance)
  - trailingPE: 43.776043
  - enterpriseToEbitda: -0.479
  - enterpriseToRevenue: -0.138
  - pegRatio: 2.012
...
## Recent news headlines
  - Teradyne (TER) Earnings Put AI Driven Fair Value Narrative To The Test (2026-07-28)
  - KOSPI Crashes 8% as AI Chip Selloff Slams Asian Markets (2026-07-28)
