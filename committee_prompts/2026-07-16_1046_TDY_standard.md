...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #31 of 112 in universe (earnings yield 3.7%, return on capital 56.7%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +11.3%, 12-mo +16.0%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $320.19, margin of safety -95.6%
...
## Raw data fields (yfinance)
  - forwardPE: 24.061056
  - trailingPE: 31.763693
  - enterpriseToEbitda: 20.068
  - enterpriseToRevenue: 4.959
  ...
  - currentPrice: 626.38
  - heldPercentInstitutions: 1.00377
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 51.2% vs 25Δ call IV 43.6% — skew +7.7% (heavy downside-protection bid (fear))
