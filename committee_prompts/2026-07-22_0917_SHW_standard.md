...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #25 of 107 in universe (earnings yield 4.1%, return on capital 72.9%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.46
  - Momentum: 6-mo -9.6%, 12-mo -4.9%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $65.06, margin of safety -392.6%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 31.5% vs 25Δ call IV 30.3% — skew +1.2% (balanced)
    - Same-day flow at this expiry: 57 call vol vs 150 put vol (C/P 0.38)
