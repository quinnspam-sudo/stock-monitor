...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #17 of 132 in universe (earnings yield 13.0%, return on capital 34.1%)
  - Piotroski F-Score: 9/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.36
  - Momentum: 6-mo +31.8%, 12-mo +87.7%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $33.82, margin of safety -1155.3%
...
## Recent news headlines
  - TSMC Revenue Tops Forecasts on AI Strength (2026-07-13)
  - TSMC Reports 36% Sales Growth as AI Demand Stays Strong (2026-07-13)
  - Premium Smartphone Demand Holds Up: What's Ahead for Amkor Technology? (2026-07-13)
  - Stock Market Today: Dow Drops As Trump Reinstates Hormuz Blockade; Oil Refiners Rise (Live Coverage) (2026-07-13)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 50.3% vs 25Δ call IV 53.0% — skew -2.8% (upside being chased (call skew))
    - Same-day flow at this expiry: 318 call vol vs 1,012 put vol (C/P 0.31)
