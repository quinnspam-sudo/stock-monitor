...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #65 of 106 in universe (earnings yield 1.7%, return on capital 60.8%)
  - Piotroski F-Score: 9/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.24
  - Momentum: 6-mo +42.5%, 12-mo +143.8%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $18.80, margin of safety -1049.7%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 95.8% vs 25Δ call IV 88.1% — skew +7.8% (heavy downside-protection bid (fear))
    - Same-day flow at this expiry: 2,493 call vol vs 6,847 put vol (C/P 0.36)
