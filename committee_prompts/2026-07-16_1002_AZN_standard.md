...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #23 of 115 in universe (earnings yield 4.9%, return on capital 109.4%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.32
  - Momentum: 6-mo -11.0%, 12-mo +23.2%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $67.52, margin of safety -151.4%
...
## Recent news headlines
  ...
  - Eli Lilly-Backed Novel Cancer Therapy Firm Raises $315 Million (2026-07-15)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 33.5% vs 25Δ call IV 31.7% — skew +1.8% (balanced)
    - Same-day flow at this expiry: 202 call vol vs 390 put vol (C/P 0.52)
