...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #27 of 109 in universe (earnings yield 3.6%, return on capital 82.3%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 0.16 (GARP: attractive <= 1)
  - Momentum: 6-mo -35.7%, 12-mo -49.0%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $2.90, margin of safety -232.0%
  ...
  - 52-week high breakout (O'Neil/Darvas): -54.4% from 52-wk high
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 60.4% vs 25Δ call IV 50.2% — skew +10.2% (heavy downside-protection bid (fear))
