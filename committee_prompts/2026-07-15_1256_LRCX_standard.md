...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #63 of 136 in universe (earnings yield 1.4%, return on capital 59.1%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.00
  - Momentum: 6-mo +56.2%, 12-mo +232.4%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $31.77, margin of safety -952.7%
...
## Recent news headlines
  - Stock Market Today: Nasdaq Gains Steam; PayPal Surges, But Sandisk, Chip Stocks Tumble (Live Coverage) (2026-07-15)
  ...
  - FTSE 100 Live: Miners drag over China slowdown, oil softens despite new Iran strikes (2026-07-15)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-28 (~45d): ATM IV 89.2%
    - 25Δ put IV 93.9% vs 25Δ call IV 88.4% — skew +5.6% (balanced)
    - Same-day flow at this expiry: 63 call vol vs 84 put vol (C/P 0.75)
