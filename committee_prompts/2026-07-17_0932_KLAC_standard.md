...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #65 of 110 in universe (earnings yield 1.7%, return on capital 60.8%)
  - Piotroski F-Score: 9/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.27
  - Momentum: 6-mo +38.8%, 12-mo +129.8%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $18.82, margin of safety -1036.4%
...
## Raw data fields (yfinance)
  ...
  - currentPrice: 213.935
  - heldPercentInstitutions: 0.94668
  - numberOfAnalystOpinions: 28

## Recent news headlines
  - Micron, Nvidia, Netflix, SK Hynix, Intuitive Surgical, and More Stocks That Explain Today’s Market (2026-07-17)
  - Micron Technology: Record DRAM Pricing Meets A Stock In Retreat (2026-07-17)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-21 (~45d): ATM IV 93.2%
    - 25Δ put IV 92.2% vs 25Δ call IV 89.6% — skew +2.6% (balanced)
    - Same-day flow at this expiry: 1,815 call vol vs 2,447 put vol (C/P 0.74)
