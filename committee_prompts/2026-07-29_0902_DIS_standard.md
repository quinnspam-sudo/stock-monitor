...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #17 of 104 in universe (earnings yield 6.3%, return on capital 44.1%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.31
  - Momentum: 6-mo -9.1%, 12-mo -16.4%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $93.60, margin of safety -5.6%
...
## Recent news headlines
  - Walt Disney (DIS) Reports Next Week: Wall Street Expects Earnings Growth (2026-07-29)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-09-18 (~45d): ATM IV 33.0%
    - 25Δ put IV 30.8% vs 25Δ call IV 32.2% — skew -1.5% (balanced)
    - Same-day flow at this expiry: 699 call vol vs 1,284 put vol (C/P 0.54)
