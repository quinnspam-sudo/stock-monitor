...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #22 of 118 in universe (earnings yield 3.7%, return on capital 103.0%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.23
  - Momentum: 6-mo -4.2%, 12-mo +3.9%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $73.35, margin of safety -595.4%
...
## Raw data fields (yfinance)
  - forwardPE: 27.381628
  - trailingPE: 36.56523
  - enterpriseToEbitda: 24.242
  - enterpriseToRevenue: 11.744
  - pegRatio: 2.2328
  ...
  - targetMeanPrice: 541.0
  - currentPrice: 510.085
  - heldPercentInstitutions: 0.8092
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 33.9% vs 25Δ call IV 31.2% — skew +2.7% (balanced)
    - Same-day flow at this expiry: 1,963 call vol vs 133 put vol (C/P 14.76)
