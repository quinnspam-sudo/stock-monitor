...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #40 of 100 in universe (earnings yield 3.8%, return on capital 43.7%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.36
  - Momentum: 6-mo +8.5%, 12-mo +87.8%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $108.00, margin of safety -231.5%
  ...
  - Analyst estimate revision momentum: +15.4% (current vs 90 days ago)
...
## Raw data fields (yfinance)
  - forwardPE: 24.43385
  - trailingPE: 27.28125
  - enterpriseToEbitda: 25.804
  - enterpriseToRevenue: 9.852
  - pegRatio: 1.3628
  ...
  - targetMeanPrice: 430.07428
  - currentPrice: 357.93
  - heldPercentInstitutions: 0.61494
...
## Recent news headlines
  ...
  - SpaceX Stock Is Trying to End a 6-Day Losing Streak. A Defense Department Deal Would Help. (2026-07-20)
  - Google stocks gain as tech giant targets 10x efficiency with model-baked silicon (2026-07-20)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 42.1% vs 25Δ call IV 41.0% — skew +1.1% (balanced)
    - Same-day flow at this expiry: 1,270 call vol vs 368 put vol (C/P 3.45)
