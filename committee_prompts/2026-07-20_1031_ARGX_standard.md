...
## Trigger(s) breached
- Earnings gate OPENED — earnings in 3 business day(s), positivity 86/100, beat streak 4/4 — buy decision is now actionable
...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - No contract proposed: against: catalyst, trend, vol_mispricing; IV/RVf 1.28 >= 1.15 — vol too rich to buy
