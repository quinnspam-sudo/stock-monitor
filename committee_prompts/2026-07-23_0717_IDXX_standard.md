...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #33 of 104 in universe (earnings yield 3.1%, return on capital 120.0%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 3.54
  - Momentum: 6-mo -21.4%, 12-mo +0.4%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $77.43, margin of safety -601.1%
...
## Raw data fields (yfinance)
  - forwardPE: 32.871113
  - trailingPE: 40.009212
  - enterpriseToEbitda: 28.395
  ...
  - currentPrice: 542.925
  - heldPercentInstitutions: 0.98230004
