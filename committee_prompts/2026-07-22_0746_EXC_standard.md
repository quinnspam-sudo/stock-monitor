...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #51 of 101 in universe (earnings yield 5.6%, return on capital 6.5%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.64
  - Momentum: 6-mo +5.3%, 12-mo +8.5%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $41.95, margin of safety -10.9%
...
## Raw data fields (yfinance)
  - forwardPE: 15.319642
  - trailingPE: 17.047619
  - enterpriseToEbitda: 11.818
  - enterpriseToRevenue: 3.933
  - pegRatio: 2.6437
  ...
  - currentPrice: 46.54
  - heldPercentInstitutions: 0.97537005
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-09-18 (~45d): ATM IV 24.3%
    - 25Δ put IV 27.1% vs 25Δ call IV 21.0% — skew +6.0% (heavy downside-protection bid (fear))
