...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  ...
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +6.6%, 12-mo +57.8%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $24.67, margin of safety -312.6%
  ...
  - 52-week high breakout (O'Neil/Darvas): -41.5% from 52-wk high
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-21 (~45d): ATM IV 105.8%
    - 25Δ put IV 110.5% vs 25Δ call IV 102.5% — skew +8.1% (heavy downside-protection bid (fear))
    - Same-day flow at this expiry: 744 call vol vs 336 put vol (C/P 2.21)
