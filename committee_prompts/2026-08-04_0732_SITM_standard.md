...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #100 of 107 in universe (earnings yield -0.4%, return on capital -6.2%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +65.5%, 12-mo +190.3%
...
## Raw data fields (yfinance)
  - forwardPE: 47.183216
  - enterpriseToEbitda: 4352.548
  - enterpriseToRevenue: 36.169
...
## Recent news headlines
  - SITM Gears Up to Report Q2 Earnings: What's in Store for the Stock? (2026-08-03)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 108.0% vs 25Δ call IV 113.7% — skew -5.7% (upside being chased (call skew))
    - Same-day flow at this expiry: 256 call vol vs 180 put vol (C/P 1.42)
