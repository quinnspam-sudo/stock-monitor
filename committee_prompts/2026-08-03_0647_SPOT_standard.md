...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #50 of 107 in universe (earnings yield 2.3%, return on capital 46.7%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.73
  - Momentum: 6-mo +0.3%, 12-mo -22.5%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $121.53, margin of safety -319.8%
...
## Raw data fields (yfinance)
  - forwardPE: 28.00178
  - trailingPE: 34.472298
  - enterpriseToEbitda: 39.649
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 51.3% vs 25Δ call IV 51.5% — skew -0.2% (balanced)
    - Same-day flow at this expiry: 384 call vol vs 1,563 put vol (C/P 0.25)
