...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #39 of 104 in universe (earnings yield 5.2%, return on capital 27.8%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.19
  - Momentum: 6-mo +9.3%, 12-mo +30.3%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $126.82, margin of safety -204.1%
...
## Raw data fields (yfinance)
  - forwardPE: 18.872614
  - trailingPE: 25.50992
  - enterpriseToEbitda: 15.504
  - enterpriseToRevenue: 2.905
  - pegRatio: 2.1895
  ...
  - currentPrice: 385.71
  - heldPercentInstitutions: 1.07389
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 44.0% vs 25Δ call IV 44.8% — skew -0.9% (balanced)
    - Same-day flow at this expiry: 27 call vol vs 21 put vol (C/P 1.29)
