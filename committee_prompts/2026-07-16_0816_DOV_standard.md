...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #21 of 111 in universe (earnings yield 4.9%, return on capital 47.7%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.78
  - Momentum: 6-mo +6.9%, 12-mo +17.0%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $100.06, margin of safety -117.3%
...
## Recent news headlines
  ...
  - 1 Hidden Tech Catalyst Makes Dover Corporation an Absolute Sanctuary for Retirees Protecting Their Wealth (2026-07-07)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-21 (~45d): ATM IV 34.7%
