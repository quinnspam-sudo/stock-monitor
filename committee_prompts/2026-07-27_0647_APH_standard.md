...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - HARD VETO: hostile market regime: SPY>!50d/200d, VIX 17.8 (max 28.0), term 0.868
  - No contract proposed: against: catalyst, flow_proxy, trend, vol_mispricing; IV/RVf 1.34 >= 1.15 — vol too rich to buy; 6-mo momentum -2% < 0% (falling knife); hostile market regime: SPY>!50d/200d, VIX 17.8 (max 28.0), term 0.868

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #51 of 104 in universe (earnings yield 3.0%, return on capital 37.8%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.31
  - Momentum: 6-mo -1.7%, 12-mo +43.8%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $29.84, margin of safety -410.3%
...
## Recent news headlines
  ...
  - RingCentral Q2 Earnings Surpass Estimates, Revenues Increase Y/Y (2026-07-24)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-09-18 (~45d): ATM IV 62.4%
    - 25Δ put IV 55.4% vs 25Δ call IV 55.8% — skew -0.4% (balanced)
    - Same-day flow at this expiry: 159 call vol vs 299 put vol (C/P 0.53)
