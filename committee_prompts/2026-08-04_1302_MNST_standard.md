...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #55 of 121 in universe (earnings yield 2.7%, return on capital 48.4%)
  - Piotroski F-Score: 5/9 (1 tests gapped) (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.84
  - Momentum: 6-mo +14.9%, 12-mo +59.5%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $20.39, margin of safety -362.0%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 34.3% vs 25Δ call IV 35.0% — skew -0.7% (balanced)
    - Same-day flow at this expiry: 638 call vol vs 140 put vol (C/P 4.56)
