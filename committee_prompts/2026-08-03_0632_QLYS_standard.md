...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #13 of 108 in universe (earnings yield 4.7%, return on capital 85.5%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 5.68
  - Momentum: 6-mo +10.0%, 12-mo +9.3%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $44.93, margin of safety -230.4%
...
## Raw data fields (yfinance)
  - forwardPE: 17.94862
  - trailingPE: 26.652603
  - enterpriseToEbitda: 19.091
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - Same-day flow at this expiry: 116 call vol vs 67 put vol (C/P 1.73)
