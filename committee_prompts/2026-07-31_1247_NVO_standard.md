...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #3 of 105 in universe (earnings yield 38.1%, return on capital 81.6%)
  - Piotroski F-Score: 4/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 3.49
  - Momentum: 6-mo -18.2%, 12-mo +4.4%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $25.68, margin of safety -82.6%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 42.0% vs 25Δ call IV 40.7% — skew +1.3% (balanced)
    - Same-day flow at this expiry: 5,243 call vol vs 3,503 put vol (C/P 1.50)
