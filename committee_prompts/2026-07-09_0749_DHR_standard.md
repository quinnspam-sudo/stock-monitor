...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #43 of 95 in universe (earnings yield 3.0%, return on capital 39.2%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.27
  - Momentum: 6-mo -16.6%, 12-mo -1.9%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $93.11, margin of safety -110.1%
...
## Recent news headlines
  ...
  - Danaher (DHR) Completes $9.9B Acquisition of Masimo Corporation (2026-06-29)
