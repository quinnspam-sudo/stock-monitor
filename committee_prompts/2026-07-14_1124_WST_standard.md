...
- Previous evaluation date: 2026-07-14 10:23
...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - HARD VETO: IV/RVf 1.77 >= 1.35 — vol too rich to buy
  - No contract proposed: against: catalyst, flow_proxy, vol_mispricing; IV/RVf 1.77 >= 1.35 — vol too rich to buy

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #83 of 122 in universe (earnings yield 2.4%, return on capital 19.0%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 3.46
  - Momentum: 6-mo +31.9%, 12-mo +60.6%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $84.87, margin of safety -323.4%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 54.4% vs 25Δ call IV 49.6% — skew +4.8% (balanced)
