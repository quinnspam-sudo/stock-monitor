...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #101 of 122 in universe (earnings yield 1.9%, return on capital 8.6%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.70
  - Momentum: 6-mo +31.0%, 12-mo +77.7%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: FAIL; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $23.89, margin of safety -359.0%
...
## Raw data fields (yfinance)
  - forwardPE: 34.298084
  - trailingPE: 72.60927
  - enterpriseToEbitda: 26.761
  - enterpriseToRevenue: 4.762
  - pegRatio: 1.7043
  ...
  - currentPrice: 109.64
  - heldPercentInstitutions: 1.17805
  - numberOfAnalystOpinions: 14

## Recent news headlines
  - Hexcel (HXL) Earnings Expected to Grow: Should You Buy? (2026-07-22)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 58.2% vs 25Δ call IV 47.8% — skew +10.4% (heavy downside-protection bid (fear))
    - Same-day flow at this expiry: 131 call vol vs 48 put vol (C/P 2.73)
