...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #72 of 107 in universe (earnings yield 1.8%, return on capital 34.4%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.30
  - Momentum: 6-mo +27.2%, 12-mo +46.2%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: GAPPED; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $26.44, margin of safety -565.6%
...
## Recent news headlines
  ...
  - Astera Labs vs. Arista Networks: Which Tech Stock Is a Better Buy in 2026? (2026-08-01)
  - Will Top-Line Improvement Benefit Palantir in Q2 Earnings? (2026-07-31)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-09-18 (~45d): ATM IV 69.0%
    - 25Δ put IV 70.7% vs 25Δ call IV 67.9% — skew +2.8% (balanced)
    - Same-day flow at this expiry: 1,047 call vol vs 649 put vol (C/P 1.61)
