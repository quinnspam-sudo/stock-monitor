...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #43 of 103 in universe (earnings yield 1.3%, return on capital 166.4%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 0.43 (GARP: attractive <= 1)
  - Momentum: 6-mo +20.9%, 12-mo +39.2%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $49.84, margin of safety -686.4%
...
## Recent news headlines
  - Billionaire Investor Philippe Laffont’s Top 5 Tech Picks (2026-07-23)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 50.2% vs 25Δ call IV 52.8% — skew -2.6% (upside being chased (call skew))
    - Same-day flow at this expiry: 364 call vol vs 413 put vol (C/P 0.88)
