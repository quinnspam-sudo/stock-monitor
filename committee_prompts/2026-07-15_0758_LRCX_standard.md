...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #65 of 137 in universe (earnings yield 1.4%, return on capital 59.1%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.00
  - Momentum: 6-mo +50.8%, 12-mo +229.9%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $31.77, margin of safety -943.4%
  ...
  - Analyst estimate revision momentum: +10.7% (current vs 90 days ago)
...
## Raw data fields (yfinance)
  - forwardPE: 41.031776
  - trailingPE: 62.57075
  - enterpriseToEbitda: 55.023
  - enterpriseToRevenue: 19.916
  - pegRatio: 1.9975
  ...
  - targetMeanPrice: 364.5484
  - currentPrice: 331.625
  - heldPercentInstitutions: 0.87786
  - numberOfAnalystOpinions: 31

## Recent news headlines
  - Chip stocks rise on ASML earnings despite U.S. strikes on Iran (2026-07-15)
  - Lam Research and Nova Shares Are Soaring, What You Need To Know (2026-07-14)
  - Mizuho Raises its Price Target on Lam Research Corporation (LRCX) (2026-07-14)
  - Jim Cramer Shares Why am Research Corporation (LRCX) is on Fire (2026-07-14)
  - These Chip Stocks Are Staying Strong In A Choppy Market (2026-07-14)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-28 (~45d): ATM IV 97.6%
    - 25Δ put IV 84.6% vs 25Δ call IV 95.6% — skew -11.0% (upside being chased (call skew))
    - Same-day flow at this expiry: 58 call vol vs 86 put vol (C/P 0.67)
