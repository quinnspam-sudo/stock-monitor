...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #47 of 116 in universe (earnings yield 8.4%, return on capital 14.6%)
  - Piotroski F-Score: 4/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.11
  - Momentum: 6-mo +32.6%, 12-mo +16.1%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $117.29, margin of safety -17.1%
  - CANSLIM (O'Neil): 6/7 criteria met — C: Y; A: Y; N: Y; S: N; L: Y; I: Y; M: Y
  - Dividend growth quality (if applicable): yield 2.9%, payout 38%, quality score 72/100, 5yr div CAGR -11.8%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-28 (~45d): ATM IV 37.0%
  - Commodity driver (futures):
    - WTI crude (CL=F): 79.34, 3-mo -13.1%, below 50d SMA — headwind
    - Natural gas (NG=F): 2.90, 3-mo +11.6%, below 50d SMA — mixed
