...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  ...
  - PEG (GARP): 2.24
  - Momentum: 6-mo +42.3%, 12-mo +143.3%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $18.80, margin of safety -1047.2%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-09-18 (~45d): ATM IV 94.8%
    - 25Δ put IV 96.4% vs 25Δ call IV 87.7% — skew +8.6% (heavy downside-protection bid (fear))
    - Same-day flow at this expiry: 2,468 call vol vs 7,487 put vol (C/P 0.33)
