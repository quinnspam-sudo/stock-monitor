...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #14 of 105 in universe (earnings yield 6.3%, return on capital 44.1%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.24
  - Momentum: 6-mo -5.3%, 12-mo -13.7%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $94.57, margin of safety -6.4%
...
## Raw data fields (yfinance)
  - forwardPE: 13.495719
  - trailingPE: 15.775078
  - enterpriseToEbitda: 11.094
  ...
  - currentPrice: 100.645
  - heldPercentInstitutions: 0.77521
  - numberOfAnalystOpinions: 30

## Recent news headlines
  - Disney's Q3 earnings top estimates on demand for experiences, company exits A+E Media stake (2026-08-05)
  - S&P 500 hits record high on Disney, Eli Lilly earnings (2026-08-05)
  - Disney's Streaming Turnaround Is Gaining Real Weight (2026-08-05)
  - U.S. stocks set for stronger open as market rally gathers pace: Dow Jones, S&P, Nasdaq, Wall Street Futures (2026-08-05)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 26.0% vs 25Δ call IV 29.0% — skew -3.0% (upside being chased (call skew))
    - Same-day flow at this expiry: 2,254 call vol vs 552 put vol (C/P 4.08)
