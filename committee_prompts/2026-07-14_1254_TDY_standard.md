...
Generated: 2026-07-14 12:54 local | Source: stock-monitor local daemon
...
- Previous evaluation date: 2026-07-14 11:54
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #36 of 136 in universe (earnings yield 3.7%, return on capital 56.7%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +13.4%, 12-mo +16.1%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $320.10, margin of safety -94.6%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 48.9% vs 25Δ call IV 45.3% — skew +3.7% (balanced)
    - Same-day flow at this expiry: 34 call vol vs 531 put vol (C/P 0.06)
