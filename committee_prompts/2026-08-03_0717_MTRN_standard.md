...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #86 of 108 in universe (earnings yield 2.3%, return on capital 9.9%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +52.1%, 12-mo +102.6%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: FAIL; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $61.47, margin of safety -246.7%
...
## Raw data fields (yfinance)
  - forwardPE: 28.049486
  - trailingPE: 58.389038
  - enterpriseToEbitda: 26.199
  - enterpriseToRevenue: 2.574
  ...
  - currentPrice: 213.12
  - heldPercentInstitutions: 0.9868
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 62.9% vs 25Δ call IV 55.7% — skew +7.2% (heavy downside-protection bid (fear))
    - Same-day flow at this expiry: 62 call vol vs 24 put vol (C/P 2.58)
