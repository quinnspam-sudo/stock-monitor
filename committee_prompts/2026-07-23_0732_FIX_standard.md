...
## Supermajority consensus vote (last gate before a BUY alert)
  - Verdict: FAIL — 7/9 systems bullish (supermajority 65%, min 6 computable)
    - momentum_timing: ✘
    - factor_tier_high: ✔
    - piotroski: ✔
    - canslim: ✔
...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - HARD VETO: hostile market regime: SPY>!50d/200d, VIX 19.1 (max 28.0), term 0.914
  - No contract proposed: against: flow_proxy, trend, vol_mispricing; IV/RVf 1.24 >= 1.15 — vol too rich to buy; hostile market regime: SPY>!50d/200d, VIX 19.1 (max 28.0), term 0.914

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #53 of 103 in universe (earnings yield 2.0%, return on capital 91.1%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 0.85 (GARP: attractive <= 1)
  - Momentum: 6-mo +65.3%, 12-mo +242.0%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $119.49, margin of safety -1464.5%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 76.1% vs 25Δ call IV 72.9% — skew +3.3% (balanced)
    - Same-day flow at this expiry: 35 call vol vs 66 put vol (C/P 0.53)
