...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #80 of 106 in universe (earnings yield 0.5%, return on capital 21.6%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.28
  - Momentum: 6-mo +121.3%, 12-mo +257.4%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $51.58, margin of safety -971.6%
...
## Recent news headlines
  ...
  - Super Micro Jumps 13% on Record $60B Order Backlog; Dell, HPE Rally on AI Server Read-Through (2026-07-22)
  - What Qualcomm Stock Does When The Market Panics (2026-07-22)
  - AMD challenges Nvidia with massive Anthropic deal, though shares dip pre-market (2026-07-22)
  - A $10,000 Investment in AMD When Lisa Su Became CEO Is Worth This Much Today (2026-07-22)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 87.5% vs 25Δ call IV 79.2% — skew +8.3% (heavy downside-protection bid (fear))
    - Same-day flow at this expiry: 2,609 call vol vs 898 put vol (C/P 2.91)
