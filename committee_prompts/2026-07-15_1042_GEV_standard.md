...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  ...
  - PEG (GARP): 1.84
  - Momentum: 6-mo +59.8%, 12-mo +86.5%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $199.73, margin of safety -420.9%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-28 (~45d): ATM IV 59.6%
    - 25Δ put IV 69.3% vs 25Δ call IV 59.6% — skew +9.7% (heavy downside-protection bid (fear))
    - Same-day flow at this expiry: 12 call vol vs 42 put vol (C/P 0.29)
