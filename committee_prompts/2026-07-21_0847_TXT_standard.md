...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #34 of 103 in universe (earnings yield 6.8%, return on capital 18.5%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.17
  - Momentum: 6-mo -2.3%, 12-mo +7.4%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: FAIL; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $73.66, margin of safety -23.6%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-21 (~45d): ATM IV 40.8%
    - 25Δ put IV 39.8% vs 25Δ call IV 35.1% — skew +4.7% (balanced)
    - Same-day flow at this expiry: 208 call vol vs 93 put vol (C/P 2.24)
