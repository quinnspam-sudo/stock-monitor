...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - HARD VETO: hostile market regime: SPY>!50d/200d, VIX 17.8 (max 28.0), term 0.868
  - No contract proposed: against: flow_proxy, trend; 6-mo momentum -4% < 0% (falling knife); hostile market regime: SPY>!50d/200d, VIX 17.8 (max 28.0), term 0.868
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  ...
  - Graham/Buffett intrinsic value: Graham Number $135.69, margin of safety -157.6%
  - CANSLIM (O'Neil): 3/7 criteria met (2 gapped) — C: Y; A: Y; N: N; S: ?; L: ?; I: Y; M: N
  - Dividend growth quality (if applicable): yield 1.0%, payout 19%, quality score 80/100
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-09-18 (~45d): ATM IV 0.1%
