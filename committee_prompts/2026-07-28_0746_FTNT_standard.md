...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - HARD VETO: hostile market regime: SPY>!50d/200d, VIX 18.7 (max 28.0), term 0.924
  - No contract proposed: against: flow_proxy, trend, vol_mispricing; IV/RVf 1.50 >= 1.15 — vol too rich to buy; hostile market regime: SPY>!50d/200d, VIX 18.7 (max 28.0), term 0.924

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #40 of 103 in universe (earnings yield 2.1%, return on capital 92.6%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 3.56
  - Momentum: 6-mo +81.8%, 12-mo +41.6%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $8.85, margin of safety -1578.9%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 67.4% vs 25Δ call IV 64.5% — skew +2.8% (balanced)
