...
## confirm or veto the positivity call using transcript/guidance judgment)
  ...
  - GATE VERDICT: NOT ACTIONABLE — earnings in 13 business days (window: ≤10); positivity 69/100 below strict bar 70
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #20 of 106 in universe (earnings yield 3.4%, return on capital 144.0%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 3.02
  - Momentum: 6-mo +11.4%, 12-mo +33.3%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $84.17, margin of safety -178.6%
...
## Raw data fields (yfinance)
  - forwardPE: 26.622494
  - trailingPE: 35.473522
  - enterpriseToEbitda: 22.93
  ...
  - currentPrice: 234.48
  - heldPercentInstitutions: 0.92523
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 33.9% vs 25Δ call IV 35.8% — skew -1.9% (balanced)
    - Same-day flow at this expiry: 1,050 call vol vs 40 put vol (C/P 26.25)
