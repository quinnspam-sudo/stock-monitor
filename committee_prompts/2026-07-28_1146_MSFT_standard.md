...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #30 of 99 in universe (earnings yield 4.3%, return on capital 45.1%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.20
  - Momentum: 6-mo -16.9%, 12-mo -21.8%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $145.25, margin of safety -173.7%
...
## Recent news headlines
  ...
  - Apple stock hits $5 trillion market cap for the first time (2026-07-28)
  - Earnings To Watch: Microsoft (MSFT) Reports Q2 Results Tomorrow (2026-07-28)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 41.5% vs 25Δ call IV 44.0% — skew -2.4% (upside being chased (call skew))
    - Same-day flow at this expiry: 1,866 call vol vs 876 put vol (C/P 2.13)
