...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - HARD VETO: IV/RVf 1.48 >= 1.35 — vol too rich to buy
  - No contract proposed: against: flow_proxy, trend, vol_mispricing; IV/RVf 1.48 >= 1.35 — vol too rich to buy
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  ...
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +149.5%, 12-mo +309.2%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: GAPPED; Gross margin > 40%: PASS; CFO > Net Income: FAIL
  - Graham/Buffett intrinsic value: Graham Number $55.35, margin of safety -416.8%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-21 (~45d): ATM IV 143.9%
    - 25Δ put IV 102.2% vs 25Δ call IV 131.3% — skew -29.1% (upside being chased (call skew))
    - Same-day flow at this expiry: 403 call vol vs 331 put vol (C/P 1.22)
