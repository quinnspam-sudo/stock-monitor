...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #32 of 105 in universe (earnings yield 10.4%, return on capital 21.3%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo -20.3%, 12-mo +97.6%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $25.76, margin of safety -5.8%
...
## Raw data fields (yfinance)
  - forwardPE: 5.7680993
  - trailingPE: 9.732143
  - enterpriseToEbitda: 7.441
  - enterpriseToRevenue: 3.595
  ...
  - currentPrice: 27.25
  - heldPercentInstitutions: 0.74763
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-09-18 (~45d): ATM IV 70.4%
    - 25Δ put IV 67.5% vs 25Δ call IV 68.2% — skew -0.7% (balanced)
    - Same-day flow at this expiry: 40 call vol vs 25 put vol (C/P 1.60)
  - Commodity driver (futures):
    - Copper (HG=F): 6.55, 3-mo +13.0%, above 50d SMA — tailwind
