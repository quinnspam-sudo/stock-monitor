...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #25 of 106 in universe (earnings yield 4.8%, return on capital 47.7%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.81
  - Momentum: 6-mo +5.6%, 12-mo +14.7%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $100.06, margin of safety -116.2%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-21 (~45d): ATM IV 39.3%
    - 25Δ put IV 40.8% vs 25Δ call IV 42.5% — skew -1.7% (balanced)
    - Same-day flow at this expiry: 126 call vol vs 114 put vol (C/P 1.11)
