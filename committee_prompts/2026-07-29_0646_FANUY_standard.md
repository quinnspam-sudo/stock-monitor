...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - HARD VETO: hostile market regime: SPY>!50d/200d, VIX 18.7 (max 28.0), term 0.942
  - No contract proposed: against: trend; price below 200d SMA; hostile market regime: SPY>!50d/200d, VIX 18.7 (max 28.0), term 0.942

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #92 of 104 in universe (earnings yield -26.3%, return on capital 11.1%)
  - Piotroski F-Score: 7/9 (1 tests gapped) (8-9 strong, 0-2 weak)
  - PEG (GARP): 3.17
  - Momentum: 6-mo +0.7%, 12-mo +36.7%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: GAPPED; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $8.70, margin of safety -128.8%
  - CANSLIM (O'Neil): 0/7 criteria met — C: N; A: N; N: N; S: N; L: N; I: N; M: N
  - Dividend growth quality (if applicable): yield 549.7%, payout 19471%, quality score 35/100
...
## Raw data fields (yfinance)
  - forwardPE: 29.716417
  - trailingPE: 36.2
  - enterpriseToEbitda: -3.021
  - enterpriseToRevenue: -0.815
  - pegRatio: 3.1741
  ...
  - currentPrice: 19.91
  - heldPercentInstitutions: 0.00238
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  - Institutional flow (13F deltas):
    ...
    - Rhumbline Advisers: 0.00% held, +6.7% q/q
