...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #32 of 108 in universe (earnings yield 4.2%, return on capital 45.1%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.22
  - Momentum: 6-mo -12.1%, 12-mo -19.9%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $145.07, margin of safety -177.0%
...
## Raw data fields (yfinance)
  - forwardPE: 20.737013
  - trailingPE: 23.961836
  - enterpriseToEbitda: 16.189
  - enterpriseToRevenue: 9.382
  - pegRatio: 1.2196
  ...
  - targetMeanPrice: 558.66034
  - currentPrice: 401.84
  - heldPercentInstitutions: 0.75655997
  - numberOfAnalystOpinions: 55

## Recent news headlines
  - Are companies getting a return on investment from AI yet? (2026-07-16)
  - Apple, Goldman Sachs, and Chevron are powering the Dow — for wildly different reasons: AlphaCheck (2026-07-15)
  - Big Tech Isn’t Doing Its Part to Offset Chip Weakness (2026-07-16)
  - Citi revamps Microsoft stock price target for the rest of 2026 (2026-07-16)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 43.6% vs 25Δ call IV 44.5% — skew -1.0% (balanced)
    - Same-day flow at this expiry: 536 call vol vs 553 put vol (C/P 0.97)
