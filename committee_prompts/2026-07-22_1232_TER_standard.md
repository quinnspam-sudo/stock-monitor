...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #73 of 107 in universe (earnings yield 1.1%, return on capital 44.8%)
  - Piotroski F-Score: 5/9 (1 tests gapped) (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.48
  - Momentum: 6-mo +60.1%, 12-mo +297.0%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $49.35, margin of safety -651.8%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-28 (~45d): ATM IV 112.0%
    - 25Δ put IV 110.3% vs 25Δ call IV 109.1% — skew +1.2% (balanced)
    - Same-day flow at this expiry: 78 call vol vs 51 put vol (C/P 1.53)
