...
## Trigger(s) breached
- Earnings gate OPENED — earnings in 5 business day(s), positivity 94/100, beat streak 3/4 — buy decision is now actionable
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  ...
  - PEG (GARP): 1.46
  - Momentum: 6-mo +60.6%, 12-mo +40.9%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $49.22, margin of safety -508.2%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 66.1% vs 25Δ call IV 62.6% — skew +3.5% (balanced)
    - Same-day flow at this expiry: 7 call vol vs 3 put vol (C/P 2.33)
