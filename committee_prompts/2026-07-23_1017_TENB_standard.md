...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - HARD VETO: hostile market regime: SPY>!50d/200d, VIX 19.4 (max 28.0), term 0.922
  - No contract proposed: against: catalyst, flow_proxy, trend; hostile market regime: SPY>!50d/200d, VIX 19.4 (max 28.0), term 0.922

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #89 of 106 in universe (earnings yield 0.1%, return on capital 15.1%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +41.0%, 12-mo -4.2%
...
## Raw data fields (yfinance)
  - forwardPE: 14.749424
  - enterpriseToEbitda: 90.829
  - enterpriseToRevenue: 3.601
  ...
  - targetMeanPrice: 33.9
  - currentPrice: 32.03
  - heldPercentInstitutions: 1.1231099
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-09-18 (~45d): ATM IV 70.5%
    - 25Δ put IV 66.1% vs 25Δ call IV 92.2% — skew -26.2% (upside being chased (call skew))
    - Same-day flow at this expiry: 245 call vol vs 408 put vol (C/P 0.60)
