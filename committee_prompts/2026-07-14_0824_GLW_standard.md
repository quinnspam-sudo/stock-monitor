...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #100 of 122 in universe (earnings yield 1.4%, return on capital 12.6%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.74
  - Momentum: 6-mo +117.5%, 12-mo +262.5%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $24.75, margin of safety -668.8%
...
## Recent news headlines
  - Ericsson Q2 Earnings Meet Estimates Despite Margin Resilience (2026-07-14)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-28 (~45d): ATM IV 90.3%
    - 25Δ put IV 91.2% vs 25Δ call IV 91.1% — skew +0.1% (balanced)
    - Same-day flow at this expiry: 90 call vol vs 22 put vol (C/P 4.09)
