...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #11 of 115 in universe (earnings yield 4.9%, return on capital 102.2%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.99
  - Momentum: 6-mo +11.1%, 12-mo +23.9%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $74.17, margin of safety -387.2%
...
## Recent insider transactions
  ...
  - MILES AMY E — Stock Award(Grant) at price 0.00 per share. (2026-05-19)
  - HOLLEY CHARLES M JR — Stock Award(Grant) at price 0.00 per share. (2026-05-19)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - Same-day flow at this expiry: 390 call vol vs 403 put vol (C/P 0.97)
