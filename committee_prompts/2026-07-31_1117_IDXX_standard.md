...
Generated: 2026-07-31 11:17 local | Source: stock-monitor local daemon
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #39 of 103 in universe (earnings yield 3.0%, return on capital 120.0%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 3.58
  - Momentum: 6-mo -16.8%, 12-mo +4.4%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $77.46, margin of safety -620.0%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 42.7% vs 25Δ call IV 39.1% — skew +3.6% (balanced)
    - Same-day flow at this expiry: 4 call vol vs 9 put vol (C/P 0.44)
