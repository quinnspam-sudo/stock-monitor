...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #49 of 103 in universe (earnings yield 2.1%, return on capital 92.6%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 3.56
  - Momentum: 6-mo +87.2%, 12-mo +48.3%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $8.85, margin of safety -1658.2%
...
## Raw data fields (yfinance)
  - forwardPE: 45.23718
  - trailingPE: 60.131786
  - enterpriseToEbitda: 46.119
  - enterpriseToRevenue: 15.318
  - pegRatio: 3.5586
  ...
  - currentPrice: 155.53
  - heldPercentInstitutions: 0.74179
  - numberOfAnalystOpinions: 37

## Recent news headlines
  - Fortinet (FTNT) Heads Into Q2 Earnings As AI Security Optimism Meets A Pricey Valuation (2026-07-25)
  - Synopsys Stock: The Price Tag Hides a Patient Investor's Discount (2026-07-24)
  - Intel Earnings Reveal Whether the Chip Selloff Created a Buy (2026-07-24)
  - Fortinet (FTNT) Q2 Earnings on the Horizon: Analysts' Insights on Key Performance Measures (2026-07-24)
