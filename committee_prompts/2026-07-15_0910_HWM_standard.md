...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #66 of 114 in universe (earnings yield 1.8%, return on capital 41.8%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +24.6%, 12-mo +48.3%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $36.59, margin of safety -647.1%
...
## Raw data fields (yfinance)
  - forwardPE: 45.15813
  - trailingPE: 63.269676
  - enterpriseToEbitda: 44.184
  - enterpriseToRevenue: 13.122
  ...
  - targetMeanPrice: 308.878
  - currentPrice: 273.325
  - heldPercentInstitutions: 0.9438
...
## Recent news headlines
  ...
  - Brokers Suggest Investing in Howmet (HWM): Read This Before Placing a Bet (2026-07-10)
