...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - No contract proposed: against: trend, vol_mispricing; IV/RVf 1.15 >= 1.15 — vol too rich to buy

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #75 of 109 in universe (earnings yield 2.3%, return on capital 16.0%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +9.1%, 12-mo +18.1%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $34.05, margin of safety -330.2%
...
## Raw data fields (yfinance)
  - forwardPE: 35.358032
  - trailingPE: 104.64286
  - enterpriseToEbitda: 27.846
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 69.9% vs 25Δ call IV 53.8% — skew +16.1% (heavy downside-protection bid (fear))
