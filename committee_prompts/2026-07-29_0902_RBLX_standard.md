...
## Trigger(s) breached
- Earnings gate OPENED — earnings in 1 business day(s), positivity 71/100, beat streak 3/4 — buy decision is now actionable
...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - HARD VETO: 6-mo momentum -35% < 0% (falling knife)
  - HARD VETO: price below 200d SMA
  - HARD VETO: hostile market regime: SPY>!50d/200d, VIX 19.9 (max 28.0), term 0.953
  - No contract proposed: against: flow_proxy, trend, vol_mispricing; IV/RVf 1.32 >= 1.15 — vol too rich to buy; 6-mo momentum -35% < 0% (falling knife); price below 200d SMA; hostile market regime: SPY>!50d/200d, VIX 19.9 (max 28.0), term 0.953

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #99 of 104 in universe (earnings yield -3.0%, return on capital -78.6%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo -34.6%, 12-mo -58.4%
  ...
  - 52-week high breakout (O'Neil/Darvas): -67.3% from 52-wk high
...
## Raw data fields (yfinance)
  ...
  - currentPrice: 49.22
  - heldPercentInstitutions: 0.82947
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-09-18 (~45d): ATM IV 81.1%
    - 25Δ put IV 79.4% vs 25Δ call IV 79.6% — skew -0.1% (balanced)
    - Same-day flow at this expiry: 381 call vol vs 584 put vol (C/P 0.65)
