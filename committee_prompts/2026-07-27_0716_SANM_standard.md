...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - HARD VETO: hostile market regime: SPY>!50d/200d, VIX 18.8 (max 28.0), term 0.925
  - No contract proposed: against: flow_proxy, trend, vol_mispricing; IV/RVf 1.51 >= 1.15 — vol too rich to buy; hostile market regime: SPY>!50d/200d, VIX 18.8 (max 28.0), term 0.925

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #79 of 102 in universe (earnings yield 2.9%, return on capital 13.2%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 0.91 (GARP: attractive <= 1)
  - Momentum: 6-mo +13.2%, 12-mo +110.2%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: FAIL; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $69.20, margin of safety -198.7%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-09-18 (~45d): ATM IV 97.1%
    - 25Δ put IV 82.5% vs 25Δ call IV 92.4% — skew -9.9% (upside being chased (call skew))
    - Same-day flow at this expiry: 168 call vol vs 10 put vol (C/P 16.80)
