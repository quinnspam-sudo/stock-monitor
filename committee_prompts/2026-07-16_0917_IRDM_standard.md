...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #73 of 99 in universe (earnings yield 3.4%, return on capital 10.9%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.34
  - Momentum: 6-mo +139.1%, 12-mo +53.5%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $9.93, margin of safety -369.6%
...
## Raw data fields (yfinance)
  - forwardPE: 39.367092
  - trailingPE: 47.121212
  - enterpriseToEbitda: 15.557
  - enterpriseToRevenue: 7.79
  - pegRatio: 2.3399
  ...
  - currentPrice: 46.65
  - heldPercentInstitutions: 0.89713997
  - numberOfAnalystOpinions: 6

## Recent news headlines
  - Iridium Communications (IRDM) Earnings Expected to Grow: What to Know Ahead of Next Week's Release (2026-07-15)
  - Rocket Lab (RKLB) Just Made an $8 Billion Move That Could Reshape Its Future (2026-07-15)
  - Cathie Wood Loads Up on SpaceX, Meta, Eli Lilly and Circle Group (2026-07-13)
  - What Does Rocket Lab's $8 Billion Iridium Acquisition Signal for the New Space Stock Era? (2026-07-13)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-21 (~45d): ATM IV 54.3%
    - 25Δ put IV 38.3% vs 25Δ call IV 47.9% — skew -9.5% (upside being chased (call skew))
    - Same-day flow at this expiry: 387 call vol vs 209 put vol (C/P 1.85)
