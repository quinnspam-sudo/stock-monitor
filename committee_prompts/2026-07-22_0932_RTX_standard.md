...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  ...
  - PEG (GARP): 2.65
  - Momentum: 6-mo -0.3%, 12-mo +33.1%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: FAIL; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $76.83, margin of safety -154.4%
...
## Recent news headlines
  ...
  - RTX (RTX) Could Be 10% Undervalued After The British Army Training Contract (2026-07-21)
  - Reading Between The Lines Of GE Stock's Latest Call (2026-07-21)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 35.5% vs 25Δ call IV 33.2% — skew +2.4% (balanced)
