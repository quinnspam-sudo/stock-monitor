...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - HARD VETO: hostile market regime: SPY>!50d/200d, VIX 18.6 (max 28.0), term 0.905
  - No contract proposed: against: catalyst, trend, vol_mispricing; IV/RVf 1.51 >= 1.15 — vol too rich to buy; hostile market regime: SPY>!50d/200d, VIX 18.6 (max 28.0), term 0.905

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #72 of 101 in universe (earnings yield 2.7%, return on capital 21.4%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +19.0%, 12-mo +3.3%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $15.83, margin of safety -206.5%
