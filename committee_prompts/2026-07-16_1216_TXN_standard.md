...
## Trigger(s) breached
- Earnings gate OPENED — earnings in 4 business day(s), positivity 94/100, beat streak 3/4 — buy decision is now actionable
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #68 of 110 in universe (earnings yield 2.2%, return on capital 27.3%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.44
  - Momentum: 6-mo +51.8%, 12-mo +37.7%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $49.22, margin of safety -489.6%
...
## Raw data fields (yfinance)
  - forwardPE: 30.312273
  - trailingPE: 49.690067
  - enterpriseToEbitda: 32.667
  - enterpriseToRevenue: 15.352
  - pegRatio: 1.4373
  ...
  - targetMeanPrice: 303.3125
  - currentPrice: 290.19
  - heldPercentInstitutions: 0.92639
  - numberOfAnalystOpinions: 32

## Recent news headlines
  - Vicor and the AI Power Trend Reshaping Data Center Hardware (2026-07-16)
  - Is VICR Stock Still Worth Buying After Its Big AI-Fueled Run? (2026-07-16)
  - Vicor Stock Outlook as AI Demand, Capacity and Royalties Align (2026-07-16)
  - Microchip Jumps 35% YTD: Is There More Room for the Stock to Rise? (2026-07-16)
  - The $43 Billion Consolation Prize For QCOM Shareholders (2026-07-16)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 63.3% vs 25Δ call IV 62.3% — skew +0.9% (balanced)
    - Same-day flow at this expiry: 13 call vol vs 68 put vol (C/P 0.19)
