...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  ...
  - PEG (GARP): 2.14
  - Momentum: 6-mo +0.3%, 12-mo +17.4%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $55.96, margin of safety -132.2%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 41.2% vs 25Δ call IV 48.8% — skew -7.6% (upside being chased (call skew))
    - Same-day flow at this expiry: 45 call vol vs 63 put vol (C/P 0.71)
