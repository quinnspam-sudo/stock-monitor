...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #40 of 95 in universe (earnings yield 1.4%, return on capital 166.4%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 0.41 (GARP: attractive <= 1)
  - Momentum: 6-mo +16.4%, 12-mo +44.4%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $49.96, margin of safety -697.4%
...
## Recent news headlines
  ...
  - After The Tumble, Is Marvell Technology Stock A Trap Or A Treasure? (2026-07-09)
