...
Generated: 2026-07-29 12:02 local | Source: stock-monitor local daemon
...
- Previous evaluation date: 2026-07-29 11:01
...
## Supermajority consensus vote (last gate before a BUY alert)
  ...
  - HARD VETO: hostile market regime: SPY>!50d/200d, VIX 17.8 (max 28.0), term 0.904
  - Market regime: SPY>!50d/200d, VIX 17.8 (max 28.0), term 0.904 — HOSTILE

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #37 of 104 in universe (earnings yield 4.3%, return on capital 40.9%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 5.36
  - Momentum: 6-mo +3.3%, 12-mo +18.7%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: FAIL; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $76.49, margin of safety -103.3%
