...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #96 of 117 in universe (earnings yield 0.1%, return on capital 22.8%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.49
  - Momentum: 6-mo +9.2%, 12-mo +54.9%
  - Quality gates (Buffett-style): ROE >= 15%: GAPPED; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: FAIL
  - Graham/Buffett intrinsic value: Graham Number $48.98, margin of safety -1675.2%
...
## Raw data fields (yfinance)
  - forwardPE: 23.64074
  - trailingPE: 38.596317
  - enterpriseToEbitda: 1027.977
  - enterpriseToRevenue: 285.752
  - pegRatio: 1.4912
  ...
  - targetMeanPrice: 1054.0211
  - currentPrice: 869.575
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 44.6% vs 25Δ call IV 42.8% — skew +1.8% (balanced)
    - Same-day flow at this expiry: 121 call vol vs 183 put vol (C/P 0.66)
