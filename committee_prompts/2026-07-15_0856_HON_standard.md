...
## Supermajority consensus vote (last gate before a BUY alert)
  - Verdict: FAIL — 2/9 systems bullish (supermajority 65%, min 6 computable)
    ...
    - positivity_margin: ✘
    - quality_gates: ✔
  - HARD VETO: estimate revisions -59.0% < -2%
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #7 of 135 in universe (earnings yield 7.0%, return on capital 58.8%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 8.31
  - Momentum: 6-mo +2.7%, 12-mo -1.5%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $109.88, margin of safety -104.1%
  - CANSLIM (O'Neil): 2/7 criteria met — C: N; A: N; N: N; S: N; L: N; I: Y; M: Y
  - Dividend growth quality (if applicable): yield 4.2%, payout 74%, quality score 69/100, 5yr div CAGR +5.7%
  ...
  - Analyst estimate revision momentum: -59.0% (current vs 90 days ago)
...
## Raw data fields (yfinance)
  - forwardPE: 22.888054
  - trailingPE: 17.922462
  - enterpriseToEbitda: 11.376
  ...
  - currentPrice: 224.21
  - heldPercentInstitutions: 0.81448
  - numberOfAnalystOpinions: 16

## Recent news headlines
  - Honeywell International (HON) Offers Potential With Automation Portfolio Outlook (2026-07-15)
  - Why SYM Stock Beats A Bond At Its Own Game (2026-07-13)
  - FTSE 100 Live: Stocks flat as Trump says US to be 'guardian of Hormuz strait' (2026-07-13)
  - Does Honeywell’s Post-Spin Guidance and Reverse Split Clarify Its Core Story for Investors (HON)? (2026-07-12)
  - Morgan Stanley drops timely Honeywell stock opinion (2026-07-11)

## Recent insider transactions
  - KAPUR VIMAL M —  (2026-06-01)
  - HAMMOUD BILLAL —  (2026-04-24)
  - LIEBLEIN GRACE D —  (2026-04-15)
  - WILLIAMSON STEPHEN —  (2026-04-15)
  - WATSON ROBIN —  (2026-04-15)
