...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #55 of 106 in universe (earnings yield 2.6%, return on capital 42.4%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +9.3%, 12-mo +115.8%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: FAIL
  - Graham/Buffett intrinsic value: Graham Number $58.20, margin of safety -481.7%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-28 (~45d): ATM IV 87.3%
    - 25Δ put IV 95.6% vs 25Δ call IV 87.5% — skew +8.1% (heavy downside-protection bid (fear))
    - Same-day flow at this expiry: 80 call vol vs 93 put vol (C/P 0.86)
