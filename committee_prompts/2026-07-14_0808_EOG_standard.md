...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #47 of 115 in universe (earnings yield 8.4%, return on capital 14.6%)
  - Piotroski F-Score: 4/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.11
  - Momentum: 6-mo +32.1%, 12-mo +15.7%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $114.94, margin of safety -19.1%
...
## Raw data fields (yfinance)
  - forwardPE: 9.34114
  - trailingPE: 13.476378
  - enterpriseToEbitda: 6.262
  ...
  - currentPrice: 136.92
  - heldPercentInstitutions: 0.97740996
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Commodity driver (futures):
    - WTI crude (CL=F): 78.78, 3-mo -13.7%, below 50d SMA — headwind
    - Natural gas (NG=F): 2.89, 3-mo +11.1%, below 50d SMA — mixed
