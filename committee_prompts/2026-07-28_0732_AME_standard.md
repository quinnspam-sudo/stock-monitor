...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #22 of 103 in universe (earnings yield 3.3%, return on capital 144.0%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 3.13
  - Momentum: 6-mo +10.5%, 12-mo +36.7%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $84.17, margin of safety -188.5%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 37.6% vs 25Δ call IV 33.8% — skew +3.8% (balanced)
    - Same-day flow at this expiry: 101 call vol vs 52 put vol (C/P 1.94)
