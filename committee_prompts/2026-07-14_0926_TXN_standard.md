...
Generated: 2026-07-14 09:26 local | Source: stock-monitor local daemon
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #77 of 122 in universe (earnings yield 2.2%, return on capital 27.3%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.42
  - Momentum: 6-mo +63.7%, 12-mo +42.9%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $49.26, margin of safety -521.0%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-28 (~45d): ATM IV 66.3%
    - 25Δ put IV 64.7% vs 25Δ call IV 63.1% — skew +1.5% (balanced)
