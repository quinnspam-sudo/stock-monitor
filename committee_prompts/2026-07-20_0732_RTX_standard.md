...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #44 of 93 in universe (earnings yield 3.6%, return on capital 52.1%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.65
  - Momentum: 6-mo -1.7%, 12-mo +32.0%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: FAIL; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $76.75, margin of safety -156.6%
...
## Recent news headlines
  ...
  - Jim Cramer Says Oracle Is “Going Down” and Avoid Every Liquor Stock. Here’s What He’d Buy Instead (2026-07-17)
  - HONA Growth Trends Ride Aerospace Demand and Aftermarket Shift (2026-07-17)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 42.2% vs 25Δ call IV 37.7% — skew +4.5% (balanced)
    - Same-day flow at this expiry: 20 call vol vs 29 put vol (C/P 0.69)
