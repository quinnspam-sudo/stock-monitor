...
Generated: 2026-07-20 10:01 local | Source: stock-monitor local daemon
...
## Supermajority consensus vote (last gate before a BUY alert)
  ...
  - Market regime: SPY>50d/200d, VIX 17.8 (max 28.0), term 0.895 — OK
...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - No contract proposed: against: catalyst, flow_proxy, trend; 6-mo momentum -37% < 0% (falling knife); price below 200d SMA

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #100 of 104 in universe (earnings yield -2.9%, return on capital -78.6%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo -36.8%, 12-mo -55.7%
  ...
  - 52-week high breakout (O'Neil/Darvas): -63.4% from 52-wk high
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 87.1% vs 25Δ call IV 83.1% — skew +4.0% (balanced)
    - Same-day flow at this expiry: 629 call vol vs 792 put vol (C/P 0.79)
