...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #9 of 113 in universe (earnings yield 5.6%, return on capital 159.3%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 4.26
  - Momentum: 6-mo +6.2%, 12-mo +0.1%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $59.56, margin of safety -154.2%
...
## Raw data fields (yfinance)
  - forwardPE: 21.467827
  - trailingPE: 22.168375
  - enterpriseToEbitda: 15.114
  - enterpriseToRevenue: 4.365
  - pegRatio: 4.2556
  ...
  - currentPrice: 151.41
  - heldPercentInstitutions: 0.71833
  - numberOfAnalystOpinions: 23

## Recent news headlines
  - Can a Conservative Portfolio Really Generate $4,000 a Month in Retirement Income? (2026-07-17)
  - Procter & Gamble Has Raised Its Dividend for 70 Straight Years. Only 5 Other Companies Can Say the Same. (2026-07-17)
  - Growing an Income Tree: From $27,000 to $66,000 (2026-07-17)
  - Consumer Staple Companies Likely Saw Another 'Tricky' Quarter, UBS Says (2026-07-16)
  - The Portfolio That Pays All Your Car Repairs For Life (2026-07-16)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 28.5% vs 25Δ call IV 41.3% — skew -12.8% (upside being chased (call skew))
    - Same-day flow at this expiry: 67 call vol vs 72 put vol (C/P 0.93)
