...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - HARD VETO: hostile market regime: SPY>!50d/200d, VIX 17.8 (max 28.0), term 0.868
  - No contract proposed: against: flow_proxy, trend; hostile market regime: SPY>!50d/200d, VIX 17.8 (max 28.0), term 0.868

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #52 of 104 in universe (earnings yield 1.6%, return on capital 59.1%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.76
  - Momentum: 6-mo +33.4%, 12-mo +202.5%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $31.71, margin of safety -834.5%
...
## Raw data fields (yfinance)
  - forwardPE: 36.284203
  - trailingPE: 56.215908
  - enterpriseToEbitda: 48.507
  - enterpriseToRevenue: 17.557
  - pegRatio: 1.7615
...
## Recent news headlines
  ...
  - Countdown to Lam Research (LRCX) Q4 Earnings: Wall Street Forecasts for Key Metrics (2026-07-24)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 86.8% vs 25Δ call IV 92.9% — skew -6.1% (upside being chased (call skew))
    - Same-day flow at this expiry: 1 call vol vs 5 put vol (C/P 0.20)
