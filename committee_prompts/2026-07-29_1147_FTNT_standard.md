...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - HARD VETO: hostile market regime: SPY>!50d/200d, VIX 18.6 (max 28.0), term 0.921
  - No contract proposed: against: flow_proxy, trend, vol_mispricing; IV/RVf 1.20 >= 1.15 — vol too rich to buy; hostile market regime: SPY>!50d/200d, VIX 18.6 (max 28.0), term 0.921

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #56 of 142 in universe (earnings yield 2.1%, return on capital 92.6%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 3.50
  - Momentum: 6-mo +84.5%, 12-mo +44.6%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $8.85, margin of safety -1612.2%
...
## Raw data fields (yfinance)
  - forwardPE: 44.219265
  - trailingPE: 58.709305
  - enterpriseToEbitda: 45.378
  - enterpriseToRevenue: 15.072
  - pegRatio: 3.5027
  ...
  - targetMeanPrice: 135.56757
  - currentPrice: 151.43
  - heldPercentInstitutions: 0.72083
  - numberOfAnalystOpinions: 37

## Recent news headlines
  - 'Unprecedented' OpenAI Cyberattack Brings Palo Alto, CrowdStrike Into Focus (2026-07-29)
  ...
  - Are Wall Street Analysts Bullish on Fortinet Stock? (2026-07-29)
  - Will Fortinet (FTNT) Beat Estimates Again in Its Next Earnings Report? (2026-07-28)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 69.3% vs 25Δ call IV 59.3% — skew +10.0% (heavy downside-protection bid (fear))
    - Same-day flow at this expiry: 295 call vol vs 1,741 put vol (C/P 0.17)
