...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #99 of 108 in universe (earnings yield 0.1%, return on capital 0.8%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +167.0%, 12-mo +298.7%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $40.67, margin of safety -441.3%
...
## Raw data fields (yfinance)
  - forwardPE: -101.682686
  - trailingPE: 84.53077
  - enterpriseToEbitda: -1503.403
  - enterpriseToRevenue: 66.102
  ...
  - currentPrice: 219.99
  - heldPercentInstitutions: 0.65717006
...
## Recent news headlines
  ...
  - Core DNA: Coreweave and Nebius Couldn’t Be More Different and Why It Matters (2026-08-05)
  - Piper Sandler Names CoreWeave Its Top AI Cloud Pick Over Nebius (2026-08-04)
  - Nvidia-Backed Stock Wins Major Vote of Confidence (2026-08-04)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-09-18 (~45d): ATM IV 144.9%
    - 25Δ put IV 128.5% vs 25Δ call IV 138.8% — skew -10.4% (upside being chased (call skew))
    - Same-day flow at this expiry: 680 call vol vs 1,790 put vol (C/P 0.38)
