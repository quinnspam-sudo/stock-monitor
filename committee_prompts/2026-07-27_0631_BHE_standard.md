...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #80 of 103 in universe (earnings yield 2.8%, return on capital 7.2%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +67.1%, 12-mo +112.2%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $25.42, margin of safety -220.2%
...
## Raw data fields (yfinance)
  - forwardPE: 26.22989
  - trailingPE: 86.59575
  - enterpriseToEbitda: 20.825
  - enterpriseToRevenue: 1.074
  ...
  - currentPrice: 81.9434
  - heldPercentInstitutions: 1.06961
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - Same-day flow at this expiry: 217 call vol vs 4 put vol (C/P 54.25)
