...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #14 of 107 in universe (earnings yield 4.8%, return on capital 118.3%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.50
  - Momentum: 6-mo -11.6%, 12-mo -16.1%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $89.72, margin of safety -71.4%
...
## Recent news headlines
  ...
  - IntercontinentalExchange (ICE) Surpasses Q2 Earnings and Revenue Estimates (2026-07-30)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 33.2% vs 25Δ call IV 28.8% — skew +4.3% (balanced)
    - Same-day flow at this expiry: 1,073 call vol vs 487 put vol (C/P 2.20)
