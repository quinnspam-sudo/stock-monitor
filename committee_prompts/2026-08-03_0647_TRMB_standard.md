...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #15 of 107 in universe (earnings yield 4.1%, return on capital 187.5%)
  - Piotroski F-Score: 4/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.58
  - Momentum: 6-mo -14.0%, 12-mo -30.7%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: FAIL
  - Graham/Buffett intrinsic value: Graham Number $32.34, margin of safety -80.4%
...
## Raw data fields (yfinance)
  - forwardPE: 14.301086
  - trailingPE: 30.547121
  - enterpriseToEbitda: 16.574
  - enterpriseToRevenue: 3.897
  - pegRatio: 1.5788
  ...
  - currentPrice: 58.345
  - heldPercentInstitutions: 0.98747003
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - Same-day flow at this expiry: 91 call vol vs 4 put vol (C/P 22.75)
