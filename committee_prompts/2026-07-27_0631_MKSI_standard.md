...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #76 of 103 in universe (earnings yield 2.1%, return on capital 20.0%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +52.0%, 12-mo +226.0%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $66.95, margin of safety -395.6%
...
## Raw data fields (yfinance)
  - forwardPE: 21.604977
  - trailingPE: 69.564995
  - enterpriseToEbitda: 27.585
  - enterpriseToRevenue: 6.373
  ...
  - currentPrice: 331.825
  - heldPercentInstitutions: 1.0543599
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - Same-day flow at this expiry: 11 call vol vs 175 put vol (C/P 0.06)
