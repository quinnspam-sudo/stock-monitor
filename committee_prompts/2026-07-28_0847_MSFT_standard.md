...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #32 of 102 in universe (earnings yield 4.3%, return on capital 45.1%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.18
  - Momentum: 6-mo -16.7%, 12-mo -21.6%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $145.25, margin of safety -174.4%
...
## Recent news headlines
  ...
  - The 5 Hyperscaler Stocks Most at Risk If AI Capex Spending Hits a Wall in 2026 (2026-07-28)
  - AMD Sinks 8%, Marvell Sinks 7%, Intel Fall 6% as AI Chip Trade Narrows to NVIDIA (2026-07-28)
  - Is Etsy (ETSY) Fully Valued Following Its New AI Partnerships? (2026-07-28)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-09-04 (~45d): ATM IV 44.7%
    - 25Δ put IV 41.5% vs 25Δ call IV 44.7% — skew -3.2% (upside being chased (call skew))
    - Same-day flow at this expiry: 1,553 call vol vs 673 put vol (C/P 2.31)
