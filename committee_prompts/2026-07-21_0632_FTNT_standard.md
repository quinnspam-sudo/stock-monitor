...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #50 of 100 in universe (earnings yield 2.0%, return on capital 92.6%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 3.62
  - Momentum: 6-mo +115.9%, 12-mo +52.4%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $8.85, margin of safety -1741.8%
...
## Raw data fields (yfinance)
  - forwardPE: 47.51053
  - trailingPE: 63.149227
  - enterpriseToEbitda: 48.598
  - enterpriseToRevenue: 16.142
  - pegRatio: 3.6178
  ...
  - currentPrice: 162.925
  - heldPercentInstitutions: 0.73030996
...
## Recent news headlines
  ...
  - CrowdStrike Stock Has Its Own Story (2026-07-20)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - Same-day flow at this expiry: 28 call vol vs 99 put vol (C/P 0.28)
