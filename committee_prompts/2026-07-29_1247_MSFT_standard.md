...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #34 of 104 in universe (earnings yield 4.2%, return on capital 45.1%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.21
  - Momentum: 6-mo -18.1%, 12-mo -22.7%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $145.20, margin of safety -170.6%
...
## Recent news headlines
  ...
  - Stock Market Today: Nasdaq Tumbles As Fed's Warsh Notes Two Trends; Meta Losing Gains (Live Coverage) (2026-07-29)
  - SK Hynix’s Profits Explode 550%, but Its $31 Billion Spending Plan Sends Investors Running (2026-07-29)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 37.1% vs 25Δ call IV 41.7% — skew -4.6% (upside being chased (call skew))
    - Same-day flow at this expiry: 24,048 call vol vs 7,548 put vol (C/P 3.19)
