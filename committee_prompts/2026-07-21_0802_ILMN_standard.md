...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #36 of 95 in universe (earnings yield 4.0%, return on capital 41.9%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 3.23
  - Momentum: 6-mo +29.3%, 12-mo +100.8%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $46.68, margin of safety -307.7%
...
## Raw data fields (yfinance)
  - forwardPE: 32.078316
  - trailingPE: 34.603638
  - enterpriseToEbitda: 25.395
  - enterpriseToRevenue: 6.677
  - pegRatio: 3.2273
  ...
  - currentPrice: 190.32
  - heldPercentInstitutions: 1.06731
...
## Recent news headlines
  ...
  - 3 Promising Genomics Stocks to Add to Your Portfolio in 2026 (2026-07-20)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 54.3% vs 25Δ call IV 54.1% — skew +0.3% (balanced)
    - Same-day flow at this expiry: 76 call vol vs 56 put vol (C/P 1.36)
