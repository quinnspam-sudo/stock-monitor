...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #4 of 107 in universe (earnings yield 40.3%, return on capital 81.6%)
  - Piotroski F-Score: 4/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 3.16
  - Momentum: 6-mo -2.1%, 12-mo -1.1%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $25.21, margin of safety -76.7%
  - CANSLIM (O'Neil): 4/7 criteria met — C: Y; A: Y; N: N; S: Y; L: N; I: N; M: Y
  - Dividend growth quality (if applicable): yield 18.0%, payout 197%, quality score 57/100, 5yr div CAGR +35.6%
...
## Recent news headlines
  ...
  - Novo Nordisk Stock Falls 4% Despite Stronger GLP-1 Outlook (2026-08-05)
  - Novo Nordisk Is Exiting a ‘Rough Patch,’ CFO Says. Earnings Prove It. (2026-08-05)
  - Eli Lilly Stock: The One Question in Otherwise Perfect Earnings and What It Means for Shares (2026-08-05)
  - Sector Update: Healthcare Stocks Advance Wednesday Afternoon (2026-08-05)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 35.3% vs 25Δ call IV 36.6% — skew -1.3% (balanced)
    - Same-day flow at this expiry: 9,837 call vol vs 3,261 put vol (C/P 3.02)
