...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #32 of 101 in universe (earnings yield 4.3%, return on capital 45.1%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.20
  - Momentum: 6-mo -16.8%, 12-mo -21.7%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $145.25, margin of safety -174.2%
...
## Recent news headlines
  ...
  - Microsoft (MSFT) Backs Bigger OpenAI Ohio Build As Nvidia And Washington Close In (2026-07-28)
  - Tesla Signs Agreement To Purchase Energy From KKR-Backed Solar Plant (2026-07-28)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 43.0% vs 25Δ call IV 44.0% — skew -1.0% (balanced)
    - Same-day flow at this expiry: 1,750 call vol vs 754 put vol (C/P 2.32)
