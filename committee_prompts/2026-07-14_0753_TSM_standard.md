...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #17 of 136 in universe (earnings yield 13.5%, return on capital 34.1%)
  - Piotroski F-Score: 9/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.32
  - Momentum: 6-mo +28.1%, 12-mo +86.9%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $33.33, margin of safety -1168.5%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 50.7% vs 25Δ call IV 53.5% — skew -2.8% (upside being chased (call skew))
    - Same-day flow at this expiry: 316 call vol vs 1,299 put vol (C/P 0.24)
