...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #72 of 106 in universe (earnings yield 1.9%, return on capital 34.4%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.22
  - Momentum: 6-mo +9.7%, 12-mo +36.9%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: GAPPED; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $26.44, margin of safety -508.8%
...
## Recent news headlines
  ...
  - Brokers Suggest Investing in Arista Networks (ANET): Read This Before Placing a Bet (2026-07-27)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - Same-day flow at this expiry: 148 call vol vs 29 put vol (C/P 5.10)
