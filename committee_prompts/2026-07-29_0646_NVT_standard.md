...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #47 of 104 in universe (earnings yield 2.6%, return on capital 52.1%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.49
  - Momentum: 6-mo +20.5%, 12-mo +73.3%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: FAIL
  - Graham/Buffett intrinsic value: Graham Number $39.34, margin of safety -248.8%
  - CANSLIM (O'Neil): 2/7 criteria met — C: N; A: N; N: N; S: N; L: Y; I: Y; M: N
  - Dividend growth quality (if applicable): yield 0.6%, payout 28%, quality score 87/100, 5yr div CAGR +29.2%
...
## Raw data fields (yfinance)
  - forwardPE: 23.884922
  - trailingPE: 46.825935
  - enterpriseToEbitda: 26.435
  - enterpriseToRevenue: 5.648
  - pegRatio: 1.4932
  ...
  - currentPrice: 137.42
  - heldPercentInstitutions: 0.96205
  - numberOfAnalystOpinions: 15

## Recent news headlines
  - nVent (NVT) Stock Seems 36% Pricey On Its $2.6B Backlog (2026-07-28)
  - NVT Likely to Beat Q2 Earnings Estimates: Buy, Sell or Hold the Stock? (2026-07-28)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - Same-day flow at this expiry: 151 call vol vs 163 put vol (C/P 0.93)
