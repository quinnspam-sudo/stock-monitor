...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #37 of 94 in universe (earnings yield 3.6%, return on capital 52.1%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.66
  - Momentum: 6-mo +1.1%, 12-mo +32.1%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: FAIL; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $76.83, margin of safety -156.5%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 39.5% vs 25Δ call IV 31.2% — skew +8.3% (heavy downside-protection bid (fear))
    - Same-day flow at this expiry: 25 call vol vs 54 put vol (C/P 0.46)
