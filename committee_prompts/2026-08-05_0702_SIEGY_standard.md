...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #40 of 105 in universe (earnings yield 4.0%, return on capital 40.9%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 5.36
  - Momentum: 6-mo +15.7%, 12-mo +30.7%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: FAIL; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $77.59, margin of safety -113.9%
...
## Raw data fields (yfinance)
  ...
  - currentPrice: 165.96
  - heldPercentInstitutions: 0.00425
  - numberOfAnalystOpinions: 4

## Recent news headlines
  - Inside the Long, AI-Powered Quest to Perfect Pringle-Making (2026-08-05)
  - Resilience and Digital Transformation Spearhead the Energy Infrastructure Transition (2026-08-04)
