...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #28 of 106 in universe (earnings yield 5.0%, return on capital 47.7%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.74
  - Momentum: 6-mo +5.4%, 12-mo +14.1%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $100.12, margin of safety -111.0%
...
## Raw data fields (yfinance)
  ...
  - currentPrice: 211.21
  - heldPercentInstitutions: 0.94977
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 43.2% vs 25Δ call IV 35.6% — skew +7.6% (heavy downside-protection bid (fear))
    - Same-day flow at this expiry: 482 call vol vs 15 put vol (C/P 32.13)
