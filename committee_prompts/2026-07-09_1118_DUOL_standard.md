...
Generated: 2026-07-09 11:18 local | Source: stock-monitor local daemon
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #69 of 92 in universe (earnings yield 2.8%, return on capital 13.5%)
  - Piotroski F-Score: 3/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo -26.6%, 12-mo -66.9%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: FAIL
  - Graham/Buffett intrinsic value: Graham Number $76.44, margin of safety -69.4%
  ...
  - 52-week high breakout (O'Neil/Darvas): -72.3% from 52-wk high
