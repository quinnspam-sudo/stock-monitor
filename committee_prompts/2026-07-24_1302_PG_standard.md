...
Generated: 2026-07-24 13:02 local | Source: stock-monitor local daemon
...
## Supermajority consensus vote (last gate before a BUY alert)
  - Verdict: FAIL — 2/9 systems bullish (supermajority 65%, min 6 computable)
    ...
    - positivity_margin: ✘
    - quality_gates: ✔
  - HARD VETO: hostile market regime: SPY>!50d/200d, VIX 18.7 (max 28.0), term 0.908
  - Market regime: SPY>!50d/200d, VIX 18.7 (max 28.0), term 0.908 — HOSTILE
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 30.6% vs 25Δ call IV 27.9% — skew +2.6% (balanced)
