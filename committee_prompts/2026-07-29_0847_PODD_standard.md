...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #64 of 106 in universe (earnings yield 3.3%, return on capital 19.4%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.48
  - Momentum: 6-mo -34.2%, 12-mo -41.7%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $42.51, margin of safety -299.5%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 53.3% vs 25Δ call IV 52.8% — skew +0.5% (balanced)
    - Same-day flow at this expiry: 225 call vol vs 108 put vol (C/P 2.08)
