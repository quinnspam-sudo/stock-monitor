...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #13 of 109 in universe (earnings yield 6.4%, return on capital 44.1%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.24
  - Momentum: 6-mo -4.9%, 12-mo -16.2%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $93.60, margin of safety -5.3%
...
## Raw data fields (yfinance)
  - forwardPE: 13.2107725
  - trailingPE: 15.7632
  - enterpriseToEbitda: 10.919
  - enterpriseToRevenue: 2.214
  - pegRatio: 2.2425
  ...
  - currentPrice: 98.52
  - heldPercentInstitutions: 0.77786005
...
## Recent news headlines
  ...
  - DIS Stock Rises Overnight As ‘Spider-Man: Brand New Day’ Nearly Breaks ‘Avengers: Endgame’ Opening Record (2026-08-03)
  - ‘Spider-Man: Brand New Day’ Delivers Huge Debut as Hollywood Chases Record Year (2026-08-02)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 33.8% vs 25Δ call IV 34.1% — skew -0.3% (balanced)
    - Same-day flow at this expiry: 626 call vol vs 761 put vol (C/P 0.82)
