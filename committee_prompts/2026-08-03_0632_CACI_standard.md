...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #17 of 108 in universe (earnings yield 4.6%, return on capital 67.8%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo -18.0%, 12-mo +7.6%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: FAIL; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $325.07, margin of safety -54.4%
...
## Raw data fields (yfinance)
  - forwardPE: 16.289913
  - trailingPE: 20.708746
  - enterpriseToEbitda: 14.876
  - enterpriseToRevenue: 1.796
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 55.8% vs 25Δ call IV 65.2% — skew -9.4% (upside being chased (call skew))
    - Same-day flow at this expiry: 188 call vol vs 156 put vol (C/P 1.21)
