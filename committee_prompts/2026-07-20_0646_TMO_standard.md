...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #45 of 109 in universe (earnings yield 3.7%, return on capital 36.2%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.76
  - Momentum: 6-mo -14.7%, 12-mo +30.5%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $239.29, margin of safety -120.1%
...
## Raw data fields (yfinance)
  ...
  - currentPrice: 526.56
  - heldPercentInstitutions: 0.93917
...
## Recent news headlines
  ...
  - Thermo Fisher Set to Report Q2 Earnings: What's in the Cards? (2026-07-15)
  - Intuitive Surgical Pre-Q2 Analysis: Buy, Hold or Sell the Stock Now? (2026-07-14)
  - Abbott's Q2 Earnings on Deck: How Should You Play the Stock Now? (2026-07-14)
