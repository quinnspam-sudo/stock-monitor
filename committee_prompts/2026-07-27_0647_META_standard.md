...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - HARD VETO: hostile market regime: SPY>!50d/200d, VIX 17.8 (max 28.0), term 0.868
  - No contract proposed: against: flow_proxy, trend, vol_mispricing; 6-mo momentum -10% < 0% (falling knife); price below 200d SMA; hostile market regime: SPY>!50d/200d, VIX 17.8 (max 28.0), term 0.868

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #30 of 104 in universe (earnings yield 5.7%, return on capital 33.0%)
  ...
  - Graham/Buffett intrinsic value: Graham Number $243.74, margin of safety -148.1%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 48.7% vs 25Δ call IV 50.2% — skew -1.6% (balanced)
