...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  ...
  - PEG (GARP): 1.85
  - Momentum: 6-mo -37.3%, 12-mo -49.0%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $32.80, margin of safety -131.3%
...
## Raw data fields (yfinance)
  - forwardPE: 10.266313
  - trailingPE: 12.437706
  - enterpriseToEbitda: 9.729
...
## Recent news headlines
  - How Burry’s Bet and OA Pipeline Push Will Impact Zoetis (ZTS) Investors (2026-08-04)
  - The Bull Case for Zoetis Stock as Michael Burry Doubles Down (2026-08-03)
  - ZTS Set to Report Q2 Earnings: Here's What Investors Should Expect (2026-08-03)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - Same-day flow at this expiry: 794 call vol vs 455 put vol (C/P 1.75)
