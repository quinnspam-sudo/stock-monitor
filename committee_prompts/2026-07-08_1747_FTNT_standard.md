...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #14 of 63 in universe (earnings yield 2.0%, return on capital 92.6%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 3.58
  - Momentum: 6-mo +98.8%, 12-mo +45.0%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $8.86, margin of safety -1659.8%
...
## Raw data fields (yfinance)
  - forwardPE: 45.52805
  - trailingPE: 60.22201
  - enterpriseToEbitda: 48.074
  - enterpriseToRevenue: 15.968
  - pegRatio: 3.5797
  ...
  - currentPrice: 155.975
  - heldPercentInstitutions: 0.72263
...
## Recent news headlines
  ...
  - Fortinet (FTNT) Falls More Steeply Than Broader Market: What Investors Need to Know (2026-07-07)
