...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #92 of 108 in universe (earnings yield 0.3%, return on capital 4.2%)
  - Piotroski F-Score: 4/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 4.17
  - Momentum: 6-mo +23.1%, 12-mo -24.0%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $49.47, margin of safety -1044.3%
...
## Raw data fields (yfinance)
  - forwardPE: 53.832943
  - trailingPE: 228.27621
  - enterpriseToEbitda: 424.281
  - enterpriseToRevenue: 14.629
  - pegRatio: 4.1727
  ...
  - currentPrice: 566.125
  - heldPercentInstitutions: 0.89381
  - numberOfAnalystOpinions: 19

## Recent news headlines
  - Chipotle Mexican Grill vs. Axon Enterprise: Comparing Recent Revenue Trends for These S&P 500 Companies (2026-08-03)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-09-18 (~45d): ATM IV 81.2%
    - 25Δ put IV 76.9% vs 25Δ call IV 76.5% — skew +0.4% (balanced)
    - Same-day flow at this expiry: 360 call vol vs 193 put vol (C/P 1.87)
