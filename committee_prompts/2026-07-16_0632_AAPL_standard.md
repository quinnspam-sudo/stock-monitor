...
## confirm or veto the positivity call using transcript/guidance judgment)
  ...
  - Earnings Positivity Score: 80/100 (strict pass bar 70, beat streak 4/4 last quarters)
    - Analyst EPS revision momentum: 74
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #28 of 103 in universe (earnings yield 2.8%, return on capital 413.7%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.54
  - Momentum: 6-mo +26.5%, 12-mo +56.9%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: FAIL
  - Graham/Buffett intrinsic value: Graham Number $36.71, margin of safety -793.9%
...
## Raw data fields (yfinance)
  - forwardPE: 34.118397
  - trailingPE: 39.78788
  - enterpriseToEbitda: 30.169
  - enterpriseToRevenue: 10.691
  - pegRatio: 2.5441
  ...
  - beta: 1.097
  - recommendationMean: 2.04255
  - targetMeanPrice: 315.78604
  - currentPrice: 328.34
  - heldPercentInstitutions: 0.65745
  - numberOfAnalystOpinions: 43

## Recent news headlines
  - $3.2 trillion rotation from chips to the 'Magnificent 7' has left the S&P 500 going nowhere: Chart of the Day (2026-07-16)
  - Apple clears key hurdle for iPhone AI launch in China (2026-07-15)
  - Apple Intelligence approved for launch in China with Alibaba and Baidu (2026-07-16)
  - EU orders Google to open Android, search data to OpenAI and AI rivals (2026-07-16)
  - AAPL's China Memory Chip Plans Draw National Security Scrutiny — Lawmakers Say Every Memory Chip Purchase Will Subsidize PLA (2026-07-16)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - Same-day flow at this expiry: 9,213 call vol vs 2,106 put vol (C/P 4.37)
