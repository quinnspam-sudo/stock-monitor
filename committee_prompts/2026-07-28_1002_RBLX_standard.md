...
## Trigger(s) breached
- Earnings gate OPENED — earnings in 2 business day(s), positivity 71/100, beat streak 3/4 — buy decision is now actionable
...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - HARD VETO: 6-mo momentum -31% < 0% (falling knife)
  - HARD VETO: price below 200d SMA
  - HARD VETO: hostile market regime: SPY>!50d/200d, VIX 18.0 (max 28.0), term 0.908
  - No contract proposed: against: flow_proxy, trend, vol_mispricing; IV/RVf 1.29 >= 1.15 — vol too rich to buy; 6-mo momentum -31% < 0% (falling knife); price below 200d SMA; hostile market regime: SPY>!50d/200d, VIX 18.0 (max 28.0), term 0.908

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #97 of 101 in universe (earnings yield -3.1%, return on capital -78.6%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo -31.0%, 12-mo -58.9%
  ...
  - 52-week high breakout (O'Neil/Darvas): -67.0% from 52-wk high
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-09-04 (~45d): ATM IV 83.4%
