...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #63 of 106 in universe (earnings yield 3.2%, return on capital 19.4%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.46
  - Momentum: 6-mo -33.6%, 12-mo -42.0%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $42.56, margin of safety -292.1%
...
## Raw data fields (yfinance)
  ...
  - currentPrice: 166.835
  - heldPercentInstitutions: 1.0539
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 55.7% vs 25Δ call IV 55.3% — skew +0.3% (balanced)
    - Same-day flow at this expiry: 136 call vol vs 88 put vol (C/P 1.55)
