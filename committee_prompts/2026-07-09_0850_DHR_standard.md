...
Generated: 2026-07-09 08:50 local | Source: stock-monitor local daemon
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #42 of 94 in universe (earnings yield 3.0%, return on capital 39.2%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.27
  - Momentum: 6-mo -17.3%, 12-mo -2.8%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $93.11, margin of safety -108.1%
