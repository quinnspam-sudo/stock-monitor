...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #13 of 113 in universe (earnings yield 5.3%, return on capital 112.6%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 4.05
  - Momentum: 6-mo +9.7%, 12-mo +30.0%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $56.30, margin of safety -168.1%
...
## Raw data fields (yfinance)
  - forwardPE: 15.4783325
  - trailingPE: 21.623209
  - enterpriseToEbitda: 14.284
  - enterpriseToRevenue: 5.787
  - pegRatio: 4.0544
  ...
  - currentPrice: 150.93
  - heldPercentInstitutions: 0.07666
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-21 (~45d): ATM IV 29.0%
    - 25Δ put IV 28.7% vs 25Δ call IV 27.7% — skew +1.0% (balanced)
    - Same-day flow at this expiry: 450 call vol vs 157 put vol (C/P 2.87)
