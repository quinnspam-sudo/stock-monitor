...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #83 of 106 in universe (earnings yield 3.0%, return on capital 6.2%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.93
  - Momentum: 6-mo +6.4%, 12-mo +26.1%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $48.45, margin of safety -84.2%
...
## Raw data fields (yfinance)
  - forwardPE: 20.277517
  - trailingPE: 22.654823
  - enterpriseToEbitda: 21.207
  - enterpriseToRevenue: 10.775
  - pegRatio: 1.9283
  ...
  - currentPrice: 89.26
  - heldPercentInstitutions: 0.87
  - numberOfAnalystOpinions: 20

## Recent news headlines
  - Zacks Investment Ideas feature highlights: GE Vernova, NextEra Energy, Meta and Google (2026-07-22)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - Same-day flow at this expiry: 66 call vol vs 30 put vol (C/P 2.20)
