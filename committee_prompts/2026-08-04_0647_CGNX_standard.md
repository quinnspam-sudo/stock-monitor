...
## confirm or veto the positivity call using transcript/guidance judgment)
  ...
  - Earnings Positivity Score: 91/100 (strict pass bar 70, beat streak None/0 last quarters)
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #76 of 108 in universe (earnings yield 1.5%, return on capital 24.2%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +71.6%, 12-mo +69.9%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $13.26, margin of safety -427.1%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 72.1% vs 25Δ call IV 76.4% — skew -4.3% (upside being chased (call skew))
