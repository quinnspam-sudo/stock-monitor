...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  ...
  - Dividend growth quality (if applicable): yield 2.7%, payout 358%, quality score 55/100
  - Fama-French 5-factor tilts: Size: Large, Value tilt: Value (descriptive only, not scored — see interpretation guide), Profitability: GAPPED, Asset growth: GAPPED
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - Same-day flow at this expiry: 120 call vol vs 143 put vol (C/P 0.84)
