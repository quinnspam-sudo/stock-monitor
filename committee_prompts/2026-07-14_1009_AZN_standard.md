...
## Trigger(s) breached
- Earnings gate OPENED — earnings in 9 business day(s), positivity 74/100, beat streak 3/4 — buy decision is now actionable
...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - No contract proposed: against: catalyst, flow_proxy, trend; 6-mo momentum -10% < -10% (falling knife); price below 200d SMA

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #21 of 116 in universe (earnings yield 4.9%, return on capital 109.4%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.33
  - Momentum: 6-mo -10.4%, 12-mo +17.8%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $67.57, margin of safety -145.8%
...
## Raw data fields (yfinance)
  - forwardPE: 17.923683
  - trailingPE: 25.013554
  - enterpriseToEbitda: 14.427
  - enterpriseToRevenue: 4.78
  - pegRatio: 1.3312
  ...
  - targetMeanPrice: 215.89
  - currentPrice: 166.09
  - heldPercentInstitutions: 0.68355006
  - numberOfAnalystOpinions: 10

## Recent news headlines
  - AstraZeneca pays up to $1.5bn to license Dizal Pharma’s lung cancer drug (2026-07-14)
  - Here's How Pfizer's Oncology Growth Story Looks Ahead of Q2 Results (2026-07-14)
  - Health Care Roundup: Market Talk (2026-07-14)
  - AstraZeneca to pay up to $1.5bn for global rights to lung cancer pill (2026-07-14)
  - AstraZeneca Enters Exclusive License Deal For Lung Cancer Drug Zegfrovy For Up to $1.5 Billion (2026-07-14)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-21 (~45d): ATM IV 32.2%
    - 25Δ put IV 35.2% vs 25Δ call IV 32.0% — skew +3.1% (balanced)
    - Same-day flow at this expiry: 686 call vol vs 185 put vol (C/P 3.71)
