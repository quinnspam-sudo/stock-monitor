...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #10 of 91 in universe (earnings yield 4.8%, return on capital 102.2%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.05
  - Momentum: 6-mo +7.6%, 12-mo +25.9%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $74.15, margin of safety -388.6%
...
## Raw data fields (yfinance)
  ...
  - targetMeanPrice: 354.9655
  - currentPrice: 362.29
  - heldPercentInstitutions: 0.85068
