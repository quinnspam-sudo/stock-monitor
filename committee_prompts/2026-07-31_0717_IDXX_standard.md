...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #38 of 106 in universe (earnings yield 3.0%, return on capital 120.0%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 3.65
  - Momentum: 6-mo -17.4%, 12-mo +3.6%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $77.46, margin of safety -614.8%
...
## Raw data fields (yfinance)
  - forwardPE: 33.521664
  - trailingPE: 40.770985
  - enterpriseToEbitda: 29.1
  - enterpriseToRevenue: 10.118
  - pegRatio: 3.6511
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 46.8% vs 25Δ call IV 43.8% — skew +2.9% (balanced)
    - Same-day flow at this expiry: 3 call vol vs 9 put vol (C/P 0.33)
