...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #7 of 111 in universe (earnings yield 5.7%, return on capital 159.3%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 4.19
  - Momentum: 6-mo -0.6%, 12-mo -5.5%
  ...
  - Fama-French 5-factor tilts: Size: GAPPED, Value tilt: GAPPED (descriptive only, not scored — see interpretation guide), Profitability: +51.2%, Asset growth: +2.3%
...
## Recent news headlines
  ...
  - Procter & Gamble to Report Q4 Earnings: What Should You Know? (2026-07-23)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-28 (~45d): ATM IV 21.6%
    - 25Δ put IV 30.3% vs 25Δ call IV 25.1% — skew +5.2% (balanced)
    - Same-day flow at this expiry: 290 call vol vs 268 put vol (C/P 1.08)
