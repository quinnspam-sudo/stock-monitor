...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #23 of 103 in universe (earnings yield 3.3%, return on capital 144.0%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 3.13
  - Momentum: 6-mo +7.3%, 12-mo +32.2%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $84.24, margin of safety -179.0%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 38.2% vs 25Δ call IV 34.4% — skew +3.8% (balanced)
    - Same-day flow at this expiry: 95 call vol vs 54 put vol (C/P 1.76)
