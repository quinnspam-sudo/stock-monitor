...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #95 of 133 in universe (earnings yield -26.0%, return on capital 43.2%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.54
  - Momentum: 6-mo +32.5%, 12-mo +57.0%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $25.64, margin of safety -263.4%
...
## Raw data fields (yfinance)
  - forwardPE: 31.293985
  - trailingPE: 39.982834
  - enterpriseToRevenue: -5.375
  - pegRatio: 2.5395
  ...
  - targetMeanPrice: 96.40833
  - currentPrice: 93.16
  - heldPercentInstitutions: 0.89887
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 65.2% vs 25Δ call IV 50.4% — skew +14.9% (heavy downside-protection bid (fear))
