...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #86 of 108 in universe (earnings yield -195.2%, return on capital 35.8%)
  - Piotroski F-Score: 4/9 (1 tests gapped) (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.18
  - Momentum: 6-mo +47.2%, 12-mo +106.4%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: GAPPED; Gross margin > 40%: PASS; CFO > Net Income: FAIL
  - Graham/Buffett intrinsic value: Graham Number $34.94, margin of safety -470.0%
  ...
  - 52-week high breakout (O'Neil/Darvas): -20.1% from 52-wk high
