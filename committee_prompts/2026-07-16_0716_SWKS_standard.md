...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #33 of 107 in universe (earnings yield 6.6%, return on capital 17.6%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.22
  - Momentum: 6-mo -2.8%, 12-mo -18.5%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $45.50, margin of safety -25.3%
...
## Raw data fields (yfinance)
  - forwardPE: 11.106459
  - trailingPE: 23.762499
  - enterpriseToEbitda: 9.259
  - enterpriseToRevenue: 2.081
  - pegRatio: 1.2226
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-21 (~45d): ATM IV 68.2%
    - 25Δ put IV 71.9% vs 25Δ call IV 69.1% — skew +2.8% (balanced)
    - Same-day flow at this expiry: 369 call vol vs 688 put vol (C/P 0.54)
