...
Generated: 2026-07-23 09:47 local | Source: stock-monitor local daemon
...
- Previous evaluation date: 2026-07-23 08:46
...
## Supermajority consensus vote (last gate before a BUY alert)
  - Verdict: FAIL — 3/8 systems bullish (supermajority 65%, min 6 computable)
    ...
    - positivity_margin: ✔
    - quality_gates: ✔
  - HARD VETO: hostile market regime: SPY>!50d/200d, VIX 19.0 (max 28.0), term 0.914
  - Market regime: SPY>!50d/200d, VIX 19.0 (max 28.0), term 0.914 — HOSTILE

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #87 of 107 in universe (earnings yield -195.2%, return on capital 35.8%)
  - Piotroski F-Score: 4/9 (1 tests gapped) (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.18
  - Momentum: 6-mo +47.8%, 12-mo +107.2%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: GAPPED; Gross margin > 40%: PASS; CFO > Net Income: FAIL
  - Graham/Buffett intrinsic value: Graham Number $34.94, margin of safety -472.4%
