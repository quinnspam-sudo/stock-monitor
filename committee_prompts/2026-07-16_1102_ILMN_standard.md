...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #43 of 112 in universe (earnings yield 4.0%, return on capital 41.9%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 3.27
  - Momentum: 6-mo +31.8%, 12-mo +95.7%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $46.68, margin of safety -306.4%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-21 (~45d): ATM IV 52.1%
    - 25Δ put IV 52.9% vs 25Δ call IV 53.3% — skew -0.4% (balanced)
    - Same-day flow at this expiry: 66 call vol vs 49 put vol (C/P 1.35)
