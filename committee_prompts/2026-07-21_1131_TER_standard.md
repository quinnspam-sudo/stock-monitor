...
## Trigger(s) breached
- Earnings gate OPENED — earnings in 5 business day(s), positivity 89/100, beat streak 4/4 — buy decision is now actionable
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #68 of 104 in universe (earnings yield 1.3%, return on capital 44.8%)
  - Piotroski F-Score: 5/9 (1 tests gapped) (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.32
  - Momentum: 6-mo +68.9%, 12-mo +299.6%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $49.26, margin of safety -667.3%
...
## Raw data fields (yfinance)
  - forwardPE: 36.75282
  - trailingPE: 70.38364
  - enterpriseToEbitda: 44.844
  - enterpriseToRevenue: 13.754
  - pegRatio: 1.3206
  ...
  - targetMeanPrice: 426.35294
  - currentPrice: 377.9601
  - heldPercentInstitutions: 0.97807
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-28 (~45d): ATM IV 113.1%
    - 25Δ put IV 113.0% vs 25Δ call IV 107.8% — skew +5.2% (balanced)
    - Same-day flow at this expiry: 74 call vol vs 53 put vol (C/P 1.40)
