...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - No contract proposed: against: catalyst, flow_proxy, trend, vol_mispricing; IV/RVf 1.35 >= 1.15 — vol too rich to buy

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #86 of 107 in universe (earnings yield 1.6%, return on capital 12.9%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +42.3%, 12-mo +199.7%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: FAIL; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $27.07, margin of safety -407.2%
...
## Raw data fields (yfinance)
  - forwardPE: 25.425926
  - trailingPE: 74.61957
  - enterpriseToEbitda: 35.429
  - enterpriseToRevenue: 5.01
  ...
  - currentPrice: 137.3
  - heldPercentInstitutions: 0.96107
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-21 (~45d): ATM IV 105.9%
    - 25Δ put IV 107.4% vs 25Δ call IV 108.4% — skew -1.0% (balanced)
    - Same-day flow at this expiry: 6,610 call vol vs 199 put vol (C/P 33.22)
