...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #99 of 103 in universe (earnings yield -0.7%, return on capital -18.8%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +20.7%, 12-mo +101.2%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-09-18 (~45d): ATM IV 59.6%
    - 25Δ put IV 58.7% vs 25Δ call IV 57.7% — skew +1.0% (balanced)
    - Same-day flow at this expiry: 49 call vol vs 823 put vol (C/P 0.06)
