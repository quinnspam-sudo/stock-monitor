...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - No contract proposed: against: catalyst, flow_proxy, trend; 6-mo momentum -18% < 0% (falling knife); price below 200d SMA

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #91 of 109 in universe (earnings yield 1.3%, return on capital 15.3%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.33
  - Momentum: 6-mo -17.5%, 12-mo +19.0%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $36.02, margin of safety -372.3%
  ...
  - 52-week high breakout (O'Neil/Darvas): -39.9% from 52-wk high
...
## Recent news headlines
  ...
  - Why Is RDDT Stock Falling Today? Two Things Investors Are Watching (2026-07-22)
  - Reddit shares drop as threat to cut off Google AI sparks standoff (2026-07-22)
  - Google Was a Lifeline for Publishers. Now Some Are Thinking of Cutting It Off. (2026-07-22)
  - The 401(k) Vesting Cliff That Cost One Worker $74,000 Before Age 60 (2026-07-22)
