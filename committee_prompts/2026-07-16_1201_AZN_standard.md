...
## Trigger(s) breached
- Earnings gate OPENED — earnings in 7 business day(s), positivity 74/100, beat streak 3/4 — buy decision is now actionable
...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - No contract proposed: against: catalyst, flow_proxy, trend; 6-mo momentum -11% < 0% (falling knife); price below 200d SMA

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #20 of 110 in universe (earnings yield 4.9%, return on capital 109.4%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.32
  - Momentum: 6-mo -11.1%, 12-mo +23.0%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $67.52, margin of safety -151.0%
...
## Raw data fields (yfinance)
  - forwardPE: 18.276606
  - trailingPE: 25.561087
  - enterpriseToEbitda: 14.342
  - enterpriseToRevenue: 4.752
  - pegRatio: 1.3226
...
## Recent news headlines
  ...
  - AZN Inks Deal With Dizal to In-License Rights to Lung Cancer Drug (2026-07-15)
  - AstraZeneca (LSE:AZN) Secures Zegfrovy In $1.5 Billion Lung Cancer Licensing Deal (2026-07-15)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-21 (~45d): ATM IV 31.8%
    - 25Δ put IV 33.1% vs 25Δ call IV 30.4% — skew +2.8% (balanced)
    - Same-day flow at this expiry: 310 call vol vs 332 put vol (C/P 0.93)
