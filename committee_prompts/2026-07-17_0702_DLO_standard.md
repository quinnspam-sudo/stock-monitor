...
## confirm or veto the positivity call using transcript/guidance judgment)
  ...
  - GATE VERDICT: NOT ACTIONABLE — earnings in 19 business days (window: ≤10); positivity 48/100 below strict bar 70; no reported-quarter history to verify beat streak
...
## Raw data fields (yfinance)
  ...
  - currentPrice: 13.92
  - heldPercentInstitutions: 0.63003
