...
- Previous evaluation date: 2026-07-29 09:02
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #34 of 104 in universe (earnings yield 2.9%, return on capital 139.0%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.60
  - Momentum: 6-mo -17.5%, 12-mo -37.4%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $116.78, margin of safety -196.1%
  ...
  - 52-week high breakout (O'Neil/Darvas): -44.3% from 52-wk high
...
## Raw data fields (yfinance)
  ...
  - currentPrice: 345.81
  - heldPercentInstitutions: 1.04018
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 56.3% vs 25Δ call IV 76.5% — skew -20.2% (upside being chased (call skew))
    - Same-day flow at this expiry: 96 call vol vs 57 put vol (C/P 1.68)
