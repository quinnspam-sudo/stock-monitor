...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #96 of 136 in universe (earnings yield 3.1%, return on capital 6.2%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.94
  - Momentum: 6-mo +12.2%, 12-mo +23.0%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $48.57, margin of safety -84.7%
...
## Recent news headlines
  - The AI-Driven Rise in Power Bills Are Causing a $25 Billion Problem for Utility Stocks (2026-07-14)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 31.7% vs 25Δ call IV 30.1% — skew +1.6% (balanced)
    - Same-day flow at this expiry: 2 call vol vs 1 put vol (C/P 2.00)
