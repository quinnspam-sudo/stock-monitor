...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #55 of 108 in universe (earnings yield 2.4%, return on capital 53.0%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.28
  - Momentum: 6-mo +53.4%, 12-mo +176.9%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $84.79, margin of safety -491.5%
...
## Raw data fields (yfinance)
  - forwardPE: 29.808441
  - trailingPE: 47.492462
  - enterpriseToEbitda: 43.353
  - enterpriseToRevenue: 13.854
  - pegRatio: 1.2826
  ...
  - currentPrice: 503.895
  - heldPercentInstitutions: 0.84474
  - numberOfAnalystOpinions: 35

## Recent news headlines
  - Microsoft joins, Broadcom exits Goldman’s top-stocks list (2026-08-03)
  - Applied Materials Rose 15% on Thursday and Is Still More Than 30% Below Its High. It Reports on Aug. 13. (2026-08-01)
  - Tech specialist explains why China memory fears are overblown (2026-07-31)
  - AEIS Set to Report Q2 Earnings: What's in the Cards for the Stock? (2026-07-31)
  - 1 of Wall Street’s Favorite Stocks for Long-Term Investors and 2 We Find Risky (2026-07-31)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - Same-day flow at this expiry: 2,754 call vol vs 1,681 put vol (C/P 1.64)
