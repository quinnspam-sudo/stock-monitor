...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #29 of 100 in universe (earnings yield 4.2%, return on capital 45.1%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.21
  - Momentum: 6-mo -12.6%, 12-mo -20.9%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $145.12, margin of safety -175.7%
  ...
  - 52-week high breakout (O'Neil/Darvas): -28.0% from 52-wk high
...
## Recent news headlines
  ...
  - AMD Stock Pops After Landing Expanded Microsoft AI Deal (2026-07-20)
  - I Keep Buying Amazon Because AI Capex Fears Were Never Real From The Start (2026-07-20)
  - Kimi K3 Hit a GPU Wall. Why Nvidia and Microsoft May Be the Real Winners (2026-07-20)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-28 (~45d): ATM IV 46.7%
    - 25Δ put IV 42.1% vs 25Δ call IV 45.4% — skew -3.4% (upside being chased (call skew))
    - Same-day flow at this expiry: 1,522 call vol vs 535 put vol (C/P 2.84)
