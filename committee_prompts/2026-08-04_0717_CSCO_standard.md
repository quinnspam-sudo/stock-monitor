...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - No contract proposed: against: catalyst, flow_proxy, trend, vol_mispricing; IV/RVf 1.32 >= 1.15 — vol too rich to buy

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #29 of 107 in universe (earnings yield 2.7%, return on capital 623.7%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.61
  - Momentum: 6-mo +45.9%, 12-mo +79.0%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $28.93, margin of safety -315.4%
...
## Raw data fields (yfinance)
  - forwardPE: 25.07509
  - trailingPE: 40.04333
  - enterpriseToEbitda: 27.813
  - enterpriseToRevenue: 7.787
  - pegRatio: 1.6097
  ...
  - targetMeanPrice: 131.36365
  - currentPrice: 120.13
  - heldPercentInstitutions: 0.83106005
  - numberOfAnalystOpinions: 22

## Recent news headlines
  - Tesla Trades at 140 Times Forward Earnings. Here's What Has to Go Right to Justify This Valuation (2026-08-04)
  - 3 Growth Stocks to Add to Your Roster (2026-08-04)
  - Are Wall Street Analysts Predicting Cisco Systems Stock Will Climb or Sink? (2026-08-04)
  - Cisco (CSCO) Stock May Trade At A Cash Flow Premium While Earnings Look Fair (2026-08-03)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 47.2% vs 25Δ call IV 48.9% — skew -1.7% (balanced)
    - Same-day flow at this expiry: 1,334 call vol vs 895 put vol (C/P 1.49)
