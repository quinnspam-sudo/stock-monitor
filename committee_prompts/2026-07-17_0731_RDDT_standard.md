...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #89 of 101 in universe (earnings yield 1.3%, return on capital 15.3%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.42
  - Momentum: 6-mo -20.3%, 12-mo +27.9%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $36.08, margin of safety -405.2%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-28 (~45d): ATM IV 81.6%
    - 25Δ put IV 88.0% vs 25Δ call IV 78.4% — skew +9.6% (heavy downside-protection bid (fear))
    - Same-day flow at this expiry: 111 call vol vs 83 put vol (C/P 1.34)
