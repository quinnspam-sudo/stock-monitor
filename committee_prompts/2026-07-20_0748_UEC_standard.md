...
## Supermajority consensus vote (last gate before a BUY alert)
  - Verdict: FAIL — 1/8 systems bullish (supermajority 65%, min 6 computable)
    ...
    - positivity_margin: ✘
    - quality_gates: ✔
  - HARD VETO: 6-mo momentum -48% < -10% (falling knife)
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #88 of 95 in universe (earnings yield -2.2%, return on capital -9.0%)
  - Piotroski F-Score: 4/9 (1 tests gapped) (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo -47.6%, 12-mo +17.1%
...
## Raw data fields (yfinance)
  - forwardPE: -93.7
  - enterpriseToEbitda: -34.003
  - enterpriseToRevenue: 203.281
  ...
  - beta: 1.186
  - currentPrice: 9.37
  - heldPercentInstitutions: 0.84690005
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 79.9% vs 25Δ call IV 77.5% — skew +2.3% (balanced)
    - Same-day flow at this expiry: 57 call vol vs 155 put vol (C/P 0.37)
