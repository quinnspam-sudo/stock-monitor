...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #62 of 108 in universe (earnings yield 0.8%, return on capital 53.5%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 0.49 (GARP: attractive <= 1)
  - Momentum: 6-mo +131.1%, 12-mo +735.4%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: FAIL
  - Graham/Buffett intrinsic value: Graham Number $88.73, margin of safety -529.6%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 107.7% vs 25Δ call IV 103.9% — skew +3.7% (balanced)
    - Same-day flow at this expiry: 392 call vol vs 376 put vol (C/P 1.04)
