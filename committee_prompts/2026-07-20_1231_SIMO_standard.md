...
## Trigger(s) breached
- Earnings gate OPENED — earnings in 7 business day(s), positivity 90/100, beat streak 3/4 — buy decision is now actionable
...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - HARD VETO: hostile market regime: SPY>!50d/200d, VIX 18.7 (max 28.0), term 0.917
  - No contract proposed: against: flow_proxy, trend, vol_mispricing; IV/RVf 1.32 >= 1.15 — vol too rich to buy; hostile market regime: SPY>!50d/200d, VIX 18.7 (max 28.0), term 0.917

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #107 of 121 in universe (earnings yield 1.1%, return on capital 11.1%)
  - Piotroski F-Score: 5/9 (1 tests gapped) (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +126.7%, 12-mo +246.9%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: GAPPED; Gross margin > 40%: PASS; CFO > Net Income: FAIL
  - Graham/Buffett intrinsic value: Graham Number $55.29, margin of safety -360.0%
  - CANSLIM (O'Neil): 4/7 criteria met — C: Y; A: Y; N: N; S: N; L: Y; I: Y; M: N
  - Dividend growth quality (if applicable): yield 0.8%, payout 40%, quality score 73/100, 5yr div CAGR +3.3%
...
## Raw data fields (yfinance)
  - forwardPE: 24.89129
  - trailingPE: 50.362373
  - enterpriseToEbitda: 52.374
  ...
  - currentPrice: 254.33
  - heldPercentInstitutions: 0.80866
...
## Recent news headlines
  ...
  - Looking for Earnings Beat? Buy These 5 Top-Ranked Stocks (2026-07-17)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-21 (~45d): ATM IV 127.4%
    - 25Δ put IV 122.4% vs 25Δ call IV 126.6% — skew -4.2% (upside being chased (call skew))
    - Same-day flow at this expiry: 1,879 call vol vs 347 put vol (C/P 5.41)
