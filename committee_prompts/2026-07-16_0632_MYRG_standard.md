...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #68 of 103 in universe (earnings yield 2.6%, return on capital 27.2%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +74.3%, 12-mo +111.0%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $96.04, margin of safety -316.5%
...
## Raw data fields (yfinance)
  - forwardPE: 29.688282
  - trailingPE: 44.052864
  - enterpriseToEbitda: 24.339
  - enterpriseToRevenue: 1.663
  ...
  - currentPrice: 400.0
  - heldPercentInstitutions: 1.02656
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - Same-day flow at this expiry: 45 call vol vs 6 put vol (C/P 7.50)
