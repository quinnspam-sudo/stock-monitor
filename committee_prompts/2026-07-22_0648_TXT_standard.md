...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #32 of 104 in universe (earnings yield 6.8%, return on capital 18.5%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.17
  - Momentum: 6-mo -5.2%, 12-mo +6.2%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: FAIL; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $73.66, margin of safety -23.9%
...
## Raw data fields (yfinance)
  ...
  - currentPrice: 91.29
  - heldPercentInstitutions: 0.91688
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - Same-day flow at this expiry: 60 call vol vs 125 put vol (C/P 0.48)
