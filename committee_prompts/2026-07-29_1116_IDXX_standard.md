...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #38 of 104 in universe (earnings yield 3.0%, return on capital 120.0%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 3.65
  - Momentum: 6-mo -17.0%, 12-mo -0.4%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $77.55, margin of safety -635.9%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 43.9% vs 25Δ call IV 45.1% — skew -1.1% (balanced)
    - Same-day flow at this expiry: 2 call vol vs 8 put vol (C/P 0.25)
