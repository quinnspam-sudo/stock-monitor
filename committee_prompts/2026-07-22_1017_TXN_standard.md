...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #71 of 111 in universe (earnings yield 2.3%, return on capital 27.3%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.40
  - Momentum: 6-mo +53.3%, 12-mo +40.9%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $49.30, margin of safety -497.4%
  - CANSLIM (O'Neil): 5/7 criteria met — C: Y; A: Y; N: N; S: N; L: Y; I: Y; M: Y
  - Dividend growth quality (if applicable): yield 1.9%, payout 95%, quality score 59/100, 5yr div CAGR +5.5%
...
## Raw data fields (yfinance)
  - forwardPE: 30.747738
  - trailingPE: 50.259384
  - enterpriseToEbitda: 31.628
  - enterpriseToRevenue: 14.864
  - pegRatio: 1.4021
  ...
  - targetMeanPrice: 307.58066
  - currentPrice: 294.52
  - heldPercentInstitutions: 0.94822997
  - numberOfAnalystOpinions: 31

## Recent news headlines
  - Earnings live: GE Vernova stock falls despite surge in orders, AT&T stock pops (2026-07-20)
  - S&P 500 edges higher as investors await Big Tech earnings (2026-07-22)
  - Big Tech Earnings Live: Reports from Alphabet, Tesla and IBM Due After the Closing Bell Today (2026-07-22)
  - Your Dividend Calendar for July 27–31: 10 Stocks and the Last Day to Buy Each One (2026-07-22)
  - What Qualcomm Stock Does When The Market Panics (2026-07-22)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-28 (~45d): ATM IV 64.9%
    - 25Δ put IV 67.8% vs 25Δ call IV 62.9% — skew +4.9% (balanced)
    - Same-day flow at this expiry: 50 call vol vs 286 put vol (C/P 0.17)
