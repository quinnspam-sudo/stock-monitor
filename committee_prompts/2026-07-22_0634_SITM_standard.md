...
## Trigger(s) breached
- Earnings gate OPENED — earnings in 10 business day(s), positivity 95/100, beat streak 4/4 — buy decision is now actionable
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #103 of 109 in universe (earnings yield -0.4%, return on capital -6.2%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +51.6%, 12-mo +189.2%
...
## Raw data fields (yfinance)
  - forwardPE: 46.44019
  - enterpriseToEbitda: 4685.832
  - enterpriseToRevenue: 38.938
  ...
  - currentPrice: 582.99
  - heldPercentInstitutions: 1.02273
  - numberOfAnalystOpinions: 8

## Recent news headlines
  - SiTime (SITM) Finalizes Acquisition of Renesas Timing Business to Accelerate Growth (2026-07-15)
  - Is SiTime Corporation (SITM) A Good Stock To Buy Now? (2026-07-03)
  - Dow Jones Futures Fall, Bloom Energy Jumps; SpaceX's First Buy Point (2026-07-01)
  - Microchip Introduces Space-Grade Clock Generator: More Growth Ahead? (2026-06-29)
  - Analysts Expect Another Stellar Year For This Specialty Chipmaker (2026-06-25)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  - Short interest trend:
    - Shares short 977,927 vs 1,099,733 prior month (-11.1% — FALLING)
    - Days-to-cover 1.4
  ...
  - Options skew / flow:
    ...
    - Same-day flow at this expiry: 121 call vol vs 44 put vol (C/P 2.75)
