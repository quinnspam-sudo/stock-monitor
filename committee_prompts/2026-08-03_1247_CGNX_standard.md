...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #77 of 107 in universe (earnings yield 1.5%, return on capital 24.2%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +69.0%, 12-mo +62.9%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $13.03, margin of safety -414.2%
...
## Raw data fields (yfinance)
  - forwardPE: 37.567684
  - trailingPE: 78.84705
  - enterpriseToEbitda: 46.964
  - enterpriseToRevenue: 10.159
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 71.3% vs 25Δ call IV 69.4% — skew +1.9% (balanced)
