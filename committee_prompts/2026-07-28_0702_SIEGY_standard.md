...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #38 of 103 in universe (earnings yield 4.2%, return on capital 40.9%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 5.36
  - Momentum: 6-mo +0.7%, 12-mo +16.8%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: FAIL; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $77.04, margin of safety -98.6%
  - CANSLIM (O'Neil): 1/7 criteria met — C: N; A: N; N: Y; S: N; L: N; I: N; M: N
  - Dividend growth quality (if applicable): yield 3.4%, payout 96%, quality score 55/100
...
## Raw data fields (yfinance)
  - forwardPE: 22.894789
  - trailingPE: 27.366724
  - enterpriseToEbitda: 24.889
