...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #90 of 107 in universe (earnings yield 0.9%, return on capital 6.3%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.72
  - Momentum: 6-mo +1.0%, 12-mo +47.5%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $18.44, margin of safety -674.0%
...
## Raw data fields (yfinance)
  - forwardPE: 31.550356
  - trailingPE: 139.96078
  - enterpriseToEbitda: 45.146
  - enterpriseToRevenue: 12.531
  - pegRatio: 2.7244
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 93.6% vs 25Δ call IV 88.6% — skew +5.0% (balanced)
