...
- Previous evaluation date: 2026-08-05 07:32
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #113 of 123 in universe (earnings yield 0.1%, return on capital 0.8%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +173.6%, 12-mo +308.5%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $40.67, margin of safety -454.2%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-09-18 (~45d): ATM IV 127.5%
    - 25Δ put IV 136.2% vs 25Δ call IV 131.5% — skew +4.7% (balanced)
    - Same-day flow at this expiry: 1,256 call vol vs 1,874 put vol (C/P 0.67)
