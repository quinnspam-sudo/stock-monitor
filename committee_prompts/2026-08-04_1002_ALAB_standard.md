...
- Previous evaluation date: 2026-08-04 09:02
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #97 of 120 in universe (earnings yield 0.3%, return on capital 13.1%)
  - Piotroski F-Score: 5/9 (1 tests gapped) (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +126.1%, 12-mo +159.8%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $17.38, margin of safety -1961.6%
  ...
  - Analyst estimate revision momentum: +25.2% (current vs 90 days ago)
...
## Recent news headlines
  ...
  - Should Investors Hold or Fold MRVL Stock at a P/S Multiple of 12X? (2026-08-04)
  - Astera Labs, GlobalFoundries Positioned for Long-term AI Growth, Morgan Stanley Says (2026-08-03)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-09-18 (~45d): ATM IV 115.7%
    - 25Δ put IV 117.7% vs 25Δ call IV 114.1% — skew +3.5% (balanced)
    - Same-day flow at this expiry: 1,059 call vol vs 558 put vol (C/P 1.90)
