...
## Raw data fields (yfinance)
  ...
  - targetMeanPrice: 20.63158
  - currentPrice: 17.1247
  - heldPercentInstitutions: 0.57009
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  - Short interest trend:
    - Shares short 185,956,377 vs 195,788,409 prior month (-5.0% — FALLING)
    - Days-to-cover 2.1
    - Short interest 14.7% of float — crowded short
  ...
  - Options skew / flow:
    ...
    - Same-day flow at this expiry: 172 call vol vs 303 put vol (C/P 0.57)
