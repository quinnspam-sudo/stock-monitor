...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #84 of 136 in universe (earnings yield 4.1%, return on capital 10.0%)
  - Piotroski F-Score: 4/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.28
  - Momentum: 6-mo +4.2%, 12-mo +37.7%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: FAIL; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $63.01, margin of safety -100.4%
...
## Raw data fields (yfinance)
  - forwardPE: 18.421864
  - trailingPE: 26.861704
  - enterpriseToEbitda: 22.731
  ...
  - currentPrice: 126.25
  - heldPercentInstitutions: 0.77296996
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-21 (~45d): ATM IV 42.3%
    - 25Δ put IV 51.5% vs 25Δ call IV 54.2% — skew -2.8% (upside being chased (call skew))
    - Same-day flow at this expiry: 94 call vol vs 32 put vol (C/P 2.94)
