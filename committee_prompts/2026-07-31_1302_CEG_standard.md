...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #67 of 107 in universe (earnings yield 3.4%, return on capital 15.1%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo -6.1%, 12-mo -22.5%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $154.76, margin of safety -69.8%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 47.8% vs 25Δ call IV 52.1% — skew -4.3% (upside being chased (call skew))
    - Same-day flow at this expiry: 367 call vol vs 610 put vol (C/P 0.60)
