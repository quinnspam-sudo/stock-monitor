...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - HARD VETO: hostile market regime: SPY>!50d/200d, VIX 20.3 (max 28.0), term 0.964
  - No contract proposed: against: flow_proxy, trend, vol_mispricing; IV/RVf 1.16 >= 1.15 — vol too rich to buy; hostile market regime: SPY>!50d/200d, VIX 20.3 (max 28.0), term 0.964

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #53 of 103 in universe (earnings yield 4.0%, return on capital 31.4%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.40
  - Momentum: 6-mo +3.3%, 12-mo -15.2%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $20.04, margin of safety -278.1%
...
## Raw data fields (yfinance)
  ...
  - currentPrice: 75.78
  - heldPercentInstitutions: 1.02354
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 51.3% vs 25Δ call IV 49.6% — skew +1.7% (balanced)
