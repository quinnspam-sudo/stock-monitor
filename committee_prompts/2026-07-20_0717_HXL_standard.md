...
## Trigger(s) breached
- Earnings gate OPENED — earnings in 7 business day(s), positivity 73/100, beat streak 3/4 — buy decision is now actionable
...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - No contract proposed: against: flow_proxy, trend, vol_mispricing; IV/RVf 1.58 >= 1.15 — vol too rich to buy

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #93 of 112 in universe (earnings yield 2.0%, return on capital 8.6%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.61
  - Momentum: 6-mo +28.0%, 12-mo +76.7%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: FAIL; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $23.89, margin of safety -340.7%
...
## Raw data fields (yfinance)
  - forwardPE: 32.931038
  - trailingPE: 69.71523
  - enterpriseToEbitda: 25.432
  - enterpriseToRevenue: 4.525
  - pegRatio: 1.61
  ...
  - currentPrice: 105.27
  - heldPercentInstitutions: 1.17704
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - Same-day flow at this expiry: 29 call vol vs 2 put vol (C/P 14.50)
