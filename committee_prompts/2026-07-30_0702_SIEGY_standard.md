...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #45 of 116 in universe (earnings yield 4.3%, return on capital 40.9%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 5.36
  - Momentum: 6-mo +4.2%, 12-mo +23.0%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: FAIL; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $76.35, margin of safety -110.4%
...
## Raw data fields (yfinance)
  - forwardPE: 24.045664
  - trailingPE: 29.26594
  - enterpriseToEbitda: 24.69
  - enterpriseToRevenue: 3.669
  - pegRatio: 5.3598
