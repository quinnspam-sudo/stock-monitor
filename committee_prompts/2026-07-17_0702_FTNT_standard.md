...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #50 of 110 in universe (earnings yield 2.0%, return on capital 92.6%)
  ...
  - Graham/Buffett intrinsic value: Graham Number $8.74, margin of safety -1751.9%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 69.8% vs 25Δ call IV 67.2% — skew +2.6% (balanced)
    - Same-day flow at this expiry: 12 call vol vs 99 put vol (C/P 0.12)
