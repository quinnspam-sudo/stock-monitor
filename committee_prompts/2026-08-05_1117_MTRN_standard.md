...
Generated: 2026-08-05 11:17 local | Source: stock-monitor local daemon
...
- Previous evaluation date: 2026-08-05 10:17
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #86 of 107 in universe (earnings yield 2.2%, return on capital 9.9%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +93.9%, 12-mo +171.5%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: FAIL; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $61.55, margin of safety -376.9%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 54.9% vs 25Δ call IV 56.1% — skew -1.2% (balanced)
    - Same-day flow at this expiry: 77 call vol vs 35 put vol (C/P 2.20)
