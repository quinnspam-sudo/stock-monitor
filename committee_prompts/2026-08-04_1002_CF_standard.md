...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #28 of 120 in universe (earnings yield 10.5%, return on capital 25.8%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 3.75
  - Momentum: 6-mo +29.3%, 12-mo +29.2%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $93.19, margin of safety -27.1%
  - CANSLIM (O'Neil): 5/7 criteria met — C: Y; A: Y; N: N; S: N; L: Y; I: Y; M: Y
  - Dividend growth quality (if applicable): yield 1.7%, payout 18%, quality score 94/100, 5yr div CAGR +10.8%
...
## Raw data fields (yfinance)
  - forwardPE: 10.515599
  - trailingPE: 10.672973
  - enterpriseToEbitda: 6.595
  - enterpriseToRevenue: 3.06
  - pegRatio: 3.7474
  ...
  - currentPrice: 118.47
  - heldPercentInstitutions: 1.04481
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - SEC filing stream:
    ...
    - 2026-03-17 ARS — Annual Report to Shareholders
  - Options skew / flow:
    - Reference expiry 2026-09-18 (~45d): ATM IV 44.1%
    - 25Δ put IV 48.4% vs 25Δ call IV 45.0% — skew +3.4% (balanced)
    - Same-day flow at this expiry: 257 call vol vs 1,074 put vol (C/P 0.24)
