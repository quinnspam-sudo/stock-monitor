...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #10 of 110 in universe (earnings yield 5.1%, return on capital 118.3%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.00
  - Momentum: 6-mo -17.8%, 12-mo -21.2%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $89.79, margin of safety -57.6%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 33.6% vs 25Δ call IV 40.1% — skew -6.4% (upside being chased (call skew))
    - Same-day flow at this expiry: 38 call vol vs 10 put vol (C/P 3.80)
