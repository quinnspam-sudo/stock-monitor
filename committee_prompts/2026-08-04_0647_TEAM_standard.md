...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #100 of 108 in universe (earnings yield -0.3%, return on capital -6.9%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 0.77 (GARP: attractive <= 1)
  - Momentum: 6-mo +1.9%, 12-mo -42.4%
...
## Raw data fields (yfinance)
  ...
  - currentPrice: 107.01
  - heldPercentInstitutions: 1.07183
...
## Recent news headlines
  ...
  - Redditors Think Wall Street is Wrong About Atlassian (TEAM) (2026-07-29)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-09-18 (~45d): ATM IV 70.2%
    - 25Δ put IV 89.5% vs 25Δ call IV 76.3% — skew +13.2% (heavy downside-protection bid (fear))
    - Same-day flow at this expiry: 419 call vol vs 317 put vol (C/P 1.32)
