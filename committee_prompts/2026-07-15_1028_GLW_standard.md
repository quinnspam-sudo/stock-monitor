...
Generated: 2026-07-15 10:28 local | Source: stock-monitor local daemon
...
- Previous evaluation date: 2026-07-15 09:23
...
## Supermajority consensus vote (last gate before a BUY alert)
  - Verdict: FAIL — 5/10 systems bullish (supermajority 65%, min 6 computable)
    ...
    - positivity_margin: ✘
    - quality_gates: ✔
  - Market regime: SPY>50d/200d, VIX 16.2 (max 28.0), term 0.841 — OK
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  ...
  - PEG (GARP): 1.79
  - Momentum: 6-mo +90.9%, 12-mo +229.1%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $24.69, margin of safety -592.6%
...
## Raw data fields (yfinance)
  - forwardPE: 39.85557
  - trailingPE: 82.20193
  - enterpriseToEbitda: 43.562
  - enterpriseToRevenue: 10.428
  - pegRatio: 1.7856
  ...
  - currentPrice: 170.98
  - heldPercentInstitutions: 0.73536
  - numberOfAnalystOpinions: 15

## Recent news headlines
  - Zacks Industry Outlook Corning, Viavi and Ooma (2026-07-15)
  - Applied Optoelectronics Bets Big on AI With Nearly 400,000-Square-Foot Texas Expansion (2026-07-14)
  - 3 Communication Stocks Set to Soar on Inherent Sector Strength (2026-07-14)
  - Corning Earnings Preview: What to Expect (2026-07-14)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 93.7% vs 25Δ call IV 88.1% — skew +5.6% (balanced)
    - Same-day flow at this expiry: 129 call vol vs 157 put vol (C/P 0.82)
