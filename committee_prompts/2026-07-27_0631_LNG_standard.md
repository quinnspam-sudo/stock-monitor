...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #25 of 103 in universe (earnings yield 10.5%, return on capital 24.1%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 9.46
  - Momentum: 6-mo +27.7%, 12-mo +16.0%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $48.75, margin of safety -438.4%
...
## Raw data fields (yfinance)
  - forwardPE: 13.2979
  - trailingPE: 44.412014
  - enterpriseToEbitda: 14.561
  ...
  - currentPrice: 262.475
  - heldPercentInstitutions: 0.90731
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Commodity driver (futures):
    - Natural gas (NG=F): 2.81, 3-mo +10.0%, below 50d SMA — mixed
