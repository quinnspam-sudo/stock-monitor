...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #51 of 106 in universe (earnings yield 2.1%, return on capital 91.1%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 0.82 (GARP: attractive <= 1)
  - Momentum: 6-mo +56.3%, 12-mo +226.0%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $119.52, margin of safety -1383.0%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-21 (~45d): ATM IV 77.1%
    - 25Δ put IV 82.7% vs 25Δ call IV 73.4% — skew +9.3% (heavy downside-protection bid (fear))
    - Same-day flow at this expiry: 256 call vol vs 146 put vol (C/P 1.75)
