...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #31 of 108 in universe (earnings yield 10.4%, return on capital 21.3%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo -21.6%, 12-mo +94.3%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $25.76, margin of safety -4.0%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - Same-day flow at this expiry: 83 call vol vs 26 put vol (C/P 3.19)
  - Commodity driver (futures):
    - Copper (HG=F): 6.46, 3-mo +11.4%, above 50d SMA — tailwind
