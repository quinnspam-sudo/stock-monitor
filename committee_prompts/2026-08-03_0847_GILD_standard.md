...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  ...
  - PEG (GARP): 2.14
  - Momentum: 6-mo -8.0%, 12-mo +16.4%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $55.92, margin of safety -132.4%
...
## Raw data fields (yfinance)
  - forwardPE: 13.507866
  - trailingPE: 17.700954
  - enterpriseToEbitda: 11.802
  - enterpriseToRevenue: 5.849
  - pegRatio: 2.1441
  ...
  - currentPrice: 129.925
  - heldPercentInstitutions: 0.92082
  - numberOfAnalystOpinions: 27

## Recent news headlines
  - Gilead Sciences (GILD) Q2 Earnings Report Preview: What To Look For (2026-08-03)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 37.1% vs 25Δ call IV 34.3% — skew +2.8% (balanced)
    - Same-day flow at this expiry: 552 call vol vs 158 put vol (C/P 3.49)
