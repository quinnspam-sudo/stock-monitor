...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #64 of 109 in universe (earnings yield 4.5%, return on capital 12.5%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 3.82
  - Momentum: 6-mo +19.5%, 12-mo +25.9%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $21.73, margin of safety -50.9%
...
## Raw data fields (yfinance)
  - forwardPE: 21.777403
  - trailingPE: 21.999998
  - enterpriseToEbitda: 14.152
  - enterpriseToRevenue: 6.006
  - pegRatio: 3.8245
  ...
  - currentPrice: 32.78
  - heldPercentInstitutions: 0.70922
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - Same-day flow at this expiry: 48 call vol vs 9 put vol (C/P 5.33)
