...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #33 of 104 in universe (earnings yield 2.9%, return on capital 139.0%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.60
  - Momentum: 6-mo -18.6%, 12-mo -38.2%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $116.78, margin of safety -192.4%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 52.1% vs 25Δ call IV 79.1% — skew -27.0% (upside being chased (call skew))
    - Same-day flow at this expiry: 98 call vol vs 62 put vol (C/P 1.58)
