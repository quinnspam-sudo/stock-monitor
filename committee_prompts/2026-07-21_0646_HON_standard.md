...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #9 of 102 in universe (earnings yield 7.0%, return on capital 58.8%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 8.44
  - Momentum: 6-mo +1.4%, 12-mo -0.5%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $109.97, margin of safety -105.9%
...
## Recent news headlines
  ...
  - Honeywell Aerospace secures IndiGo avionics contract and Aeromexico runway safety rollout (2026-07-20)
