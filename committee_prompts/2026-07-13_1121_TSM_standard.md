...
Generated: 2026-07-13 11:21 local | Source: stock-monitor local daemon
...
## Supermajority consensus vote (last gate before a BUY alert)
  - Verdict: FAIL — 6/10 systems bullish (supermajority 65%, min 6 computable)
    ...
    - positivity_margin: ✔
    - quality_gates: ✔
  - Market regime: SPY>50d/200d, VIX 16.9 (max 28.0), term 0.865 — OK
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #6 of 120 in universe (earnings yield 13.0%, return on capital 34.1%)
  - Piotroski F-Score: 9/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.36
  - Momentum: 6-mo +31.6%, 12-mo +87.4%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $33.82, margin of safety -1153.2%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 50.4% vs 25Δ call IV 52.7% — skew -2.3% (upside being chased (call skew))
    - Same-day flow at this expiry: 355 call vol vs 1,023 put vol (C/P 0.35)
