...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #89 of 140 in universe (earnings yield 1.9%, return on capital 34.4%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.18
  - Momentum: 6-mo +28.0%, 12-mo +47.2%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: GAPPED; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $26.48, margin of safety -584.9%
...
## Recent news headlines
  ...
  - Broadridge Gears Up to Report Q4 Earnings: What's in the Cards? (2026-07-31)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 68.7% vs 25Δ call IV 65.6% — skew +3.1% (balanced)
    - Same-day flow at this expiry: 1,990 call vol vs 486 put vol (C/P 4.09)
