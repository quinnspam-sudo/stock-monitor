...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - HARD VETO: hostile market regime: SPY>!50d/200d, VIX 19.0 (max 28.0), term 0.911
  - No contract proposed: against: flow_proxy, trend, vol_mispricing; IV/RVf 1.34 >= 1.15 — vol too rich to buy; hostile market regime: SPY>!50d/200d, VIX 19.0 (max 28.0), term 0.911
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  ...
  - PEG (GARP): 1.48
  - Momentum: 6-mo +0.4%, 12-mo -16.7%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $12.42, margin of safety -101.7%
