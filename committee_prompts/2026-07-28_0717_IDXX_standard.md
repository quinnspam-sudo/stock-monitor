...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #40 of 100 in universe (earnings yield 3.0%, return on capital 120.0%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 3.49
  - Momentum: 6-mo -17.2%, 12-mo +2.0%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $77.43, margin of safety -645.9%
...
## Raw data fields (yfinance)
  - forwardPE: 34.969284
  - trailingPE: 42.563007
  - enterpriseToEbitda: 28.967
  - enterpriseToRevenue: 10.072
  - pegRatio: 3.488
  ...
  - currentPrice: 577.58
  - heldPercentInstitutions: 0.98282
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 42.7% vs 25Δ call IV 39.0% — skew +3.7% (balanced)
