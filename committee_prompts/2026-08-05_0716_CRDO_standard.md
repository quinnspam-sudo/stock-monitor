...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #79 of 105 in universe (earnings yield 1.0%, return on capital 23.1%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +141.7%, 12-mo +112.5%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: FAIL
  - Graham/Buffett intrinsic value: Graham Number $26.19, margin of safety -794.6%
...
## Raw data fields (yfinance)
  - forwardPE: 25.817913
  - trailingPE: 85.51825
  - enterpriseToEbitda: 89.544
  - enterpriseToRevenue: 32.169
  ...
  - currentPrice: 234.32
  - heldPercentInstitutions: 0.77198
...
## Recent news headlines
  ...
  - Credo Technology Surges 52% YTD: Buy, Sell or Hold the Stock? (2026-08-04)
  - Nvidia Stock Retakes Key Level As Chip Stocks Waver (2026-08-03)

## Recent insider transactions
  - LAM YAT TUNG — Sale at price 209.83 - 216.49 per share. (2026-07-31)
  - CHENG CHI FUNG — Sale at price 201.22 - 215.35 per share. (2026-07-31)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-09-18 (~45d): ATM IV 132.5%
    - 25Δ put IV 112.1% vs 25Δ call IV 126.3% — skew -14.2% (upside being chased (call skew))
    - Same-day flow at this expiry: 367 call vol vs 420 put vol (C/P 0.87)
