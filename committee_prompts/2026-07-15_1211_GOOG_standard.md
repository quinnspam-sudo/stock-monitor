...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  ...
  - PEG (GARP): 1.41
  - Momentum: 6-mo +9.8%, 12-mo +102.1%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $107.96, margin of safety -241.8%
...
## Recent news headlines
  ...
  - Oracle Leads Race for Japan's Classified Cloud (2026-07-15)
  - Equity Markets Rise Intraday as Big Tech Gains (2026-07-15)
  - This Growth ETF Costs 3 Cents and Has Beaten the S&P 500 in 95% of 5-Year Windows (2026-07-15)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-28 (~45d): ATM IV 42.3%
    - 25Δ put IV 35.3% vs 25Δ call IV 39.6% — skew -4.3% (upside being chased (call skew))
    - Same-day flow at this expiry: 244 call vol vs 275 put vol (C/P 0.89)
