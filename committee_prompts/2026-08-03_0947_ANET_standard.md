...
Generated: 2026-08-03 09:47 local | Source: stock-monitor local daemon
...
- Previous evaluation date: 2026-08-03 08:47
...
## Supermajority consensus vote (last gate before a BUY alert)
  - Verdict: FAIL — 4/10 systems bullish (supermajority 65%, min 6 computable)
    ...
    - positivity_margin: ✘
    - quality_gates: ✔
  - Market regime: SPY>50d/200d, VIX 15.6 (max 28.0), term 0.832 — OK
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #75 of 107 in universe (earnings yield 1.8%, return on capital 34.4%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.30
  - Momentum: 6-mo +31.6%, 12-mo +51.4%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: GAPPED; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $26.44, margin of safety -589.0%
...
## Raw data fields (yfinance)
  - forwardPE: 40.774574
  - trailingPE: 62.813793
  - enterpriseToEbitda: 50.681
  - enterpriseToRevenue: 22.116
  - pegRatio: 2.3001
  ...
  - currentPrice: 182.155
  - heldPercentInstitutions: 0.72944
...
## Recent news headlines
  ...
  - CDW Q2 Earnings on the Horizon: Can it Deliver Another Beat? (2026-08-03)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-09-18 (~45d): ATM IV 69.8%
    - 25Δ put IV 69.3% vs 25Δ call IV 66.9% — skew +2.3% (balanced)
    - Same-day flow at this expiry: 1,243 call vol vs 410 put vol (C/P 3.03)
