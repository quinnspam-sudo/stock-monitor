...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - No contract proposed: against: catalyst, trend, vol_mispricing; IV/RVf 1.42 >= 1.15 — vol too rich to buy

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #62 of 106 in universe (earnings yield 3.6%, return on capital 21.9%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.30
  - Momentum: 6-mo +4.8%, 12-mo +9.3%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $87.92, margin of safety -184.9%
...
## Recent news headlines
  ...
  - Undervalued and Winning the AI Hyperscaler War: 3 Reasons Amazon is a No-Brainer Right Now (2026-07-20)
  - How To Bank 8.8% On GOOGL Stock Before Buying A Single Share (2026-07-20)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 40.9% vs 25Δ call IV 41.7% — skew -0.8% (balanced)
    - Same-day flow at this expiry: 817 call vol vs 485 put vol (C/P 1.68)
