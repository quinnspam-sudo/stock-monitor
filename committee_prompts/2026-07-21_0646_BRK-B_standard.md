...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #80 of 102 in universe (earnings yield -33.0%, return on capital 37.2%)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - Same-day flow at this expiry: 144 call vol vs 149 put vol (C/P 0.97)
