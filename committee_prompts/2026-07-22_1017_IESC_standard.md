...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #52 of 111 in universe (earnings yield 3.1%, return on capital 54.6%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +40.5%, 12-mo +115.9%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: FAIL
  - Graham/Buffett intrinsic value: Graham Number $150.63, margin of safety -342.7%
...
## Raw data fields (yfinance)
  - trailingPE: 35.601177
  - enterpriseToEbitda: 26.584
  - enterpriseToRevenue: 3.512
  ...
  - currentPrice: 666.81
  - heldPercentInstitutions: 0.97702
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 75.6% vs 25Δ call IV 76.6% — skew -1.0% (balanced)
    - Same-day flow at this expiry: 151 call vol vs 38 put vol (C/P 3.97)
