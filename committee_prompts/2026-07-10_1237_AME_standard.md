...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  ...
  - PEG (GARP): 3.02
  - Momentum: 6-mo +12.1%, 12-mo +30.2%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $84.24, margin of safety -178.6%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 33.9% vs 25Δ call IV 34.4% — skew -0.4% (balanced)
    - Same-day flow at this expiry: 584 call vol vs 542 put vol (C/P 1.08)
