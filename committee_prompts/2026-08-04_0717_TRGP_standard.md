...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - No contract proposed: against: catalyst, flow_proxy, trend, vol_mispricing; IV/RVf 1.40 >= 1.15 — vol too rich to buy
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  ...
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +28.5%, 12-mo +60.6%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $56.11, margin of safety -361.7%
  - CANSLIM (O'Neil): 5/7 criteria met — C: Y; A: Y; N: N; S: N; L: Y; I: Y; M: Y
  - Dividend growth quality (if applicable): yield 1.6%, payout 44%, quality score 100/100, 5yr div CAGR +103.6%
...
## Raw data fields (yfinance)
  - forwardPE: 21.702435
  - trailingPE: 27.041754
  - enterpriseToEbitda: 14.559
  - enterpriseToRevenue: 4.586
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 37.1% vs 25Δ call IV 40.3% — skew -3.2% (upside being chased (call skew))
    - Same-day flow at this expiry: 136 call vol vs 307 put vol (C/P 0.44)
