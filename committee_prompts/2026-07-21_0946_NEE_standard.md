...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #79 of 107 in universe (earnings yield 3.1%, return on capital 6.2%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.93
  - Momentum: 6-mo +6.7%, 12-mo +18.7%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $48.45, margin of safety -81.3%
...
## Raw data fields (yfinance)
  - forwardPE: 19.955574
  - trailingPE: 22.299492
  - enterpriseToEbitda: 20.999
  - enterpriseToRevenue: 10.67
  - pegRatio: 1.9298
  ...
  - targetMeanPrice: 99.2
  - currentPrice: 87.86
  - heldPercentInstitutions: 0.87013
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-28 (~45d): ATM IV 31.2%
    - 25Δ put IV 30.3% vs 25Δ call IV 47.1% — skew -16.8% (upside being chased (call skew))
    - Same-day flow at this expiry: 29 call vol vs 13 put vol (C/P 2.23)
