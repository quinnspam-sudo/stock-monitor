...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #5 of 63 in universe (earnings yield 6.9%, return on capital 44.9%)
  - Piotroski F-Score: 5/9 (1 tests gapped) (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.31
  - Momentum: 6-mo -26.9%, 12-mo -39.9%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $76.71, margin of safety -77.2%
  ...
  - 52-week high breakout (O'Neil/Darvas): -41.4% from 52-wk high
...
## Raw data fields (yfinance)
  - forwardPE: 11.898915
  - trailingPE: 13.966599
  - enterpriseToEbitda: 15.724
  - enterpriseToRevenue: 4.983
  - pegRatio: 1.3089
  ...
  - currentPrice: 135.895
  - heldPercentInstitutions: 0.78217006
...
## Recent news headlines
  ...
  - Check Point (CHKP) Partners With AWS European Sovereign Cloud For EU Security Push (2026-07-03)
  - Cybersecurity Spending Just Crossed $300 Billion and These 3 ETFs Are the Cleanest Plays on the AI Era Attack Surface (2026-07-03)
