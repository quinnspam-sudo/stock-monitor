...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #19 of 108 in universe (earnings yield 3.3%, return on capital 144.0%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 3.13
  - Momentum: 6-mo +6.2%, 12-mo +31.5%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $84.24, margin of safety -186.2%
...
## Raw data fields (yfinance)
  - forwardPE: 27.370996
  - trailingPE: 36.415787
  - enterpriseToEbitda: 23.706
  ...
  - currentPrice: 241.0725
  - heldPercentInstitutions: 0.92581004
  - numberOfAnalystOpinions: 18

## Recent news headlines
  - AMETEK (AME) Q2 Earnings: What To Expect (2026-08-03)
  - Entegris Likely to Beat Q2 Earnings Estimates: How to Play the Stock (2026-07-31)
  - ICHR Set to Report Q2 Earnings: What's in Store for the Stock? (2026-07-30)
  - Unlocking Q2 Potential of Ametek (AME): Exploring Wall Street Estimates for Key Metrics (2026-07-30)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - Same-day flow at this expiry: 275 call vol vs 157 put vol (C/P 1.75)
