...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #18 of 94 in universe (earnings yield 3.4%, return on capital 144.0%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 3.05
  - Momentum: 6-mo +11.1%, 12-mo +33.4%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $84.17, margin of safety -180.4%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-21 (~45d): ATM IV 38.0%
    - 25Δ put IV 41.3% vs 25Δ call IV 38.5% — skew +2.9% (balanced)
    - Same-day flow at this expiry: 1,159 call vol vs 145 put vol (C/P 7.99)
