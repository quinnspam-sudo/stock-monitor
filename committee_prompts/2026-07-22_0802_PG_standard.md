...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #9 of 115 in universe (earnings yield 5.7%, return on capital 159.3%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 4.19
  - Momentum: 6-mo +3.7%, 12-mo -3.6%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $59.60, margin of safety -150.5%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 29.6% vs 25Δ call IV 26.8% — skew +2.8% (balanced)
    - Same-day flow at this expiry: 124 call vol vs 45 put vol (C/P 2.76)
