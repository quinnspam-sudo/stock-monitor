...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - HARD VETO: hostile market regime: SPY>!50d/200d, VIX 18.2 (max 28.0), term 0.908
  - No contract proposed: against: catalyst, flow_proxy, trend, vol_mispricing; hostile market regime: SPY>!50d/200d, VIX 18.2 (max 28.0), term 0.908

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #78 of 102 in universe (earnings yield 0.5%, return on capital 21.6%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.25
  - Momentum: 6-mo +94.5%, 12-mo +190.9%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $51.49, margin of safety -880.7%
...
## Raw data fields (yfinance)
  ...
  - targetMeanPrice: 573.1489
  - currentPrice: 504.29
  - heldPercentInstitutions: 0.74119
...
## Recent news headlines
  ...
  - Intel More Than Quadrupled In A Year, So Why Has It Cooled? (2026-07-27)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-09-04 (~45d): ATM IV 84.3%
    - 25Δ put IV 77.4% vs 25Δ call IV 82.6% — skew -5.1% (upside being chased (call skew))
    - Same-day flow at this expiry: 594 call vol vs 55 put vol (C/P 10.80)
