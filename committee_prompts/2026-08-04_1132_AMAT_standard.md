...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #56 of 107 in universe (earnings yield 2.3%, return on capital 53.0%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.28
  - Momentum: 6-mo +72.5%, 12-mo +202.2%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $84.83, margin of safety -546.5%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 85.8% vs 25Δ call IV 86.9% — skew -1.0% (balanced)
    - Same-day flow at this expiry: 3,816 call vol vs 1,539 put vol (C/P 2.48)
