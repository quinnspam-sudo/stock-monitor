...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  ...
  - PEG (GARP): 4.15
  - Momentum: 6-mo +7.7%, 12-mo +36.2%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $56.30, margin of safety -167.9%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-21 (~45d): ATM IV 31.5%
    - 25Δ put IV 29.3% vs 25Δ call IV 30.3% — skew -0.9% (balanced)
    - Same-day flow at this expiry: 715 call vol vs 288 put vol (C/P 2.48)
