...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #30 of 107 in universe (earnings yield 3.0%, return on capital 139.0%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.53
  - Momentum: 6-mo -29.0%, 12-mo -45.7%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $116.94, margin of safety -160.1%
...
## Raw data fields (yfinance)
  - forwardPE: 20.504654
  - trailingPE: 41.944828
  - enterpriseToEbitda: 28.842
  - enterpriseToRevenue: 5.506
  - pegRatio: 1.5258
  ...
  - currentPrice: 304.1
  - heldPercentInstitutions: 1.03684
  - numberOfAnalystOpinions: 21

## Recent news headlines
  - Wall Street Analysts Predict a 35.12% Upside in Tyler Technologies (TYL): Here's  What You Should Know (2026-07-21)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 50.7% vs 25Δ call IV 59.1% — skew -8.4% (upside being chased (call skew))
    - Same-day flow at this expiry: 48 call vol vs 25 put vol (C/P 1.92)
