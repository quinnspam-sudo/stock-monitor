...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #82 of 120 in universe (earnings yield 3.7%, return on capital 9.4%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 4.08
  - Momentum: 6-mo +56.0%, 12-mo +126.5%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $208.31, margin of safety -45.7%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 42.3% vs 25Δ call IV 47.2% — skew -4.9% (upside being chased (call skew))
    - Same-day flow at this expiry: 4,152 call vol vs 712 put vol (C/P 5.83)
  - Commodity driver (futures):
    - WTI crude (CL=F): 74.91, 3-mo -21.2%, below 50d SMA — headwind
