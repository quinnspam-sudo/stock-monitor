...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #80 of 103 in universe (earnings yield 3.6%, return on capital 4.7%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.13
  - Momentum: 6-mo +5.7%, 12-mo +13.4%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $54.37, margin of safety -44.8%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-21 (~45d): ATM IV 26.6%
    - 25Δ put IV 26.9% vs 25Δ call IV 26.0% — skew +1.0% (balanced)
    - Same-day flow at this expiry: 70 call vol vs 84 put vol (C/P 0.83)
