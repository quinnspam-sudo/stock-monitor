...
## confirm or veto the positivity call using transcript/guidance judgment)
  ...
  - Earnings Positivity Score: 87/100 (strict pass bar 70, beat streak None/0 last quarters)
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #105 of 118 in universe (earnings yield 1.0%, return on capital 11.1%)
  - Piotroski F-Score: 5/9 (1 tests gapped) (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +134.8%, 12-mo +268.4%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: GAPPED; Gross margin > 40%: PASS; CFO > Net Income: FAIL
  - Graham/Buffett intrinsic value: Graham Number $55.29, margin of safety -378.7%
  - CANSLIM (O'Neil): 5/7 criteria met — C: Y; A: Y; N: N; S: N; L: Y; I: Y; M: Y
  - Dividend growth quality (if applicable): yield 0.7%, payout 40%, quality score 73/100, 5yr div CAGR +3.3%
...
## Raw data fields (yfinance)
  - forwardPE: 25.903267
  - trailingPE: 52.4099
  - enterpriseToEbitda: 54.009
  - enterpriseToRevenue: 8.518
  ...
  - currentPrice: 264.67
  - heldPercentInstitutions: 0.8087
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-21 (~45d): ATM IV 120.3%
    - 25Δ put IV 127.4% vs 25Δ call IV 120.7% — skew +6.6% (heavy downside-protection bid (fear))
    - Same-day flow at this expiry: 1,909 call vol vs 263 put vol (C/P 7.26)
