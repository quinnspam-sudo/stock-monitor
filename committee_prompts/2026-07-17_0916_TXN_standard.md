...
## Trigger(s) breached
- Earnings gate OPENED — earnings in 3 business day(s), positivity 94/100, beat streak 3/4 — buy decision is now actionable
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #71 of 106 in universe (earnings yield 2.3%, return on capital 27.3%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.39
  - Momentum: 6-mo +53.4%, 12-mo +36.1%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $49.26, margin of safety -482.6%
...
## Raw data fields (yfinance)
  ...
  - currentPrice: 286.82
  - heldPercentInstitutions: 0.9395
  - numberOfAnalystOpinions: 32

## Recent news headlines
  - 4 Tech Stocks Throwing Off Dividends (2026-07-17)
  - TXN Likely to Beat Q2 Earnings Estimates: How to Play the Stock? (2026-07-17)
  - XLP's Future Earnings Outlook Is Tilting Up (2026-07-17)
  - What Could Fuel a Real Turnaround for Alcoa Stock? (2026-07-17)
  - Best Income Stocks to Buy for July 17th (2026-07-17)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-28 (~45d): ATM IV 60.6%
    - 25Δ put IV 67.1% vs 25Δ call IV 60.7% — skew +6.4% (heavy downside-protection bid (fear))
    - Same-day flow at this expiry: 14 call vol vs 268 put vol (C/P 0.05)
