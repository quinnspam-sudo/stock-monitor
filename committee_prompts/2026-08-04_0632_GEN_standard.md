...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  ...
  - PEG (GARP): 1.55
  - Momentum: 6-mo +25.7%, 12-mo -1.8%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $12.58, margin of safety -122.0%
  - CANSLIM (O'Neil): 5/7 criteria met — C: Y; A: Y; N: N; S: N; L: Y; I: Y; M: Y
  - Dividend growth quality (if applicable): yield 1.8%, payout 31%, quality score 76/100, 5yr div CAGR -7.8%
...
## Raw data fields (yfinance)
  - forwardPE: 8.491671
  - trailingPE: 17.335403
  - enterpriseToEbitda: 10.393
  ...
  - currentPrice: 27.91
  - heldPercentInstitutions: 0.90801
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - Same-day flow at this expiry: 54 call vol vs 1 put vol (C/P 54.00)
