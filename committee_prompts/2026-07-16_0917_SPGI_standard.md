...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  ...
  - PEG (GARP): 1.85
  - Momentum: 6-mo -11.8%, 12-mo -8.0%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $193.61, margin of safety -133.7%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 45.5% vs 25Δ call IV 45.8% — skew -0.3% (balanced)
    - Same-day flow at this expiry: 8 call vol vs 9 put vol (C/P 0.89)
