...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #17 of 115 in universe (earnings yield 13.5%, return on capital 34.1%)
  - Piotroski F-Score: 9/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.32
  - Momentum: 6-mo +27.8%, 12-mo +86.5%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $33.83, margin of safety -1146.7%
  - CANSLIM (O'Neil): 4/7 criteria met — C: Y; A: Y; N: N; S: N; L: Y; I: N; M: Y
  - Dividend growth quality (if applicable): yield 5.7%, payout 209%, quality score 59/100, 5yr div CAGR +5.8%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 50.3% vs 25Δ call IV 56.6% — skew -6.2% (upside being chased (call skew))
    - Same-day flow at this expiry: 432 call vol vs 1,567 put vol (C/P 0.28)
