...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #87 of 137 in universe (earnings yield 4.1%, return on capital 10.0%)
  - Piotroski F-Score: 4/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.25
  - Momentum: 6-mo +5.5%, 12-mo +34.0%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: FAIL; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $63.01, margin of safety -97.3%
...
## Raw data fields (yfinance)
  - forwardPE: 18.134466
  - trailingPE: 26.444681
  - enterpriseToEbitda: 22.284
  ...
  - currentPrice: 124.29
  - heldPercentInstitutions: 0.76104
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 50.3% vs 25Δ call IV 43.9% — skew +6.5% (heavy downside-protection bid (fear))
    - Same-day flow at this expiry: 101 call vol vs 41 put vol (C/P 2.46)
