...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #45 of 68 in universe (earnings yield 1.0%, return on capital 15.7%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 0.14 (GARP: attractive <= 1)
  - Momentum: 6-mo +176.4%, 12-mo +677.4%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $252.75, margin of safety -275.4%
...
## Raw data fields (yfinance)
  - forwardPE: 6.3406157
  - trailingPE: 21.466063
  - enterpriseToEbitda: 15.247
  - enterpriseToRevenue: 11.522
  - pegRatio: 0.1449
  ...
  - currentPrice: 948.8
  - heldPercentInstitutions: 0.81303
  - numberOfAnalystOpinions: 42

## Recent news headlines
  - AI memory stocks trim losses as investors buy the dip (2026-07-08)
  - Micron, Broadcom, Palantir, Delta, SpaceX, and More Stocks That Explain Today’s Market (2026-07-08)
  - Is Micron (MU) One of the Most Profitable Cheap Stocks to Buy Right Now? (2026-07-08)
  - Stock Market Today: Nasdaq Swings To Score A Win; Fed Minutes Show Split On Direction (2026-07-08)
  - Nvidia Stock Is Cheaper Than It's Been Since the AI Boom Began (2026-07-08)
