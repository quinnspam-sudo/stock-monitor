...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #12 of 107 in universe (earnings yield 4.1%, return on capital 133.2%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 7.80
  - Momentum: 6-mo -7.8%, 12-mo -18.7%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $33.48, margin of safety -114.6%
...
## Raw data fields (yfinance)
  ...
  - currentPrice: 71.865
  - heldPercentInstitutions: 0.85679
  - numberOfAnalystOpinions: 48

## Recent news headlines
  - Ex-Uber boss Travis Kalanick lands air taxi 'vertiport' deal with Joby (2026-08-04)
  - JOBY Stock Pops 8% On US Infrastructure Push Ahead Of Commercial Operations Launch (2026-08-04)
  - Angel investor says Bitcoin has bottomed, sell it and buy Solana (2026-08-04)
  - What's Maplebear's Probability of an Earnings Beat This Season? (2026-08-04)
  - Is CAR Stock Worth Buying Despite Weak Liquidity and High Valuation? (2026-08-04)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 41.7% vs 25Δ call IV 43.2% — skew -1.4% (balanced)
    - Same-day flow at this expiry: 4,415 call vol vs 2,842 put vol (C/P 1.55)
