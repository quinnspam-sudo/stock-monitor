...
## Trigger(s) breached
- Earnings gate OPENED — earnings in 10 business day(s), positivity 74/100, beat streak 3/4 — buy decision is now actionable
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #17 of 110 in universe (earnings yield 4.8%, return on capital 109.4%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.31
  - Momentum: 6-mo -9.5%, 12-mo +20.2%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $67.57, margin of safety -151.0%
...
## Raw data fields (yfinance)
  - forwardPE: 18.29923
  - trailingPE: 25.537653
  - enterpriseToEbitda: 14.592
  - enterpriseToRevenue: 4.835
  - pegRatio: 1.3056
  ...
  - currentPrice: 169.57
  - heldPercentInstitutions: 0.68327004
  - numberOfAnalystOpinions: 10

## Recent news headlines
  - Biogen Stock Is Upgraded to Buy Ahead of Key Alzheimer’s Drug Study Details (2026-07-13)
  - Health Care Roundup: Market Talk (2026-07-13)
  - AstraZeneca Shares Slip After HSBC Cuts Rating Following Wainua Setback (AZN) (2026-07-13)
  - HSBC downgrades AstraZeneca after key trial failure (2026-07-13)
  - UBS stays positive on AstraZeneca ahead of second-quarter results (2026-07-13)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-21 (~45d): ATM IV 32.6%
    - 25Δ put IV 32.6% vs 25Δ call IV 31.9% — skew +0.7% (balanced)
    - Same-day flow at this expiry: 1,339 call vol vs 260 put vol (C/P 5.15)
