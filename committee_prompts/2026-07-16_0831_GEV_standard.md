...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #76 of 95 in universe (earnings yield 0.5%, return on capital 26.5%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.82
  - Momentum: 6-mo +60.5%, 12-mo +84.6%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $199.64, margin of safety -417.9%
...
## Raw data fields (yfinance)
  - forwardPE: 41.998257
  - trailingPE: 30.226967
  - enterpriseToEbitda: 81.611
  - enterpriseToRevenue: 7.078
  - pegRatio: 1.8167
  ...
  - currentPrice: 1033.46
  - heldPercentInstitutions: 0.79498
...
## Recent news headlines
  ...
  - Micron and General Mills have been highlighted as Zacks Bull and Bear of the Day (2026-07-16)
  - Is GEV Stock a Smart Investment Option Before Q2 Earnings Release? (2026-07-15)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 62.2% vs 25Δ call IV 64.1% — skew -2.0% (balanced)
    - Same-day flow at this expiry: 59 call vol vs 1,610 put vol (C/P 0.04)
