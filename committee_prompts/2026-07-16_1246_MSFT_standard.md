...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  ...
  - PEG (GARP): 1.22
  - Momentum: 6-mo -12.5%, 12-mo -20.2%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $145.07, margin of safety -175.9%
...
## Raw data fields (yfinance)
  ...
  - currentPrice: 400.165
  - heldPercentInstitutions: 0.75655997
  - numberOfAnalystOpinions: 55

## Recent news headlines
  - Wall Street explores tokenization of assets (2026-07-16)
  - Microsoft Sees Paid-Search Ad Media Buys Rise (2026-07-16)
  - Microsoft Stock Rises 2.9% as AI Sales Push Targets OpenAI and Anthropic (2026-07-16)
  - Microsoft Stock Rises. Why It's Taking On OpenAI, Google, and Anthropic (2026-07-16)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 40.8% vs 25Δ call IV 46.9% — skew -6.0% (upside being chased (call skew))
    - Same-day flow at this expiry: 1,049 call vol vs 1,350 put vol (C/P 0.78)
