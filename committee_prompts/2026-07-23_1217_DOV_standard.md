...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #24 of 108 in universe (earnings yield 4.9%, return on capital 47.7%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.79
  - Momentum: 6-mo -5.6%, 12-mo +4.1%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $100.06, margin of safety -96.6%
...
## Recent news headlines
  - Dover Q2 Earnings Call Highlights (2026-07-23)
  - Dover Corporation Q2 2026 Earnings Call Summary (2026-07-23)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 35.1% vs 25Δ call IV 33.4% — skew +1.7% (balanced)
    - Same-day flow at this expiry: 83 call vol vs 54 put vol (C/P 1.54)
