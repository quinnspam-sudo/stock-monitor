...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #13 of 111 in universe (earnings yield 5.4%, return on capital 112.6%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 4.03
  - Momentum: 6-mo +11.3%, 12-mo +40.0%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $56.30, margin of safety -175.3%
  - CANSLIM (O'Neil): 3/7 criteria met — C: N; A: N; N: Y; S: N; L: Y; I: N; M: Y
  - Dividend growth quality (if applicable): yield 3.1%, payout 67%, quality score 70/100
...
## Raw data fields (yfinance)
  - forwardPE: 15.898287
  - trailingPE: 22.209885
  - enterpriseToEbitda: 14.218
  ...
  - currentPrice: 155.025
  - heldPercentInstitutions: 0.076630004
  - numberOfAnalystOpinions: 10

## Recent news headlines
  - Novartis Q2 2026 earnings beat as cancer, MS drugs drive growth (2026-07-21)
  - U.S. stocks set for higher open as strong earnings boost market sentiment: Dow Jones, S&P, Nasdaq, Wall Street Futures (2026-07-21)
  - Exchange-Traded Funds, Equity Futures Higher Pre-Bell Tuesday as Semiconductor Recovery Supports Markets (2026-07-21)
  - Update: Potential Middle East Ceasefire Lifts US Equity Futures Pre-Bell (2026-07-21)
  - Novartis Bounds For Buy Point. Why Shares Are On The Rise. (2026-07-21)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-21 (~45d): ATM IV 27.2%
    - 25Δ put IV 29.7% vs 25Δ call IV 26.3% — skew +3.4% (balanced)
    - Same-day flow at this expiry: 130 call vol vs 203 put vol (C/P 0.64)
