...
## Trigger(s) breached
- Earnings gate OPENED — earnings in 10 business day(s), positivity 96/100, beat streak 4/4 — buy decision is now actionable
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #65 of 136 in universe (earnings yield 1.4%, return on capital 59.1%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.90
  - Momentum: 6-mo +54.0%, 12-mo +237.1%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $31.77, margin of safety -966.5%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - Same-day flow at this expiry: 75 call vol vs 69 put vol (C/P 1.09)
