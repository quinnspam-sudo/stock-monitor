...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #5 of 104 in universe (earnings yield 5.7%, return on capital 159.3%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 4.16
  - Momentum: 6-mo -0.7%, 12-mo -5.3%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $59.64, margin of safety -145.9%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 29.2% vs 25Δ call IV 27.8% — skew +1.4% (balanced)
    - Same-day flow at this expiry: 290 call vol vs 61 put vol (C/P 4.75)
