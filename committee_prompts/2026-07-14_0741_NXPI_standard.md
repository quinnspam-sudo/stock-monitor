...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #43 of 117 in universe (earnings yield 4.0%, return on capital 44.5%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 0.75 (GARP: attractive <= 1)
  - Momentum: 6-mo +21.3%, 12-mo +29.9%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $100.90, margin of safety -184.1%
  - CANSLIM (O'Neil): 5/7 criteria met — C: Y; A: Y; N: N; S: N; L: Y; I: Y; M: Y
  - Dividend growth quality (if applicable): yield 1.5%, payout 39%, quality score 82/100, 5yr div CAGR +12.5%
...
## Raw data fields (yfinance)
  - forwardPE: 16.160303
  - trailingPE: 27.404875
  - enterpriseToEbitda: 18.901
  - enterpriseToRevenue: 6.235
  - pegRatio: 0.7454
  ...
  - currentPrice: 286.655
  - heldPercentInstitutions: 1.00822
...
## Recent news headlines
  ...
  - Nvidia, Chip Stocks Rally Despite U.S.-Iran War Flare-Up (2026-07-08)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-21 (~45d): ATM IV 65.8%
    - 25Δ put IV 66.6% vs 25Δ call IV 65.3% — skew +1.3% (balanced)
    - Same-day flow at this expiry: 80 call vol vs 212 put vol (C/P 0.38)
