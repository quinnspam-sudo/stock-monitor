...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #41 of 107 in universe (earnings yield 4.0%, return on capital 40.9%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 5.36
  - Momentum: 6-mo +8.0%, 12-mo +22.5%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: FAIL; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $77.31, margin of safety -102.8%
  - CANSLIM (O'Neil): 2/7 criteria met — C: N; A: N; N: Y; S: N; L: N; I: N; M: Y
  - Dividend growth quality (if applicable): yield 3.2%, payout 96%, quality score 55/100
...
## Raw data fields (yfinance)
  - forwardPE: 23.466486
  - trailingPE: 28.201439
  - enterpriseToEbitda: 26.117
  ...
  - currentPrice: 156.8
  - heldPercentInstitutions: 0.00421
  - numberOfAnalystOpinions: 4

## Recent news headlines
  - Siemens (XTRA:SIE) Could Be 10% Undervalued On Record Q3 And Guidance Upgrade (2026-08-06)
  - Siemens Shares Fall as Digital Industries Order Growth Misses Expectations (2026-08-06)
  - European Indexes Rise as Earnings Drive Markets (2026-08-06)
  - Siemens shares plunge on disappointing guidance raise (2026-08-06)
  - Siemens Aktiengesellschaft Q3 Earnings Call Highlights (2026-08-06)
