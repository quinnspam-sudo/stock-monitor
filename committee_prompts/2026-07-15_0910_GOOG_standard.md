...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  ...
  - PEG (GARP): 1.41
  - Momentum: 6-mo +10.3%, 12-mo +103.0%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $107.96, margin of safety -243.2%
...
## Recent news headlines
  ...
  - Oracle Leads Japan Secure Cloud Talks (2026-07-15)
  - Apple chasing AI chip company deals, The Information reports (2026-07-15)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-28 (~45d): ATM IV 40.1%
    - 25Δ put IV 37.9% vs 25Δ call IV 39.4% — skew -1.5% (balanced)
    - Same-day flow at this expiry: 123 call vol vs 240 put vol (C/P 0.51)
