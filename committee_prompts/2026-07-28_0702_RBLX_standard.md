...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - HARD VETO: hostile market regime: SPY>!50d/200d, VIX 19.3 (max 28.0), term 0.941
  - No contract proposed: against: flow_proxy, trend, vol_mispricing; IV/RVf 1.47 >= 1.15 — vol too rich to buy; 6-mo momentum -33% < 0% (falling knife); price below 200d SMA; hostile market regime: SPY>!50d/200d, VIX 19.3 (max 28.0), term 0.941

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #99 of 103 in universe (earnings yield -3.1%, return on capital -78.6%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo -33.1%, 12-mo -60.1%
  ...
  - 52-week high breakout (O'Neil/Darvas): -68.0% from 52-wk high
