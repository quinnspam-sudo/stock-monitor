...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #21 of 107 in universe (earnings yield 4.1%, return on capital 72.9%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.46
  - Momentum: 6-mo -10.0%, 12-mo -5.3%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $65.06, margin of safety -390.5%
...
## Raw data fields (yfinance)
  - forwardPE: 23.993763
  - trailingPE: 30.656101
  - enterpriseToEbitda: 20.291
  ...
  - currentPrice: 319.13
  - heldPercentInstitutions: 0.82587
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 32.7% vs 25Δ call IV 32.6% — skew +0.1% (balanced)
    - Same-day flow at this expiry: 901 call vol vs 145 put vol (C/P 6.21)
