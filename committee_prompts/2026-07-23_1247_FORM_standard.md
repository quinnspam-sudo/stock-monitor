...
## Trigger(s) breached
- Earnings gate OPENED — earnings in 4 business day(s), positivity 87/100, beat streak 3/4 — buy decision is now actionable
...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - HARD VETO: hostile market regime: SPY>!50d/200d, VIX 19.2 (max 28.0), term 0.919
  - No contract proposed: against: catalyst, flow_proxy, trend, vol_mispricing; hostile market regime: SPY>!50d/200d, VIX 19.2 (max 28.0), term 0.919

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #87 of 107 in universe (earnings yield 0.8%, return on capital 9.9%)
  - Piotroski F-Score: 4/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +39.3%, 12-mo +228.1%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $16.31, margin of safety -591.8%
...
## Raw data fields (yfinance)
  - forwardPE: 40.412003
  - trailingPE: 129.65518
  - enterpriseToEbitda: 62.36
  - enterpriseToRevenue: 10.203
  - freeCashflow: -566875
  ...
  - currentPrice: 112.8
  - heldPercentInstitutions: 0.98207
  - numberOfAnalystOpinions: 9

## Recent news headlines
  - NVTS Set to Report Q2 Earnings: Buy, Sell or Hold the Stock? (2026-07-23)
  - FormFactor (FORM) Could Be 21% Undervalued On Its AI And HBM Growth Narrative (2026-07-22)
  - FormFactor (FORM) Stock Looks Strong On Returns But Rich On Earnings (2026-07-22)
  - Seagate, Western Digital, FormFactor, Amkor, and Teradyne Shares Are Soaring, What You Need To Know (2026-07-21)
  - Zacks Industry Outlook Highlights Applied Materials, Lam Research and FormFactor (2026-07-21)

## Recent insider transactions
  - SLESSOR MICHAEL D — Sale at price 116.56 - 121.30 per share. (2026-07-15)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-09-18 (~45d): ATM IV 120.0%
    - Same-day flow at this expiry: 10 call vol vs 45 put vol (C/P 0.22)
