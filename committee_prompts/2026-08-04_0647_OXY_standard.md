...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #61 of 108 in universe (earnings yield 5.4%, return on capital 6.5%)
  - Piotroski F-Score: 4/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.20
  - Momentum: 6-mo +20.7%, 12-mo +28.9%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $22.38, margin of safety -141.8%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 42.1% vs 25Δ call IV 42.6% — skew -0.5% (balanced)
    - Same-day flow at this expiry: 3,448 call vol vs 559 put vol (C/P 6.17)
