...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #82 of 112 in universe (earnings yield 3.5%, return on capital 10.9%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.24
  - Momentum: 6-mo +149.0%, 12-mo +50.3%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $9.93, margin of safety -372.9%
...
## Raw data fields (yfinance)
  - forwardPE: 39.645573
  - trailingPE: 47.454544
  - enterpriseToEbitda: 15.077
  - enterpriseToRevenue: 7.55
  - pegRatio: 2.2442
  ...
  - currentPrice: 46.98
  - heldPercentInstitutions: 0.89774
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-21 (~45d): ATM IV 69.5%
    - Same-day flow at this expiry: 151 call vol vs 46 put vol (C/P 3.28)
