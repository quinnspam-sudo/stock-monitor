...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - HARD VETO: hostile market regime: SPY>!50d/200d, VIX 19.8 (max 28.0), term 0.954
  - No contract proposed: against: catalyst, flow_proxy, trend, vol_mispricing; IV/RVf 1.35 >= 1.15 — vol too rich to buy; hostile market regime: SPY>!50d/200d, VIX 19.8 (max 28.0), term 0.954

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #115 of 140 in universe (earnings yield 0.2%, return on capital 3.2%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.57
  - Momentum: 6-mo +88.8%, 12-mo +73.7%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $10.04, margin of safety -2496.8%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-09-18 (~45d): ATM IV 81.4%
    - 25Δ put IV 78.5% vs 25Δ call IV 75.5% — skew +3.0% (balanced)
    - Same-day flow at this expiry: 653 call vol vs 326 put vol (C/P 2.00)
