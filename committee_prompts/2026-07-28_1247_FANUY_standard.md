...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - HARD VETO: hostile market regime: SPY>!50d/200d, VIX 18.2 (max 28.0), term 0.918
  - No contract proposed: against: trend; 6-mo momentum -5% < 0% (falling knife); price below 200d SMA; hostile market regime: SPY>!50d/200d, VIX 18.2 (max 28.0), term 0.918

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #90 of 101 in universe (earnings yield -26.3%, return on capital 11.1%)
  - Piotroski F-Score: 7/9 (1 tests gapped) (8-9 strong, 0-2 weak)
  - PEG (GARP): 3.32
  - Momentum: 6-mo -5.4%, 12-mo +32.0%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: GAPPED; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $8.70, margin of safety -124.0%
  - CANSLIM (O'Neil): 0/7 criteria met — C: N; A: N; N: N; S: N; L: N; I: N; M: N
  - Dividend growth quality (if applicable): yield 524.7%, payout 19471%, quality score 35/100
...
## Raw data fields (yfinance)
  - forwardPE: 29.089552
  - trailingPE: 35.436363
  - enterpriseToEbitda: -3.013
  - enterpriseToRevenue: -0.813
  - pegRatio: 3.3169
