...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - HARD VETO: hostile market regime: SPY>!50d/200d, VIX 19.8 (max 28.0), term 0.954
  - No contract proposed: against: catalyst, flow_proxy, trend; hostile market regime: SPY>!50d/200d, VIX 19.8 (max 28.0), term 0.954

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #116 of 140 in universe (earnings yield 0.1%, return on capital 1.1%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +29.9%, 12-mo +24.1%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-09-18 (~45d): ATM IV 105.7%
    - 25Δ put IV 105.1% vs 25Δ call IV 104.1% — skew +1.0% (balanced)
    - Same-day flow at this expiry: 185 call vol vs 147 put vol (C/P 1.26)
