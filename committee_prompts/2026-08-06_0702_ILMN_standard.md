...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #45 of 107 in universe (earnings yield 3.8%, return on capital 41.9%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.88
  - Momentum: 6-mo +42.6%, 12-mo +101.7%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $47.57, margin of safety -300.4%
...
## Raw data fields (yfinance)
  - forwardPE: 31.40556
  - trailingPE: 35.60187
  - enterpriseToEbitda: 27.307
  - enterpriseToRevenue: 7.018
  - pegRatio: 2.8801
  ...
  - currentPrice: 190.47
  - heldPercentInstitutions: 1.08194
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Institutional flow (13F deltas):
    ...
    - Blackrock Inc.: 12.60% held, +3.8% q/q
    - Capital World Investors: 10.30% held, -22.6% q/q
    - Vanguard Portfolio Management LLC: 4.52% held, +100.0% q/q
    - Vanguard Capital Management LLC: 4.37% held, +100.0% q/q
    - State Street Corporation: 4.26% held, +3.9% q/q
    - WCM Investment Management, LLC: 3.92% held, +45.5% q/q
  - SEC filing stream:
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 49.2% vs 25Δ call IV 51.3% — skew -2.1% (upside being chased (call skew))
    - Same-day flow at this expiry: 461 call vol vs 128 put vol (C/P 3.60)
