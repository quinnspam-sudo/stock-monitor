...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #74 of 105 in universe (earnings yield 2.9%, return on capital 12.2%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 0.44 (GARP: attractive <= 1)
  - Momentum: 6-mo +1.7%, 12-mo -26.6%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $35.27, margin of safety -343.4%
...
## Raw data fields (yfinance)
  - forwardPE: 15.140939
  - trailingPE: 26.110184
  - enterpriseToEbitda: 10.658
  - enterpriseToRevenue: 3.722
  - pegRatio: 0.4441
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 54.6% vs 25Δ call IV 55.1% — skew -0.6% (balanced)
    - Same-day flow at this expiry: 4,683 call vol vs 2,421 put vol (C/P 1.93)
