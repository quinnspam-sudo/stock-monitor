...
- Previous evaluation date: 2026-08-04 09:47
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #65 of 106 in universe (earnings yield 3.2%, return on capital 19.4%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.46
  - Momentum: 6-mo -34.2%, 12-mo -42.6%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $42.56, margin of safety -288.3%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 55.8% vs 25Δ call IV 64.3% — skew -8.6% (upside being chased (call skew))
    - Same-day flow at this expiry: 117 call vol vs 101 put vol (C/P 1.16)
