...
## Trigger(s) breached
- Exited Top 5 ranked opportunities (rank 5 → 8)
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #20 of 106 in universe (earnings yield 4.9%, return on capital 85.5%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 5.56
  - Momentum: 6-mo +9.8%, 12-mo +8.9%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $44.93, margin of safety -222.4%
...
## Raw data fields (yfinance)
  ...
  - currentPrice: 144.855
  - heldPercentInstitutions: 1.08803
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 61.2% vs 25Δ call IV 59.6% — skew +1.6% (balanced)
    - Same-day flow at this expiry: 114 call vol vs 67 put vol (C/P 1.70)
