...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #52 of 133 in universe (earnings yield 2.0%, return on capital 92.6%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 3.69
  - Momentum: 6-mo +103.0%, 12-mo +58.1%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $9.05, margin of safety -1651.1%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-21 (~45d): ATM IV 76.4%
    - 25Δ put IV 63.8% vs 25Δ call IV 74.5% — skew -10.7% (upside being chased (call skew))
    - Same-day flow at this expiry: 811 call vol vs 493 put vol (C/P 1.65)
