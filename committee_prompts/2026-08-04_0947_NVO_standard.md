...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #3 of 106 in universe (earnings yield 40.3%, return on capital 81.6%)
  - Piotroski F-Score: 4/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 3.16
  - Momentum: 6-mo -7.3%, 12-mo -3.4%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $25.77, margin of safety -74.3%
  - CANSLIM (O'Neil): 4/7 criteria met — C: Y; A: Y; N: N; S: Y; L: N; I: N; M: Y
  - Dividend growth quality (if applicable): yield 24.8%, payout 278%, quality score 57/100, 5yr div CAGR +35.6%
...
## Recent news headlines
  ...
  - Pfizer Covid Pill Revenue Plunges 95%. That’s Just One Reason the Stock Is Slipping. (2026-08-04)
  - SpaceX Earnings, Jobs Numbers: What to Watch This Week (2026-08-04)
  - ‘Arrogance kills’: Novo chief injects risk-taking into Ozempic maker (2026-08-04)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 30.2% vs 25Δ call IV 52.5% — skew -22.4% (upside being chased (call skew))
    - Same-day flow at this expiry: 1,865 call vol vs 1,094 put vol (C/P 1.70)
