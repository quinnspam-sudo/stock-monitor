...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #66 of 110 in universe (earnings yield 1.7%, return on capital 60.8%)
  - Piotroski F-Score: 9/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.27
  - Momentum: 6-mo +38.6%, 12-mo +129.4%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $18.82, margin of safety -1034.9%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-21 (~45d): ATM IV 92.9%
    - 25Δ put IV 92.8% vs 25Δ call IV 89.7% — skew +3.1% (balanced)
    - Same-day flow at this expiry: 2,531 call vol vs 3,411 put vol (C/P 0.74)
