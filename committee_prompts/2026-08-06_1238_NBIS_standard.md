...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #100 of 109 in universe (earnings yield 0.1%, return on capital 0.8%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +159.1%, 12-mo +247.4%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $40.51, margin of safety -372.4%
...
## Raw data fields (yfinance)
  - forwardPE: -88.60801
  - trailingPE: 74.23256
  - enterpriseToEbitda: -1458.617
  - enterpriseToRevenue: 64.133
  ...
  - currentPrice: 191.52
  - heldPercentInstitutions: 0.65806997
  - numberOfAnalystOpinions: 16

## Recent news headlines
  - Why Nvidia-Backed Nebius Group Stock Got Crushed on Thursday (2026-08-06)
  - Nebius Is Still Up 136% This Year. It Is Time to Take Profits and Switch to Cloudflare, CoreWeave, or Snowflake? (2026-08-06)
  - After Surging 298%, Is Nebius Stock Still a Buy? Here's What History Says. (2026-08-06)
  - Sabre (SABR) Reports Q2 Loss, Beats Revenue Estimates (2026-08-06)
  - Nebius Director John Wilson Boynton IV Sells 5,812 Shares for $1.5 Million (2026-08-06)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-09-18 (~45d): ATM IV 124.7%
    - 25Δ put IV 120.9% vs 25Δ call IV 126.4% — skew -5.5% (upside being chased (call skew))
    - Same-day flow at this expiry: 7,477 call vol vs 6,548 put vol (C/P 1.14)
