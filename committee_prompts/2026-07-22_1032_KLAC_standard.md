...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #64 of 107 in universe (earnings yield 1.7%, return on capital 60.8%)
  - Piotroski F-Score: 9/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.24
  - Momentum: 6-mo +42.8%, 12-mo +144.2%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $18.80, margin of safety -1051.7%
...
## Raw data fields (yfinance)
  - forwardPE: 42.177982
  - trailingPE: 61.485794
  - enterpriseToEbitda: 48.781
  - enterpriseToRevenue: 21.79
  - pegRatio: 2.2364
  ...
  - currentPrice: 216.43
  - heldPercentInstitutions: 0.95755
...
## Recent news headlines
  ...
  - KLA (KLAC) Earnings Expected to Grow: What to Know Ahead of Next Week's Release (2026-07-21)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 97.6% vs 25Δ call IV 86.8% — skew +10.8% (heavy downside-protection bid (fear))
    - Same-day flow at this expiry: 2,450 call vol vs 7,396 put vol (C/P 0.33)
