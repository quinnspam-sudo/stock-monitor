...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  ...
  - PEG (GARP): 1.45
  - Momentum: 6-mo -31.1%, 12-mo -44.8%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $116.78, margin of safety -161.5%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 53.1% vs 25Δ call IV 54.9% — skew -1.8% (balanced)
    - Same-day flow at this expiry: 26 call vol vs 32 put vol (C/P 0.81)
