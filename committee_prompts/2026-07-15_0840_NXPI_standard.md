...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #48 of 118 in universe (earnings yield 3.9%, return on capital 44.5%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 0.72 (GARP: attractive <= 1)
  - Momentum: 6-mo +17.9%, 12-mo +28.7%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $100.85, margin of safety -177.3%
  - CANSLIM (O'Neil): 5/7 criteria met — C: Y; A: Y; N: N; S: N; L: Y; I: Y; M: Y
  - Dividend growth quality (if applicable): yield 1.4%, payout 39%, quality score 82/100, 5yr div CAGR +12.5%
...
## Raw data fields (yfinance)
  - forwardPE: 15.762574
  - trailingPE: 26.755981
  - enterpriseToEbitda: 19.234
  - enterpriseToRevenue: 6.344
  - pegRatio: 0.724
  ...
  - targetMeanPrice: 310.31033
  - currentPrice: 279.6
  - heldPercentInstitutions: 1.0078399
...
## Recent news headlines
  ...
  - NXP Semiconductors (NXPI) Outpaces Stock Market Gains: What You Should Know (2026-07-14)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Institutional flow (13F deltas):
    ...
    - Vanguard Capital Management LLC: 3.20% held, +100.0% q/q
  - SEC filing stream:
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-21 (~45d): ATM IV 67.3%
    - 25Δ put IV 64.1% vs 25Δ call IV 66.2% — skew -2.1% (upside being chased (call skew))
    - Same-day flow at this expiry: 81 call vol vs 451 put vol (C/P 0.18)
