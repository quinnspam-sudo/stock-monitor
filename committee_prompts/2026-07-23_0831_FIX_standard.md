...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - HARD VETO: hostile market regime: SPY>!50d/200d, VIX 19.9 (max 28.0), term 0.933
  - No contract proposed: against: catalyst, flow_proxy, trend, vol_mispricing; IV/RVf 1.26 >= 1.15 — vol too rich to buy; hostile market regime: SPY>!50d/200d, VIX 19.9 (max 28.0), term 0.933

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #53 of 102 in universe (earnings yield 2.0%, return on capital 91.1%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 0.85 (GARP: attractive <= 1)
  - Momentum: 6-mo +61.6%, 12-mo +234.3%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $119.49, margin of safety -1429.6%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 73.8% vs 25Δ call IV 74.9% — skew -1.1% (balanced)
