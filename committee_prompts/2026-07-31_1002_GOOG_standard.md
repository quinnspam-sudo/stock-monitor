...
## Trigger(s) breached
- Overall score Δ -27 (threshold ±8)
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: GAPPED (earnings yield GAPPED, return on capital 43.7%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 0.90 (GARP: attractive <= 1)
  - Momentum: 6-mo +4.4%, 12-mo +83.6%
  ...
  - CANSLIM (O'Neil): 1/7 criteria met (3 gapped) — C: ?; A: ?; N: N; S: N; L: N; I: ?; M: Y
  - Dividend growth quality (if applicable): yield 0.3%, quality score 32/100, 5yr div CAGR -15.4%
  ...
  - Analyst estimate revision momentum: +28.2% (current vs 90 days ago)
...
## Recent news headlines
  - Why Amazon stock isn't getting bogged down by its negative free cash flow (2026-07-31)
  - Apple stock plunges: CEO Tim Cook explains weak revenue forecast (2026-07-31)
  - Amazon stock soars after Q2 earnings beat expectations as AI, chip businesses see $25 billion run rate (2026-07-29)
  - Amazon, Apple, Microsoft, Micron, Roblox, Reddit, SK Hynix, and More Stocks That Explain Today’s Market (2026-07-31)
  - Today’s Dow Moves as Told by Magnificent 7 Stocks (2026-07-31)
