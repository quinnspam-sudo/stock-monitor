...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #19 of 104 in universe (earnings yield 3.4%, return on capital 144.0%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 3.05
  - Momentum: 6-mo +12.2%, 12-mo +34.8%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $84.17, margin of safety -183.3%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 38.1% vs 25Δ call IV 36.3% — skew +1.8% (balanced)
    - Same-day flow at this expiry: 3,161 call vol vs 148 put vol (C/P 21.36)
