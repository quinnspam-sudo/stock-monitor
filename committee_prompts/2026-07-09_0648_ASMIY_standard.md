...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #53 of 95 in universe (earnings yield 1.9%, return on capital 45.9%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.99
  - Momentum: 6-mo +45.1%, 12-mo +77.0%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $227.80, margin of safety -366.8%
  ...
  - 52-week high breakout (O'Neil/Darvas): -14.9% from 52-wk high
