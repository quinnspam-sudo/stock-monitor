...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - HARD VETO: hostile market regime: SPY>!50d/200d, VIX 18.2 (max 28.0), term 0.906
  - No contract proposed: against: catalyst, flow_proxy, trend; hostile market regime: SPY>!50d/200d, VIX 18.2 (max 28.0), term 0.906

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #54 of 108 in universe (earnings yield 6.0%, return on capital 13.5%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.33
  - Momentum: 6-mo +12.3%, 12-mo +43.5%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $90.57, margin of safety -71.9%
...
## Raw data fields (yfinance)
  ...
  - currentPrice: 155.64
  - heldPercentInstitutions: 0.68292
...
## Recent news headlines
  ...
  - BofA just turned on Exxon in favor of Chevron (2026-07-30)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 33.0% vs 25Δ call IV 30.3% — skew +2.6% (balanced)
    - Same-day flow at this expiry: 1,714 call vol vs 2,580 put vol (C/P 0.66)
  - Commodity driver (futures):
    - WTI crude (CL=F): 84.14, 3-mo -19.9%, above 50d SMA — mixed
