...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #34 of 109 in universe (earnings yield 3.7%, return on capital 56.7%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +9.5%, 12-mo +13.9%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $320.51, margin of safety -98.8%
...
## Raw data fields (yfinance)
  - forwardPE: 24.561573
  - trailingPE: 32.358803
  - enterpriseToEbitda: 20.411
  - enterpriseToRevenue: 5.043
  ...
  - currentPrice: 639.41
  - heldPercentInstitutions: 1.00376
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 45.9% vs 25Δ call IV 38.3% — skew +7.6% (heavy downside-protection bid (fear))
    - Same-day flow at this expiry: 38 call vol vs 632 put vol (C/P 0.06)
