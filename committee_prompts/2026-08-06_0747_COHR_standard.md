...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #88 of 107 in universe (earnings yield 0.5%, return on capital 8.4%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +65.0%, 12-mo +222.2%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $50.79, margin of safety -580.1%
  - CANSLIM (O'Neil): 4/7 criteria met (1 gapped) — C: Y; A: ?; N: N; S: N; L: Y; I: Y; M: Y
...
## Raw data fields (yfinance)
  - forwardPE: 41.257076
  - trailingPE: 164.46191
  - enterpriseToEbitda: 49.898
  - enterpriseToRevenue: 9.929
  ...
  - currentPrice: 345.37
  - heldPercentInstitutions: 0.91580003
  - numberOfAnalystOpinions: 22

## Recent news headlines
  - Symbotic Inc. (SYM) Misses Q3 Earnings Estimates (2026-08-05)
  - LITE Stock Alert: Analysts See Big Upside Ahead for Lumentum as Trump Aims to Restrict Chinese Data Center Components (2026-08-05)
  - Dear Coherent Stock Fans, Mark Your Calendars for August 12 (2026-08-05)
  - Coherent (COHR) Earnings Expected to Grow: What to Know Ahead of Next Week's Release (2026-08-05)
  - New report warns China transceiver ban would hurt U.S. AI giants (2026-08-05)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 102.8% vs 25Δ call IV 98.8% — skew +4.0% (balanced)
    - Same-day flow at this expiry: 746 call vol vs 1,489 put vol (C/P 0.50)
