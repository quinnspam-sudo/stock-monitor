...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - HARD VETO: hostile market regime: SPY>!50d/200d, VIX 17.0 (max 28.0), term 0.872
  - No contract proposed: against: catalyst, flow_proxy, trend; hostile market regime: SPY>!50d/200d, VIX 17.0 (max 28.0), term 0.872

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #73 of 103 in universe (earnings yield 1.9%, return on capital 34.4%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.01
  - Momentum: 6-mo +28.1%, 12-mo +47.3%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: GAPPED; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $27.55, margin of safety -558.7%
...
## Raw data fields (yfinance)
  ...
  - currentPrice: 181.15
  - heldPercentInstitutions: 0.72971
  - numberOfAnalystOpinions: 27

## Recent news headlines
  - Arista Networks vs. BigBear.ai: Which Tech Stock Is a Better Buy in 2026? (2026-07-31)
  - Monolithic Power Beats Q2 Earnings Estimates on Enterprise Data Growth (2026-07-31)
  - Can Solid Top-Line Expansion Benefit KLIC's Q3 Earnings? (2026-07-30)
  - GFS Set to Report Q2 Results: Can Revenue Growth Lift Earnings? (2026-07-30)
  - Vertiv Q2 Earnings Beat Estimates, Net Sales Rise Year over Year (2026-07-30)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 71.2% vs 25Δ call IV 63.1% — skew +8.2% (heavy downside-protection bid (fear))
    - Same-day flow at this expiry: 1,495 call vol vs 314 put vol (C/P 4.76)
