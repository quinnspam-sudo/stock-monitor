...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - No contract proposed: against: flow_proxy, trend, vol_mispricing; IV/RVf 1.34 >= 1.15 — vol too rich to buy

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #69 of 103 in universe (earnings yield 2.3%, return on capital 27.3%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.37
  - Momentum: 6-mo +50.3%, 12-mo +38.2%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $49.30, margin of safety -485.8%
...
## Recent news headlines
  ...
  - Wall Street awaits major tech earnings as oil prices extend gains: Dow Jones, S&P, Nasdaq, Futures (2026-07-22)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-28 (~45d): ATM IV 67.3%
    - 25Δ put IV 68.2% vs 25Δ call IV 64.9% — skew +3.3% (balanced)
    - Same-day flow at this expiry: 38 call vol vs 277 put vol (C/P 0.14)
