...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #39 of 90 in universe (earnings yield 2.9%, return on capital 64.1%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 3.01
  - Momentum: 6-mo +27.6%, 12-mo +15.1%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $108.12, margin of safety -278.4%
...
## Raw data fields (yfinance)
  - forwardPE: 25.93063
  - trailingPE: 39.99218
  - enterpriseToEbitda: 27.791
  - enterpriseToRevenue: 6.18
  - pegRatio: 3.0069
  ...
  - currentPrice: 409.12
  - heldPercentInstitutions: 0.88022006
