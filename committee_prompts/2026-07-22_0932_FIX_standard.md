...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #55 of 107 in universe (earnings yield 2.0%, return on capital 91.1%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 0.85 (GARP: attractive <= 1)
  - Momentum: 6-mo +57.2%, 12-mo +239.6%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $119.50, margin of safety -1410.6%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 77.1% vs 25Δ call IV 69.3% — skew +7.8% (heavy downside-protection bid (fear))
    - Same-day flow at this expiry: 41 call vol vs 67 put vol (C/P 0.61)
