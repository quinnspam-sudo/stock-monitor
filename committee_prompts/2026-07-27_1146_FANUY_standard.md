...
## Trigger(s) breached
- Earnings gate OPENED — earnings in 4 business day(s), positivity 72/100, beat streak 3/4 — buy decision is now actionable
...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - HARD VETO: hostile market regime: SPY>!50d/200d, VIX 19.3 (max 28.0), term 0.94
  - No contract proposed: against: trend; 6-mo momentum -3% < 0% (falling knife); hostile market regime: SPY>!50d/200d, VIX 19.3 (max 28.0), term 0.94
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  ...
  - PEG (GARP): 3.25
  - Momentum: 6-mo -2.6%, 12-mo +37.7%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: GAPPED; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $8.70, margin of safety -133.5%
  - CANSLIM (O'Neil): 1/7 criteria met — C: N; A: N; N: N; S: Y; L: N; I: N; M: N
  - Dividend growth quality (if applicable): yield 534.9%, payout 19471%, quality score 35/100
