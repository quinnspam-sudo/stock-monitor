...
Generated: 2026-07-10 10:57 local | Source: stock-monitor local daemon
...
- Previous evaluation date: 2026-07-10 09:53
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #105 of 132 in universe (earnings yield 0.4%, return on capital 6.0%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 4.94
  - Momentum: 6-mo -6.2%, 12-mo +31.9%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $23.28, margin of safety -1655.3%
...
## Raw data fields (yfinance)
  ...
  - currentPrice: 408.6353
  - heldPercentInstitutions: 0.44877997
  - numberOfAnalystOpinions: 40

## Recent news headlines
  - A Big Headache for Police: Getting Driverless Cars to Obey Traffic Laws (2026-07-10)
  - Elon Musk SEC settlement raises 'red flags,' judge says (2026-07-10)
  - Elon Musk Has Mojo Back, As Tesla Quarterly Deliveries Skyrocket (2026-07-10)
  - Intel’s $200 Billion Turnaround Plan Is Under the Microscope (2026-07-10)
  - Why Is Tesla Bringing the Long-Wheelbase Model Y to the US? (2026-07-10)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-21 (~45d): ATM IV 49.1%
    - 25Δ put IV 44.3% vs 25Δ call IV 48.3% — skew -4.0% (upside being chased (call skew))
    - Same-day flow at this expiry: 14,656 call vol vs 8,047 put vol (C/P 1.82)
