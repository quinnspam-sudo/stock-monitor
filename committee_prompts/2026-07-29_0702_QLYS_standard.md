...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - HARD VETO: hostile market regime: SPY>!50d/200d, VIX 18.6 (max 28.0), term 0.924
  - No contract proposed: against: flow_proxy, trend; hostile market regime: SPY>!50d/200d, VIX 18.6 (max 28.0), term 0.924

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #24 of 118 in universe (earnings yield 5.1%, return on capital 85.5%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 5.29
  - Momentum: 6-mo +3.5%, 12-mo -0.5%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $45.09, margin of safety -203.4%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 60.0% vs 25Δ call IV 55.1% — skew +4.9% (balanced)
