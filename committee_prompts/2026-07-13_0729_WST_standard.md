...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - HARD VETO: IV/RVf 1.84 >= 1.35 — vol too rich to buy
  - No contract proposed: against: catalyst, flow_proxy, vol_mispricing; IV/RVf 1.84 >= 1.35 — vol too rich to buy

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #80 of 120 in universe (earnings yield 2.4%, return on capital 18.6%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 3.40
  - Momentum: 6-mo +30.2%, 12-mo +60.1%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $84.14, margin of safety -325.7%
...
## Raw data fields (yfinance)
  - forwardPE: 37.420433
  - trailingPE: 48.016087
  - enterpriseToEbitda: 28.496
  ...
  - currentPrice: 358.2
  - heldPercentInstitutions: 1.038
  - numberOfAnalystOpinions: 14

## Recent news headlines
  - West Pharmaceutical Services (WST) Sells SmartDose Rights To AbbVie To Refocus Its Business (2026-07-10)
...
## Recent insider transactions
  ...
  - FEEHERY WILLIAM F. — Stock Award(Grant) at price 0.00 per share. (2026-05-04)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 55.1% vs 25Δ call IV 51.4% — skew +3.8% (balanced)
