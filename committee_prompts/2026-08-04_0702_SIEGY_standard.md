...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #42 of 110 in universe (earnings yield 4.0%, return on capital 40.9%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 5.36
  - Momentum: 6-mo +8.6%, 12-mo +32.4%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: FAIL; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $77.59, margin of safety -114.5%
...
## Raw data fields (yfinance)
  - forwardPE: 24.91219
  - trailingPE: 29.725002
  - enterpriseToEbitda: 26.031
  - enterpriseToRevenue: 3.869
  - pegRatio: 5.3598
...
## Recent news headlines
  - PTC's AI-Led Lifecycle Strategy Reshapes Its Long-Term Growth Outlook (2026-07-31)
  - PTC Rides AI, Cloud and Product Data Trends Across Industrial Markets (2026-07-31)
