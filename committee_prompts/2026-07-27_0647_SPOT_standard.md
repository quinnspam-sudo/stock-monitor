...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #49 of 104 in universe (earnings yield 2.4%, return on capital 46.7%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.66
  - Momentum: 6-mo -6.1%, 12-mo -31.3%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $121.21, margin of safety -297.1%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-09-04 (~45d): ATM IV 56.5%
    - Same-day flow at this expiry: 4 call vol vs 30 put vol (C/P 0.13)
