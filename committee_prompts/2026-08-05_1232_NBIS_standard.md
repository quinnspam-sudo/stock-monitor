...
- Earnings gate OPENED — earnings in 5 business day(s), positivity 78/100, beat streak 3/4 — buy decision is now actionable
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  ...
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +176.0%, 12-mo +312.2%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $40.67, margin of safety -459.6%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-09-18 (~45d): ATM IV 124.1%
    - 25Δ put IV 130.6% vs 25Δ call IV 124.4% — skew +6.2% (heavy downside-protection bid (fear))
    - Same-day flow at this expiry: 1,911 call vol vs 3,847 put vol (C/P 0.50)
