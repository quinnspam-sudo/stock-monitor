...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #31 of 105 in universe (earnings yield 11.0%, return on capital 21.3%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo -31.5%, 12-mo +100.7%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $25.76, margin of safety -1.1%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-09-18 (~45d): ATM IV 75.0%
    - 25Δ put IV 69.6% vs 25Δ call IV 72.8% — skew -3.1% (upside being chased (call skew))
    - Same-day flow at this expiry: 3 call vol vs 19 put vol (C/P 0.16)
  - Commodity driver (futures):
    - Copper (HG=F): 6.45, 3-mo +8.8%, above 50d SMA — tailwind
