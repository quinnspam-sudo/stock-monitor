...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #76 of 107 in universe (earnings yield 1.4%, return on capital 24.2%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +74.9%, 12-mo +69.6%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $13.07, margin of safety -426.8%
  - CANSLIM (O'Neil): 6/7 criteria met — C: Y; A: Y; N: Y; S: N; L: Y; I: Y; M: Y
  - Dividend growth quality (if applicable): not a dividend payer, 5yr div CAGR +6.3%
...
## Raw data fields (yfinance)
  - forwardPE: 38.599087
  - trailingPE: 81.011765
  - enterpriseToEbitda: 50.984
  - enterpriseToRevenue: 11.029
  ...
  - targetMeanPrice: 76.83333
  - currentPrice: 68.86
  - heldPercentInstitutions: 1.0509
  - numberOfAnalystOpinions: 18

## Recent news headlines
  - Cognex Corporation (CGNX) Tops Q2 Earnings Estimates (2026-08-06)
  - Cognex (NASDAQ:CGNX) Misses Q2 CY2026 Revenue Estimates (2026-08-05)
  - Cognex (CGNX) Q2 Earnings Report Preview: What To Look For (2026-08-04)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 59.1% vs 25Δ call IV 59.3% — skew -0.2% (balanced)
    - Same-day flow at this expiry: 87 call vol vs 727 put vol (C/P 0.12)
