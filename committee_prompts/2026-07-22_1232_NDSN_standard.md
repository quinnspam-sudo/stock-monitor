...
## confirm or veto the positivity call using transcript/guidance judgment)
  ...
  - GATE VERDICT: NOT ACTIONABLE — earnings in 20 business days (window: ≤10); positivity 57/100 below strict bar 70
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #31 of 107 in universe (earnings yield 3.9%, return on capital 65.0%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.79
  - Momentum: 6-mo +7.1%, 12-mo +34.9%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $110.08, margin of safety -164.2%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 30.7% vs 25Δ call IV 30.9% — skew -0.3% (balanced)
