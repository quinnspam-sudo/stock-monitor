...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - HARD VETO: hostile market regime: SPY>!50d/200d, VIX 19.0 (max 28.0), term 0.93
  - No contract proposed: against: catalyst, trend; hostile market regime: SPY>!50d/200d, VIX 19.0 (max 28.0), term 0.93

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #37 of 101 in universe (earnings yield 5.3%, return on capital 27.8%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.15
  - Momentum: 6-mo +6.4%, 12-mo +27.8%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $126.70, margin of safety -201.1%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 42.9% vs 25Δ call IV 42.7% — skew +0.2% (balanced)
    - Same-day flow at this expiry: 24 call vol vs 5 put vol (C/P 4.80)
