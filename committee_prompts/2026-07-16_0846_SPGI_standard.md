...
Generated: 2026-07-16 08:46 local | Source: stock-monitor local daemon
...
- Previous evaluation date: 2026-07-16 08:31
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  ...
  - PEG (GARP): 1.83
  - Momentum: 6-mo -12.2%, 12-mo -8.4%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $193.61, margin of safety -132.8%
...
## Recent news headlines
  ...
  - S&P: Despite enrollment gains, margins have worsened at colleges (2026-07-15)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 41.7% vs 25Δ call IV 46.6% — skew -4.9% (upside being chased (call skew))
    - Same-day flow at this expiry: 8 call vol vs 7 put vol (C/P 1.14)
