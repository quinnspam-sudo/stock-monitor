...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - HARD VETO: hostile market regime: SPY>!50d/200d, VIX 18.5 (max 28.0), term 0.908
  - No contract proposed: against: catalyst, flow_proxy, trend, vol_mispricing; IV/RVf 1.53 >= 1.15 — vol too rich to buy; hostile market regime: SPY>!50d/200d, VIX 18.5 (max 28.0), term 0.908

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #52 of 112 in universe (earnings yield 2.0%, return on capital 92.6%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 3.63
  - Momentum: 6-mo +111.8%, 12-mo +53.3%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $8.83, margin of safety -1730.5%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-28 (~45d): ATM IV 71.0%
    - 25Δ put IV 71.6% vs 25Δ call IV 67.8% — skew +3.8% (balanced)
