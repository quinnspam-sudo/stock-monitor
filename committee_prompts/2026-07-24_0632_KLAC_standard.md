...
- Earnings gate OPENED — earnings in 2 business day(s), positivity 78/100, beat streak 4/4 — buy decision is now actionable
...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #62 of 104 in universe (earnings yield 1.7%, return on capital 60.8%)
  - Piotroski F-Score: 9/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.25
  - Momentum: 6-mo +42.5%, 12-mo +139.3%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $18.80, margin of safety -1044.4%
...
## Raw data fields (yfinance)
  - forwardPE: 41.951923
  - trailingPE: 61.15625
  - enterpriseToEbitda: 49.042
  - enterpriseToRevenue: 21.907
  - pegRatio: 2.2485
  ...
  - currentPrice: 215.27
  - heldPercentInstitutions: 0.95695996
  - numberOfAnalystOpinions: 28

## Recent news headlines
  - AMSL, AMAT, KLAC, LRCX: Chipmaking Equipment Stocks Rise On Intel’s CapEx Bump (2026-07-24)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - Same-day flow at this expiry: 2,445 call vol vs 6,104 put vol (C/P 0.40)
