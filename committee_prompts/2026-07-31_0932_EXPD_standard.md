...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #36 of 123 in universe (earnings yield 5.0%, return on capital 39.1%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 3.91
  - Momentum: 6-mo +5.7%, 12-mo +46.7%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $49.13, margin of safety -243.5%
...
## Raw data fields (yfinance)
  - forwardPE: 24.024895
  - trailingPE: 27.219355
  - enterpriseToEbitda: 18.543
  - enterpriseToRevenue: 1.886
  - pegRatio: 3.9122
  ...
  - currentPrice: 168.76
  - heldPercentInstitutions: 1.01044
...
## Recent news headlines
  ...
  - EXPD to Report Q2 Earnings: What's in the Offing for the Stock? (2026-07-28)
  - Expeditors International (EXPD) Reports Next Week: Wall Street Expects Earnings Growth (2026-07-28)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 35.4% vs 25Δ call IV 34.9% — skew +0.5% (balanced)
