...
- Previous evaluation date: 2026-07-17 10:46
...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - No contract proposed: against: trend; 6-mo momentum -2% < 0% (falling knife)

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #117 of 136 in universe (earnings yield -26.4%, return on capital 11.1%)
  - Piotroski F-Score: 7/9 (1 tests gapped) (8-9 strong, 0-2 weak)
  - PEG (GARP): 3.41
  - Momentum: 6-mo -2.5%, 12-mo +61.5%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: GAPPED; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $8.73, margin of safety -137.0%
  - CANSLIM (O'Neil): 1/7 criteria met — C: N; A: N; N: N; S: N; L: N; I: N; M: Y
  - Dividend growth quality (if applicable): yield 505.9%, payout 19471%, quality score 35/100
...
## Raw data fields (yfinance)
  - forwardPE: 30.895523
  - trailingPE: 37.636364
  - enterpriseToEbitda: -3.007
...
## Recent news headlines
  ...
  - Nvidia partners with Japan robotics firms on AI development (2026-07-16)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  - Institutional flow (13F deltas):
    ...
    - Nbc Securities, Inc.                          : 0.00% held, +0.0% q/q
