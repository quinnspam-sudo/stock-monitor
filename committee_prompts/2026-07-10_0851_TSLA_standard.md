...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  ...
  - PEG (GARP): 4.94
  - Momentum: 6-mo -6.3%, 12-mo +31.8%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $23.28, margin of safety -1654.7%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 45.8% vs 25Δ call IV 46.9% — skew -1.1% (balanced)
    - Same-day flow at this expiry: 9,733 call vol vs 5,188 put vol (C/P 1.88)
