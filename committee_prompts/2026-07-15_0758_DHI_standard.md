...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #46 of 137 in universe (earnings yield 9.2%, return on capital 13.7%)
  - Piotroski F-Score: 4/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.25
  - Momentum: 6-mo -5.1%, 12-mo +17.4%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: FAIL
  - Graham/Buffett intrinsic value: Graham Number $140.96, margin of safety -6.9%
...
## Raw data fields (yfinance)
  - forwardPE: 12.558665
  - trailingPE: 14.151175
  - enterpriseToEbitda: 11.206
  ...
  - currentPrice: 150.71
  - heldPercentInstitutions: 0.88838
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-28 (~45d): ATM IV 50.3%
