...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - No contract proposed: against: trend; 6-mo momentum -1% < 0% (falling knife)

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #96 of 109 in universe (earnings yield -26.4%, return on capital 11.1%)
  - Piotroski F-Score: 7/9 (1 tests gapped) (8-9 strong, 0-2 weak)
  - PEG (GARP): 3.33
  - Momentum: 6-mo -1.4%, 12-mo +60.6%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: GAPPED; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $8.73, margin of safety -136.9%
  - CANSLIM (O'Neil): 1/7 criteria met — C: N; A: N; N: N; S: N; L: N; I: N; M: Y
  - Dividend growth quality (if applicable): yield 516.6%, payout 19471%, quality score 35/100
...
## Raw data fields (yfinance)
  - forwardPE: 30.880596
  - trailingPE: 37.618183
  - enterpriseToEbitda: -3.011
