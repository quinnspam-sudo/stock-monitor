...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #46 of 116 in universe (earnings yield 3.6%, return on capital 52.1%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 2.65
  - Momentum: 6-mo +1.4%, 12-mo +33.5%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: FAIL; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $76.90, margin of safety -154.1%
...
## Raw data fields (yfinance)
  - forwardPE: 25.758936
  - trailingPE: 36.582413
  - enterpriseToEbitda: 19.282
  - enterpriseToRevenue: 3.257
  - pegRatio: 2.6501
  ...
  - currentPrice: 195.37
  - heldPercentInstitutions: 0.81384003
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - Same-day flow at this expiry: 6 call vol vs 12 put vol (C/P 0.50)
