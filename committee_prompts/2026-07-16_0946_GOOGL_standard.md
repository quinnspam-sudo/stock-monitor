...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #41 of 108 in universe (earnings yield 3.6%, return on capital 43.7%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.46
  - Momentum: 6-mo +10.7%, 12-mo +103.6%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $107.88, margin of safety -244.3%
...
## Recent news headlines
  - Meta's data center plans could help solve its AI spending problems (2026-07-16)
  - OpenAI's AI speaker marks its entry into consumer hardware (2026-07-15)
  - Stock market today: Dow, S&P 500, Nasdaq rise as Apple notches record high (2026-07-15)
  - Big Tech Isn’t Doing Its Part to Offset Chip Weakness (2026-07-16)
  - AI Internet Hyperscalers: Why Wedbush Prefers Google And Amazon To Meta (2026-07-16)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-28 (~45d): ATM IV 40.4%
    - 25Δ put IV 37.1% vs 25Δ call IV 38.3% — skew -1.3% (balanced)
    - Same-day flow at this expiry: 234 call vol vs 236 put vol (C/P 0.99)
