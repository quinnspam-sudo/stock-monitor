...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #8 of 108 in universe (earnings yield 7.0%, return on capital 58.8%)
  - Piotroski F-Score: 5/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 8.44
  - Momentum: 6-mo +3.2%, 12-mo +1.2%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $109.97, margin of safety -109.5%
...
## Recent news headlines
  - SSUMY or HON: Which Is the Better Value Stock Right Now? (2026-07-21)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 39.6% vs 25Δ call IV 38.0% — skew +1.6% (balanced)
    - Same-day flow at this expiry: 2 call vol vs 11 put vol (C/P 0.18)
