...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #53 of 94 in universe (earnings yield 1.7%, return on capital 41.8%)
  - Piotroski F-Score: 8/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +24.3%, 12-mo +48.7%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $36.50, margin of safety -649.0%
...
## Raw data fields (yfinance)
  - forwardPE: 45.168045
  - trailingPE: 63.577908
  - enterpriseToEbitda: 44.568
  - enterpriseToRevenue: 13.237
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - Same-day flow at this expiry: 3 call vol vs 5 put vol (C/P 0.60)
