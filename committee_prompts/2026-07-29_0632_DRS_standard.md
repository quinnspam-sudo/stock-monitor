...
## Call-option candidate (independent options engine; committee should judge premium vs expected move, not just direction)
  ...
  - HARD VETO: hostile market regime: SPY>!50d/200d, VIX 18.9 (max 28.0), term 0.952
  - No contract proposed: against: catalyst, trend; hostile market regime: SPY>!50d/200d, VIX 18.9 (max 28.0), term 0.952

## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #71 of 104 in universe (earnings yield 2.6%, return on capital 21.4%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +14.8%, 12-mo +1.6%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: FAIL; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $15.83, margin of safety -206.9%
...
## Raw data fields (yfinance)
  - forwardPE: 33.72543
  - trailingPE: 45.364483
  - enterpriseToEbitda: 28.291
  - enterpriseToRevenue: 3.537
  ...
  - currentPrice: 48.54
  - heldPercentInstitutions: 0.27796
