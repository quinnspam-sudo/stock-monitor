...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  ...
  - PEG (GARP): 2.14
  - Momentum: 6-mo -8.4%, 12-mo +15.8%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $55.92, margin of safety -131.1%
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    ...
    - 25Δ put IV 36.5% vs 25Δ call IV 35.2% — skew +1.3% (balanced)
    - Same-day flow at this expiry: 247 call vol vs 154 put vol (C/P 1.60)
