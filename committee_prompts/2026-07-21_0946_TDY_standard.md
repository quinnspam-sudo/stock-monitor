...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #31 of 107 in universe (earnings yield 3.7%, return on capital 56.7%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +16.1%, 12-mo +17.5%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $320.35, margin of safety -105.1%
...
## Raw data fields (yfinance)
  - forwardPE: 25.217474
  - trailingPE: 33.256584
  - enterpriseToEbitda: 20.142
  - enterpriseToRevenue: 4.977
  ...
  - currentPrice: 656.485
  - heldPercentInstitutions: 1.00371
  - numberOfAnalystOpinions: 13

## Recent news headlines
  - Teledyne Technologies to Report Q2 Earnings: Here's What to Expect (2026-07-21)
  - Teledyne (TDY) To Report Earnings Tomorrow: Here Is What To Expect (2026-07-21)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-21 (~45d): ATM IV 46.2%
    - 25Δ put IV 51.2% vs 25Δ call IV 41.2% — skew +10.0% (heavy downside-protection bid (fear))
    - Same-day flow at this expiry: 126 call vol vs 38 put vol (C/P 3.32)
