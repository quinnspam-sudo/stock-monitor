...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #24 of 110 in universe (earnings yield 4.8%, return on capital 47.7%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.81
  - Momentum: 6-mo +6.4%, 12-mo +15.5%
  - Quality gates (Buffett-style): ROE >= 15%: FAIL; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $100.06, margin of safety -117.8%
...
## Raw data fields (yfinance)
  ...
  - currentPrice: 217.94
  - heldPercentInstitutions: 0.94965
  - numberOfAnalystOpinions: 18

## Recent news headlines
  - 3 Profitable Stocks We Think Twice About (2026-07-17)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-08-21 (~45d): ATM IV 36.5%
    - 25Δ put IV 42.6% vs 25Δ call IV 40.7% — skew +1.9% (balanced)
    - Same-day flow at this expiry: 125 call vol vs 114 put vol (C/P 1.10)
