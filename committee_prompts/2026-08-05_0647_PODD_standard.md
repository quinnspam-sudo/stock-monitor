...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #62 of 105 in universe (earnings yield 3.3%, return on capital 19.4%)
  - Piotroski F-Score: 6/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): 1.46
  - Momentum: 6-mo -46.2%, 12-mo -51.9%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: FAIL; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $42.56, margin of safety -217.8%
  ...
  - 52-week high breakout (O'Neil/Darvas): -61.9% from 52-wk high
...
## Raw data fields (yfinance)
  ...
  - currentPrice: 135.07
  - heldPercentInstitutions: 1.0532299
  - numberOfAnalystOpinions: 24

## Recent news headlines
  - Insulet (PODD) Beats Q2 Earnings and Revenue Estimates (2026-08-05)
  - Insulet’s (NASDAQ:PODD) Q2 CY2026 Sales Top Estimates But Stock Drops (2026-08-05)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Options skew / flow:
    - Reference expiry 2026-09-18 (~45d): ATM IV 52.2%
    - 25Δ put IV 68.1% vs 25Δ call IV 80.2% — skew -12.1% (upside being chased (call skew))
    - Same-day flow at this expiry: 140 call vol vs 79 put vol (C/P 1.77)
