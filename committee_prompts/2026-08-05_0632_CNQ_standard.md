...
## Evidence-backed factor screen (mechanical; committee should weigh explicitly)
  - Magic Formula rank: #41 of 122 in universe (earnings yield 12.4%, return on capital 17.2%)
  - Piotroski F-Score: 7/9 (8-9 strong, 0-2 weak)
  - PEG (GARP): GAPPED
  - Momentum: 6-mo +22.7%, 12-mo +50.3%
  - Quality gates (Buffett-style): ROE >= 15%: PASS; Debt/Equity < 0.5: PASS; Gross margin > 40%: PASS; CFO > Net Income: PASS
  - Graham/Buffett intrinsic value: Graham Number $36.68, margin of safety -26.4%
  - CANSLIM (O'Neil): 4/7 criteria met — C: N; A: N; N: Y; S: N; L: Y; I: Y; M: Y
  - Dividend growth quality (if applicable): yield 5.2%, payout 61%, quality score 80/100, 5yr div CAGR +17.0%
...
## Raw data fields (yfinance)
  - forwardPE: 12.653199
  - trailingPE: 11.821428
  - enterpriseToEbitda: 7.792
  ...
  - targetMeanPrice: 47.859367
  - currentPrice: 46.34
  - heldPercentInstitutions: 0.79549
  - numberOfAnalystOpinions: 4

## Recent news headlines
  - Canadian Natural to Report Q2 Earnings: What's in the Offing? (2026-08-04)
  - Insights Into Canadian Natural Resources (CNQ) Q2: Wall Street Projections for Key Metrics (2026-08-03)
...
## Recent insider transactions
  ...
  - Healy (Christine) — Compensation for services at price 39.68 per share. (2026-07-06)
...
## Depth enrichment (short interest, 13F flow, filings, options skew)
  ...
  - Institutional flow (13F deltas):
    ...
    - Capital World Investors: 9.55% held, -1.1% q/q
    - Capital Research Global Investors: 7.95% held, +12.4% q/q
    - Royal Bank of Canada: 6.03% held, +10.7% q/q
    - FMR, LLC: 4.12% held, -6.6% q/q
    - Bank of Montreal /CAN/: 3.09% held, -8.0% q/q
  ...
  - SEC filing stream:
    ...
    - 2026-03-26 6-K — Corporate Changes & Voting Matters
  - Options skew / flow:
    - Reference expiry 2026-09-18 (~45d): ATM IV 1.6%
    - Same-day flow at this expiry: 871 call vol vs 1,219 put vol (C/P 0.71)
